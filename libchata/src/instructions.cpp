...
const std::array<rvinstruction, 339> instructions = {
        {{"lui", U, LUI, 0b0110111, 0b000, RV32I},
         ...
         {"lr.w.aq", R, LRW, 0b0101111, 0b0001010010, RV32A, {0b00000}},
         {"sc.w.aq", R, SCW, 0b0101111, 0b0001110010, RV32A},
         {"lr.w.rl", R, LRW, 0b0101111, 0b0001001010, RV32A, {0b00000}},
         {"sc.w.rl", R, SCW, 0b0101111, 0b0001101010, RV32A},
         {"lr.w.aqrl", R, LRW, 0b0101111, 0b0001011010, RV32A, {0b00000}},
         {"sc.w.aqrl", R, SCW, 0b0101111, 0b0001111010, RV32A},
         ...
         {"amoswap.w.aq", R, AMOSWAPW, 0b0101111, 0b0000110010, RV32A},
         {"amoadd.w.aq", R, AMOADDW, 0b0101111, 0b0000010010, RV32A},
         {"amoxor.w.aq", R, AMOXORW, 0b0101111, 0b0010010010, RV32A},
         {"amoand.w.aq", R, AMOANDW, 0b0101111, 0b0110010010, RV32A},
         {"amoor.w.aq", R, AMOORW, 0b0101111, 0b0100010010, RV32A},
         {"amomin.w.aq", R, AMOMINW, 0b0101111, 0b1000010010, RV32A},
         {"amomax.w.aq", R, AMOMAXW, 0b0101111, 0b1010010010, RV32A},
         {"amominu.w.aq", R, AMOMINUW, 0b0101111, 0b1100010010, RV32A},
         {"amomaxu.w.aq", R, AMOMAXUW, 0b0101111, 0b1110010010, RV32A},
         {"amoswap.w.rl", R, AMOSWAPW, 0b0101111, 0b0000101010, RV32A},
         {"amoadd.w.rl", R, AMOADDW, 0b0101111, 0b0000001010, RV32A},
         {"amoxor.w.rl", R, AMOXORW, 0b0101111, 0b0010001010, RV32A},
         {"amoand.w.rl", R, AMOANDW, 0b0101111, 0b0110001010, RV32A},
         {"amoor.w.rl", R, AMOORW, 0b0101111, 0b0100001010, RV32A},
         {"amomin.w.rl", R, AMOMINW, 0b0101111, 0b1000001010, RV32A},
         {"amomax.w.rl", R, AMOMAXW, 0b0101111, 0b1010001010, RV32A},
         {"amominu.w.rl", R, AMOMINUW, 0b0101111, 0b1100001010, RV32A},
         {"amomaxu.w.rl", R, AMOMAXUW, 0b0101111, 0b1110001010, RV32A},
         {"amoswap.w.aqrl", R, AMOSWAPW, 0b0101111, 0b0000111010, RV32A},
         {"amoadd.w.aqrl", R, AMOADDW, 0b0101111, 0b0000011010, RV32A},
         {"amoxor.w.aqrl", R, AMOXORW, 0b0101111, 0b0010011010, RV32A},
         {"amoand.w.aqrl", R, AMOANDW, 0b0101111, 0b0110011010, RV32A},
         {"amoor.w.aqrl", R, AMOORW, 0b0101111, 0b0100011010, RV32A},
         {"amomin.w.aqrl", R, AMOMINW, 0b0101111, 0b1000011010, RV32A},
         {"amomax.w.aqrl", R, AMOMAXW, 0b0101111, 0b1010011010, RV32A},
         {"amominu.w.aqrl", R, AMOMINUW, 0b0101111, 0b1100011010, RV32A},
         {"amomaxu.w.aqrl", R, AMOMAXUW, 0b0101111, 0b1110011010, RV32A},
         {"lr.d", R, LRD, 0b0101111, 0b0001000011, RV64A, {0b00000}},
         {"sc.d", R, SCD, 0b0101111, 0b0001100011, RV64A},
         {"lr.d.aq", R, LRD, 0b0101111, 0b0001010011, RV64A, {0b00000}},
         {"sc.d.aq", R, SCD, 0b0101111, 0b0001110011, RV64A},
         {"lr.d.rl", R, LRD, 0b0101111, 0b0001001011, RV64A, {0b00000}},
         {"sc.d.rl", R, SCD, 0b0101111, 0b0001101011, RV64A},
         {"lr.d.aqrl", R, LRD, 0b0101111, 0b0001011011, RV64A, {0b00000}},
         {"sc.d.aqrl", R, SCD, 0b0101111, 0b0001111011, RV64A},
         ...
         {"amoswap.d.aq", R, AMOSWAPD, 0b0101111, 0b0000110011, RV64A},
         {"amoadd.d.aq", R, AMOADDD, 0b0101111, 0b0000010011, RV64A},
         {"amoxor.d.aq", R, AMOXORD, 0b0101111, 0b0010010011, RV64A},
         {"amoand.d.aq", R, AMOANDD, 0b0101111, 0b0110010011, RV64A},
         {"amoor.d.aq", R, AMOORD, 0b0101111, 0b0100010011, RV64A},
         {"amomin.d.aq", R, AMOMIND, 0b0101111, 0b1000010011, RV64A},
         {"amomax.d.aq", R, AMOMAXD, 0b0101111, 0b1010010011, RV64A},
         {"amominu.d.aq", R, AMOMINUD, 0b0101111, 0b1100010011, RV64A},
         {"amomaxu.d.aq", R, AMOMAXUD, 0b0101111, 0b1110010011, RV64A},
         {"amoswap.d.rl", R, AMOSWAPD, 0b0101111, 0b0000101011, RV64A},
         {"amoadd.d.rl", R, AMOADDD, 0b0101111, 0b0000001011, RV64A},
         {"amoxor.d.rl", R, AMOXORD, 0b0101111, 0b0010001011, RV64A},
         {"amoand.d.rl", R, AMOANDD, 0b0101111, 0b0110001011, RV64A},
         {"amoor.d.rl", R, AMOORD, 0b0101111, 0b0100001011, RV64A},
         {"amomin.d.rl", R, AMOMIND, 0b0101111, 0b1000001011, RV64A},
         {"amomax.d.rl", R, AMOMAXD, 0b0101111, 0b1010001011, RV64A},
         {"amominu.d.rl", R, AMOMINUD, 0b0101111, 0b1100001011, RV64A},
         {"amomaxu.d.rl", R, AMOMAXUD, 0b0101111, 0b1110001011, RV64A},
         {"amoswap.d.aqrl", R, AMOSWAPD, 0b0101111, 0b0000111011, RV64A},
         {"amoadd.d.aqrl", R, AMOADDD, 0b0101111, 0b0000011011, RV64A},
         {"amoxor.d.aqrl", R, AMOXORD, 0b0101111, 0b0010011011, RV64A},
         {"amoand.d.aqrl", R, AMOANDD, 0b0101111, 0b0110011011, RV64A},
         {"amoor.d.aqrl", R, AMOORD, 0b0101111, 0b0100011011, RV64A},
         {"amomin.d.aqrl", R, AMOMIND, 0b0101111, 0b1000011011, RV64A},
         {"amomax.d.aqrl", R, AMOMAXD, 0b0101111, 0b1010011011, RV64A},
         {"amominu.d.aqrl", R, AMOMINUD, 0b0101111, 0b1100011011, RV64A},
         {"amomaxu.d.aqrl", R, AMOMAXUD, 0b0101111, 0b1110011011, RV64A},
