...
const std::array<rvinstruction, 170> instructions = {
        {{"lui", U, LUI, 0b0110111, 0b000, RV32I},
         ...
         {"fmsub.s", R4, FMSUBS, 0b1000011, 0b00, RV32F, {{nullopt, true}}},
         {"fnmsub.s", R4, FNMSUBS, 0b1000011, 0b00, RV32F, {{nullopt, true}}},
         {"fnmadd.s", R4, FNMADDS, 0b1000011, 0b00, RV32F, {{nullopt, true}}},
         {"fadd.s", R, FADDS, 0b1010011, 0b0000000, RV32F, {{nullopt, true}}},
         {"fsub.s", R, FSUBS, 0b1010011, 0b0000100, RV32F, {{nullopt, true}}},
         {"fmul.s", R, FMULS, 0b1010011, 0b0001000, RV32F, {{nullopt, true}}},
         {"fdiv.s", R, FDIVS, 0b1010011, 0b0001100, RV32F, {{nullopt, true}}},
         ...
         {"fcvt.w.s", R, FCVTWS, 0b1010011, 0b1100000000, RV32F, {{0b00000}}},
         {"fcvt.wu.s", R, FCVTWUS, 0b1010011, 0b1100000000, RV32F, {{0b00001}}},
         ...
         {"fclass.s", R, FCLASSS, 0b1010011, 0b1110000000, RV32F, {{0b00000}}},
         {"fcvt.s.w", R, FCVTSW, 0b1010011, 0b1101000000, RV32F, {{0b00000}}},
         {"fcvt.s.wu", R, FCVTSWU, 0b1010011, 0b1101000000, RV32F, {{0b00001}}},
         {"fmv.w.x", R, FMVWX, 0b1010011, 0b1111000000, RV32F, {{0b00000}}},
         {"flw", I, FLW, 0b0000111, 0b010, RV32F},
         {"fsw", S, FSW, 0b0100111, 0b010, RV32F},
         {"fcvt.l.s", R, FCVTLS, 0b1010011, 0b1100000000, RV64F, {{0b00010}}},
         {"fcvt.lu.s", R, FCVTLUS, 0b1010011, 0b1100000000, RV64F, {{0b00011}}},
         {"fcvt.s.l", R, FCVTSL, 0b1010011, 0b1101000000, RV64F, {{0b00010}}},
         {"fcvt.s.lu", R, FCVTSLU, 0b1010011, 0b1101000000, RV64F, {{0b00011}}},
         {"fadd.d", R, FADDD, 0b1000011, 0b0000001000, RV32D},
         {"fmadd.d", R4, FMADDD, 0b1000011, 0b01, RV32D},
         {"fclass.d", R, FCLASSD, 0b1010011, 0b1110001000, RV32D, {{0b00000}}},
         {"fcvt.d.h", R, FCVTDH, 0b1010011, 0b0100001000, RV32D, {{0b00010}}},
         {"fcvt.d.s", R, FCVTDS, 0b1010011, 0b0100001000, RV32D, {{0b00000}}},
         {"fcvt.d.w", R, FCVTDW, 0b1010011, 0b1101001000, RV32D, {{0b00000}}},
         {"fcvt.d.wu", R, FCVTDWU, 0b1010011, 0b1101001000, RV32D, {{0b00001}}},
         {"fcvt.h.d", R, FCVTHD, 0b1010011, 0b0100010000, RV32D, {{0b00001}}},
         {"fcvt.s.d", R, FCVTSD, 0b1010011, 0b0100000000, RV32D, {{0b00001}}},
         {"fcvt.w.d", R, FCVTWD, 0b1010011, 0b1100001000, RV32D, {{0b00000}}},
         {"fcvt.wu.d", R, FCVTWUD, 0b1010011, 0b1100001000, RV32D, {{0b00001}}},
         {"fdiv.d", R, FDIVD, 0b1010011, 0b0001110000, RV32D},
         ...
         {"fmul.d", R, FMULD, 0b1010011, 0b0001001000, RV32D},
         ...
         {"fsgnjn.d", R, FSGJND, 0b1010011, 0b0010001000, RV32D},
         {"fsgnjx.d", R, FSGNJXD, 0b1010011, 0b0010001010, RV32D},
         {"fsqrt.d", R, FSQRTD, 0b1010011, 0b0101101000, RV32D, {{0b00000}}},
         {"fsub.d", R, FSUBD, 0b1010011, 0b0000101000, RV32D},
         {"fcvt.l.d", R, FCVTLD, 0b1010011, 0b1100001000, RV64D, {{0b00010}}},
         {"fcvt.lu.d", R, FCVTLUD, 0b1010011, 0b1100001000, RV64D, {{0b00011}}},
         {"fmv.x.d", R, FMVXD, 0b1010011, 0b1110001000, RV64D, {{0b00000}}},
         {"fcvt.d.l", R, FCVTDL, 0b1010011, 0b1101001000, RV64D, {{0b00010}}},
         {"fcvt.d.lu", R, FCVTDLU, 0b1010011, 0b1101001000, RV64D, {{0b00011}}},
