...
const std::array<rvinstruction, 367> instructions = {
        {{"lui", U, LUI, 0b0110111, 0b000, RV32I},
         ...
         {"slli", R, SLLI, 0b0010011, 0b0000000001, RV32I, {nullopt, false, true}},
         {"srli", R, SRLI, 0b0010011, 0b0000000101, RV32I, {nullopt, false, true}},
         {"srai", R, SRAI, 0b0010011, 0b0100000101, RV32I, {nullopt, false, true}},
         ...
         {"fence", I, FENCE, 0b0001111, 0b000, RV32I, {nullopt, false, false, true}},
         {"fence.tso", I, FENCETSO, 0b0001111, 0b000, RV32I, {nullopt, false, false, true}},
         {"pause", I, PAUSE, 0b0001111, 0b000, RV32I, {nullopt, false, false, true}},
         {"ecall", I, ECALL, 0b1110011, 0b000, RV32I, {nullopt, false, false, true}},
         {"ebreak", I, EBREAK, 0b1110011, 0b000, RV32I, {nullopt, false, false, true}},
         ...
         {"slliw", R, SLLIW, 0b0011011, 0b0000000001, RV64I, {nullopt, false, true}},
         {"srliw", R, SRLIW, 0b0011011, 0b0000000101, RV64I, {nullopt, false, true}},
         {"sraiw", R, SRAIW, 0b0011011, 0b0100000101, RV64I, {nullopt, false, true}},
         ...
         {"lr.w.aq", R, LRWAQ, 0b0101111, 0b0001010010, RV32A, {0b00000}},
         {"sc.w.aq", R, SCWAQ, 0b0101111, 0b0001110010, RV32A},
         {"lr.w.rl", R, LRWRL, 0b0101111, 0b0001001010, RV32A, {0b00000}},
         {"sc.w.rl", R, SCWRL, 0b0101111, 0b0001101010, RV32A},
         {"lr.w.aqrl", R, LRWAQRL, 0b0101111, 0b0001011010, RV32A, {0b00000}},
         {"sc.w.aqrl", R, SCWAQRL, 0b0101111, 0b0001111010, RV32A},
         ...
         {"amoswap.w.aq", R, AMOSWAPWAQ, 0b0101111, 0b0000110010, RV32A},
         {"amoadd.w.aq", R, AMOADDWAQ, 0b0101111, 0b0000010010, RV32A},
         {"amoxor.w.aq", R, AMOXORWAQ, 0b0101111, 0b0010010010, RV32A},
         {"amoand.w.aq", R, AMOANDWAQ, 0b0101111, 0b0110010010, RV32A},
         {"amoor.w.aq", R, AMOORWAQ, 0b0101111, 0b0100010010, RV32A},
         {"amomin.w.aq", R, AMOMINWAQ, 0b0101111, 0b1000010010, RV32A},
         {"amomax.w.aq", R, AMOMAXWAQ, 0b0101111, 0b1010010010, RV32A},
         {"amominu.w.aq", R, AMOMINUWAQ, 0b0101111, 0b1100010010, RV32A},
         {"amomaxu.w.aq", R, AMOMAXUWAQ, 0b0101111, 0b1110010010, RV32A},
         {"amoswap.w.rl", R, AMOSWAPWRL, 0b0101111, 0b0000101010, RV32A},
         {"amoadd.w.rl", R, AMOADDWRL, 0b0101111, 0b0000001010, RV32A},
         {"amoxor.w.rl", R, AMOXORWRL, 0b0101111, 0b0010001010, RV32A},
         {"amoand.w.rl", R, AMOANDWRL, 0b0101111, 0b0110001010, RV32A},
         {"amoor.w.rl", R, AMOORWRL, 0b0101111, 0b0100001010, RV32A},
         {"amomin.w.rl", R, AMOMINWRL, 0b0101111, 0b1000001010, RV32A},
         {"amomax.w.rl", R, AMOMAXWRL, 0b0101111, 0b1010001010, RV32A},
         {"amominu.w.rl", R, AMOMINUWRL, 0b0101111, 0b1100001010, RV32A},
         {"amomaxu.w.rl", R, AMOMAXUWRL, 0b0101111, 0b1110001010, RV32A},
         {"amoswap.w.aqrl", R, AMOSWAPWAQRL, 0b0101111, 0b0000111010, RV32A},
         {"amoadd.w.aqrl", R, AMOADDWAQRL, 0b0101111, 0b0000011010, RV32A},
         {"amoxor.w.aqrl", R, AMOXORWAQRL, 0b0101111, 0b0010011010, RV32A},
         {"amoand.w.aqrl", R, AMOANDWAQRL, 0b0101111, 0b0110011010, RV32A},
         {"amoor.w.aqrl", R, AMOORWAQRL, 0b0101111, 0b0100011010, RV32A},
         {"amomin.w.aqrl", R, AMOMINWAQRL, 0b0101111, 0b1000011010, RV32A},
         {"amomax.w.aqrl", R, AMOMAXWAQRL, 0b0101111, 0b1010011010, RV32A},
         {"amominu.w.aqrl", R, AMOMINUWAQRL, 0b0101111, 0b1100011010, RV32A},
         {"amomaxu.w.aqrl", R, AMOMAXUWAQRL, 0b0101111, 0b1110011010, RV32A},
         {"lr.d", R, LRD, 0b0101111, 0b0001000011, RV64A, {0b00000}},
         {"sc.d", R, SCD, 0b0101111, 0b0001100011, RV64A},
         {"lr.d.aq", R, LRDAQ, 0b0101111, 0b0001010011, RV64A, {0b00000}},
         {"sc.d.aq", R, SCDAQ, 0b0101111, 0b0001110011, RV64A},
         {"lr.d.rl", R, LRDRL, 0b0101111, 0b0001001011, RV64A, {0b00000}},
         {"sc.d.rl", R, SCDRL, 0b0101111, 0b0001101011, RV64A},
         {"lr.d.aqrl", R, LRDAQRL, 0b0101111, 0b0001011011, RV64A, {0b00000}},
         {"sc.d.aqrl", R, SCDAQRL, 0b0101111, 0b0001111011, RV64A},
         ...
         {"amoswap.d.aq", R, AMOSWAPDAQ, 0b0101111, 0b0000110011, RV64A},
         {"amoadd.d.aq", R, AMOADDDAQ, 0b0101111, 0b0000010011, RV64A},
         {"amoxor.d.aq", R, AMOXORDAQ, 0b0101111, 0b0010010011, RV64A},
         {"amoand.d.aq", R, AMOANDDAQ, 0b0101111, 0b0110010011, RV64A},
         {"amoor.d.aq", R, AMOORDAQ, 0b0101111, 0b0100010011, RV64A},
         {"amomin.d.aq", R, AMOMINDAQ, 0b0101111, 0b1000010011, RV64A},
         {"amomax.d.aq", R, AMOMAXDAQ, 0b0101111, 0b1010010011, RV64A},
         {"amominu.d.aq", R, AMOMINUDAQ, 0b0101111, 0b1100010011, RV64A},
         {"amomaxu.d.aq", R, AMOMAXUDAQ, 0b0101111, 0b1110010011, RV64A},
         {"amoswap.d.rl", R, AMOSWAPDRL, 0b0101111, 0b0000101011, RV64A},
         {"amoadd.d.rl", R, AMOADDDRL, 0b0101111, 0b0000001011, RV64A},
         {"amoxor.d.rl", R, AMOXORDRL, 0b0101111, 0b0010001011, RV64A},
         {"amoand.d.rl", R, AMOANDDRL, 0b0101111, 0b0110001011, RV64A},
         {"amoor.d.rl", R, AMOORDRL, 0b0101111, 0b0100001011, RV64A},
         {"amomin.d.rl", R, AMOMINDRL, 0b0101111, 0b1000001011, RV64A},
         {"amomax.d.rl", R, AMOMAXDRL, 0b0101111, 0b1010001011, RV64A},
         {"amominu.d.rl", R, AMOMINUDRL, 0b0101111, 0b1100001011, RV64A},
         {"amomaxu.d.rl", R, AMOMAXUDRL, 0b0101111, 0b1110001011, RV64A},
         {"amoswap.d.aqrl", R, AMOSWAPDAQRL, 0b0101111, 0b0000111011, RV64A},
         {"amoadd.d.aqrl", R, AMOADDDAQRL, 0b0101111, 0b0000011011, RV64A},
         {"amoxor.d.aqrl", R, AMOXORDAQRL, 0b0101111, 0b0010011011, RV64A},
         {"amoand.d.aqrl", R, AMOANDDAQRL, 0b0101111, 0b0110011011, RV64A},
         {"amoor.d.aqrl", R, AMOORDAQRL, 0b0101111, 0b0100011011, RV64A},
         {"amomin.d.aqrl", R, AMOMINDAQRL, 0b0101111, 0b1000011011, RV64A},
         {"amomax.d.aqrl", R, AMOMAXDAQRL, 0b0101111, 0b1010011011, RV64A},
         {"amominu.d.aqrl", R, AMOMINUDAQRL, 0b0101111, 0b1100011011, RV64A},
         {"amomaxu.d.aqrl", R, AMOMAXUDAQRL, 0b0101111, 0b1110011011, RV64A},
         ...
         {"fmadd.h", R4, FMADDH, 0b1000011, 0b10000, RV32Zfh, {nullopt, true}},
         {"fmsub.h", R4, FMSUBH, 0b1000111, 0b10000, RV32Zfh, {nullopt, true}},
         {"fnmsub.h", R4, FNMSUBH, 0b1001011, 0b10000, RV32Zfh, {nullopt, true}},
         {"fnmadd.h", R4, FNMADDH, 0b1001111, 0b10000, RV32Zfh, {nullopt, true}},
         ...
         {"fence.i", I, FENCEI, 0b0001111, 0b001, Zifencei, {nullopt, false, false, true}},
         {"csrrw", I, CSRRW, 0b1110011, 0b001, Zicsr, {nullopt, false, false, true}},
         {"csrrs", I, CSRRS, 0b1110011, 0b010, Zicsr, {nullopt, false, false, true}},
         {"csrrc", I, CSRRC, 0b1110011, 0b011, Zicsr, {nullopt, false, false, true}},
         {"csrrwi", I, CSRRWI, 0b1110011, 0b101, Zicsr, {nullopt, false, false, true}},
         {"csrrsi", I, CSRRSI, 0b1110011, 0b110, Zicsr, {nullopt, false, false, true}},
         {"csrrci", I, CSRRCI, 0b1110011, 0b111, Zicsr, {nullopt, false, false, true}},
         {"wrs.nto", I, WRSNTO, 0b1110011, 0b000, Zawrs, {nullopt, false, false, true}},
         {"wrs.sto", I, WRSSTO, 0b1110011, 0b000, Zawrs, {nullopt, false, false, true}},
         {"c.lwsp", CI, CLWSP, 0b10, 0b010, C},
         {"c.ldsp", CI, CLDSP, 0b10, 0b011, C},
         {"c.flwsp", CI, CFLWSP, 0b10, 0b011, C},
         {"c.fldsp", CI, CFLDSP, 0b10, 0b001, C},
         {"c.swsp", CSS, CSWSP, 0b10, 0b110, C},
         {"c.sdsp", CSS, CSDSP, 0b10, 0b111, C},
         {"c.fswsp", CSS, CFSWSP, 0b10, 0b111, C},
         {"c.fsdsp", CSS, CFSDSP, 0b10, 0b101, C},
         {"c.lw", CL, CLW, 0b00, 0b010, C},
         {"c.ld", CL, CLD, 0b00, 0b011, C},
         {"c.flw", CL, CFLW, 0b00, 0b011, C},
         {"c.fld", CL, CFLD, 0b00, 0b001, C},
         {"c.sw", CS, CSW, 0b00, 0b110, C},
         {"c.sd", CS, CSD, 0b00, 0b111, C},
         {"c.fsw", CS, CFSW, 0b00, 0b111, C},
         {"c.fsd", CS, CFSD, 0b00, 0b101, C},
         {"c.j", CJ, CJump, 0b01, 0b101, C},
         {"c.jal", CJ, CJAL, 0b01, 0b001, C},
         {"c.jr", CR, CJR, 0b10, 0b1000, C, {0b00000}},
         {"c.jalr", CR, CJALR, 0b10, 0b1001, C, {0b00000}},
         ...
         {"c.srli", CB, CSRLI, 0b01, 0b10000, C},
         {"c.srai", CB, CSRAI, 0b01, 0b10001, C},
         {"c.andi", CB, CANDI, 0b01, 0b10010, C},
         {"c.mv", CR, CMV, 0b10, 0b1000, C},
         {"c.add", CR, CADD, 0b10, 0b1001, C},
         {"c.and", CA, CAND, 0b01, 0b10001111, C},
         {"c.or", CA, COR, 0b01, 0b10001110, C},
         {"c.xor", CA, CXOR, 0b01, 0b10001101, C},
         {"c.sub", CA, CSUB, 0b01, 0b10001100, C},
