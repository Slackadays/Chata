...
const std::array<rvinstruction, 1041> instructions = {{
        ...
        {"beq", BEQ, B, 0b1100011, 0b000, RV32I, 4},
        {"bne", BNE, B, 0b1100011, 0b001, RV32I, 4},
        {"blt", BLT, B, 0b1100011, 0b001, RV32I, 4},
        {"bge", BGE, B, 0b1100011, 0b100, RV32I, 4},
        {"bltu", BLTU, B, 0b1100011, 0b101, RV32I, 4},
        {"bgeu", BGEU, B, 0b1100011, 0b110, RV32I, 4},
        ...
        {"lr.w", LRW, R, 0b0101111, 0b0001000010, RV32A, 4, {.rs2 = 0b00000}},
        {"sc.w", SCW, R, 0b0101111, 0b0001100010, RV32A, 4},
        {"lr.w.aq", LRWAQ, R, 0b0101111, 0b0001010010, RV32A, 4, {.rs2 = 0b00000}},
        {"sc.w.aq", SCWAQ, R, 0b0101111, 0b0001110010, RV32A, 4},
        {"lr.w.rl", LRWRL, R, 0b0101111, 0b0001001010, RV32A, 4, {.rs2 = 0b00000}},
        {"sc.w.rl", SCWRL, R, 0b0101111, 0b0001101010, RV32A, 4},
        {"lr.w.aqrl", LRWAQRL, R, 0b0101111, 0b0001011010, RV32A, 4, {.rs2 = 0b00000}},
        ...
        {"lr.d", LRD, R, 0b0101111, 0b0001000011, RV64A, 4, {.rs2 = 0b00000}},
        {"sc.d", SCD, R, 0b0101111, 0b0001100011, RV64A, 4},
        {"lr.d.aq", LRDAQ, R, 0b0101111, 0b0001010011, RV64A, 4, {.rs2 = 0b00000}},
        {"sc.d.aq", SCDAQ, R, 0b0101111, 0b0001110011, RV64A, 4},
        {"lr.d.rl", LRDRL, R, 0b0101111, 0b0001001011, RV64A, 4, {.rs2 = 0b00000}},
        {"sc.d.rl", SCDRL, R, 0b0101111, 0b0001101011, RV64A, 4},
        {"lr.d.aqrl", LRDAQRL, R, 0b0101111, 0b0001011011, RV64A, 4, {.rs2 = 0b00000}},
        ...
        {"fsqrt.s", FSQRTS, R, 0b1010011, 0b0101100000, RV32F, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        ...
        {"fcvt.w.s", FCVTWS, R, 0b1010011, 0b1100000000, RV32F, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.wu.s", FCVTWUS, R, 0b1010011, 0b1100000000, RV32F, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fmv.x.w", FMVXW, R, 0b1010011, 0b1110000000, RV32F, 4, {.rs2 = 0b00000}},
        ...
        {"fclass.s", FCLASSS, R, 0b1010011, 0b1110000001, RV32F, 4, {.rs2 = 0b00000}},
        {"fcvt.s.w", FCVTSW, R, 0b1010011, 0b1101000000, RV32F, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.s.wu", FCVTSWU, R, 0b1010011, 0b1101000000, RV32F, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fmv.w.x", FMVWX, R, 0b1010011, 0b1111000000, RV32F, 4, {.rs2 = 0b00000}},
        {"flw", FLW, I, 0b0000111, 0b010, RV32F, 4},
        {"fsw", FSW, S, 0b0100111, 0b010, RV32F, 4},
        {"fcvt.l.s", FCVTLS, R, 0b1010011, 0b1100000000, RV64F, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.lu.s", FCVTLUS, R, 0b1010011, 0b1100000000, RV64F, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fcvt.s.l", FCVTSL, R, 0b1010011, 0b1101000000, RV64F, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.s.lu", FCVTSLU, R, 0b1010011, 0b1101000000, RV64F, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        ...
        {"fclass.d", FCLASSD, R, 0b1010011, 0b1110001001, RV32D, 4, {.rs2 = 0b00000}},
        {"fcvt.d.s", FCVTDS, R, 0b1010011, 0b0100001000, RV32D, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.d.w", FCVTDW, R, 0b1010011, 0b1101001000, RV32D, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.d.wu", FCVTDWU, R, 0b1010011, 0b1101001000, RV32D, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fcvt.s.d", FCVTSD, R, 0b1010011, 0b0100000000, RV32D, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fcvt.w.d", FCVTWD, R, 0b1010011, 0b1100001000, RV32D, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.wu.d", FCVTWUD, R, 0b1010011, 0b1100001000, RV32D, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        ...
        {"fsqrt.d", FSQRTD, R, 0b1010011, 0b0101101000, RV32D, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fsub.d", FSUBD, R, 0b1010011, 0b0000101000, RV32D, 4, {.use_frm_for_funct3 = true}},
        {"fcvt.l.d", FCVTLD, R, 0b1010011, 0b1100001000, RV64D, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.lu.d", FCVTLUD, R, 0b1010011, 0b1100001000, RV64D, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fmv.x.d", FMVXD, R, 0b1010011, 0b1110001000, RV64D, 4, {.rs2 = 0b00000}},
        {"fcvt.d.l", FCVTDL, R, 0b1010011, 0b1101001000, RV64D, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.d.lu", FCVTDLU, R, 0b1010011, 0b1101001000, RV64D, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fmv.d.x", FMVDX, R, 0b1010011, 0b1111001000, RV64D, 4, {.rs2 = 0b00000}},
        ...
        {"fsqrt.q", FSQRTQ, R, 0b1010011, 0b0101111000, RV32Q, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        ...
        {"fcvt.s.q", FCVTSQ, R, 0b1010011, 0b0100000000, RV32Q, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fcvt.q.s", FCVTQS, R, 0b1010011, 0b0100011000, RV32Q, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.d.q", FCVTDQ, R, 0b1010011, 0b0100001000, RV32Q, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fcvt.q.d", FCVTQD, R, 0b1010011, 0b0100011000, RV32Q, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        ...
        {"fclass.q", FCLASSQ, R, 0b1010011, 0b1110011001, RV32Q, 4, {.rs2 = 0b00000}},
        {"fcvt.w.q", FCVTWQ, R, 0b1010011, 0b1100011000, RV32Q, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.wu.q", FCVTWUQ, R, 0b1010011, 0b1100011000, RV32Q, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fcvt.q.w", FCVTQW, R, 0b1010011, 0b1101011000, RV32Q, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.q.wu", FCVTQWU, R, 0b1010011, 0b1101011000, RV32Q, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fcvt.l.q", FCVTLQ, R, 0b1010011, 0b1100011000, RV64Q, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.lu.q", FCVTLUQ, R, 0b1010011, 0b1100011000, RV64Q, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fcvt.q.l", FCVTQL, R, 0b1010011, 0b1101011000, RV64Q, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.q.lu", FCVTQLU, R, 0b1010011, 0b1101011000, RV64Q, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        ...
        {"fsqrt.h", FSQRTH, R, 0b1010011, 0b0101110000, RV32Zfh, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        ...
        {"fcvt.s.h", FCVTSH, R, 0b1010011, 0b0100000000, RV32Zfh, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.h.s", FCVTHS, R, 0b1010011, 0b0100010000, RV32Zfh, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.d.h", FCVTDH, R, 0b1010011, 0b0100001000, RV32Zfh, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.h.d", FCVTHD, R, 0b1010011, 0b0100010000, RV32Zfh, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fcvt.q.h", FCVTQH, R, 0b1010011, 0b0100011000, RV32Zfh, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.h.q", FCVTHQ, R, 0b1010011, 0b0100010000, RV32Zfh, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        ...
        {"fclass.h", FCLASSH, R, 0b1010011, 0b1110010001, RV32Zfh, 4, {.rs2 = 0b00000}},
        {"fcvt.w.h", FCVTWH, R, 0b1010011, 0b1100010000, RV32Zfh, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.wu.h", FCVTWUH, R, 0b1010011, 0b1100010000, RV32Zfh, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fmv.x.h", FMVXH, R, 0b1010011, 0b1110010000, RV32Zfh, 4, {.rs2 = 0b00000}},
        {"fcvt.h.w", FCVTHW, R, 0b1010011, 0b1101010000, RV32Zfh, 4, {.rs2 = 0b00000, .use_frm_for_funct3 = true}},
        {"fcvt.h.wu", FCVTHWU, R, 0b1010011, 0b1101010000, RV32Zfh, 4, {.rs2 = 0b00001, .use_frm_for_funct3 = true}},
        {"fmv.h.x", FMVXH, R, 0b1010011, 0b1111010000, RV32Zfh, 4, {.rs2 = 0b00000}},
        {"fcvt.l.h", FCVTLH, R, 0b1010011, 0b1100010000, RV64Zfh, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.lu.h", FCVTLUH, R, 0b1010011, 0b1100010000, RV64Zfh, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        {"fcvt.h.l", FCVTHL, R, 0b1010011, 0b1101010000, RV64Zfh, 4, {.rs2 = 0b00010, .use_frm_for_funct3 = true}},
        {"fcvt.h.lu", FCVTHLU, R, 0b1010011, 0b1101010000, RV64Zfh, 4, {.rs2 = 0b00011, .use_frm_for_funct3 = true}},
        ...
        {"c.flwsp", CFLWSP, CI, 0b10, 0b011, C, 2},
        {"c.fldsp", CFLDSP, CI, 0b10, 0b001, C, 2},
        {"c.swsp", CSWSP, CSS, 0b10, 0b110, C, 2},
        {"c.sdsp", CSDSP, CSS, 0b10, 0b111, C, 2},
        {"c.fswsp", CFSWSP, CSS, 0b10, 0b111, C, 2},
        {"c.fsdsp", CFSDSP, CSS, 0b10, 0b101, C, 2},
        {"c.lw", CLW, CL, 0b00, 0b010, C, 2},
        {"c.ld", CLD, CL, 0b00, 0b011, C, 2},
        {"c.flw", CFLW, CL, 0b00, 0b011, C, 2},
        {"c.fld", CFLD, CL, 0b00, 0b001, C, 2},
        {"c.sw", CSW, CS, 0b00, 0b110, C, 2},
        {"c.sd", CSD, CS, 0b00, 0b111, C, 2},
        {"c.fsw", CFSW, CS, 0b00, 0b111, C, 2},
        {"c.fsd", CFSD, CS, 0b00, 0b101, C, 2},
        {"c.j", CJump, CJ, 0b01, 0b101, C, 2},
        {"c.jal", CJAL, CJ, 0b01, 0b001, C, 2},
        {"c.jr", CJR, CR, 0b10, 0b1000, C, 2, {.rs2 = 0b00000}},
        {"c.jalr", CJALR, CR, 0b10, 0b1001, C, 2, {.rs2 = 0b00000}},
        ...
        {"czero.eqz", CZEROEQZ, R, 0b0110011, 0b0000111101, Zicond, 4},
        {"czero.nez", CZERONEZ, R, 0b0110011, 0b0000111111, Zicond, 4},
        ...
        {"add.uw", ADDUW, R, 0b0111011, 0b0000100000, Bit, 4},
        {"andn", ANDN, R, 0b0110011, 0b0100000111, Bit, 4},
        {"bclr", BCLR, R, 0b0110011, 0b0100100001, Bit, 4},
        {"bclri", BCLRI, R, 0b0010011, 0b0100100001, Bit, 4, {.use_imm_for_rs2 = true}}, // This one "requires" an extra bit in shamt for RV64, but in reality it's a special case where shamt is big
                                                                                         // enough to clear a 64 bit register, so we just add the extra bit to rs2 and let the extra available space
                                                                                         // handle it transparently
        {"bext", BEXT, R, 0b0110011, 0b0100100101, Bit, 4},
        {"bexti", BEXTI, R, 0b0010011, 0b0100100101, Bit, 4, {.use_imm_for_rs2 = true}}, // Same idea as bclri
        {"binv", BINV, R, 0b0110011, 0b0110100001, Bit, 4},
        {"binvi", BINVI, R, 0b0010011, 0b0110100001, Bit, 4, {.use_imm_for_rs2 = true}}, // Same idea as bclri
        {"bset", BSET, R, 0b0110011, 0b0010100001, Bit, 4},
        {"bseti", BSETI, R, 0b0010011, 0b0010100001, Bit, 4, {.use_imm_for_rs2 = true}}, // Same idea as bclri
        {"clmul", CLMUL, R, 0b0110011, 0b0000101001, Bit, 4},
        {"clmulh", CLMULH, R, 0b0110011, 0b0000101011, Bit, 4},
        {"clmulr", CLMULR, R, 0b0110011, 0b0000101010, Bit, 4},
        {"clz", CLZ, R, 0b0010011, 0b0110000001, Bit, 4, {.rs2 = 0b00000}},
        {"clzw", CLZW, R, 0b0011011, 0b0110000001, Bit, 4, {.rs2 = 0b00000}},
        {"cpop", CPOP, R, 0b0010011, 0b0110000001, Bit, 4, {.rs2 = 0b00010}},
        {"cpopw", CPOPW, R, 0b0011011, 0b0110000001, Bit, 4, {.rs2 = 0b00010}},
        {"ctz", CTZ, R, 0b0010011, 0b0110000001, Bit, 4, {.rs2 = 0b00001}},
        {"ctzw", CTZW, R, 0b0011011, 0b0110000001, Bit, 4, {.rs2 = 0b00001}},
        {"max", MAX, R, 0b0110011, 0b0000101110, Bit, 4},
        {"maxu", MAXU, R, 0b0110011, 0b0000101111, Bit, 4},
        {"min", MIN, R, 0b0110011, 0b0000101100, Bit, 4},
        {"minu", MINU, R, 0b0110011, 0b0000101101, Bit, 4},
        {"orc.b", ORCB, R, 0b0010011, 0b0010100101, Bit, 4, {.rs2 = 0b00111}},
        {"orn", ORN, R, 0b0110011, 0b0100000110, Bit, 4},
        {"pack", PACK, R, 0b0110011, 0b0000100100, Bit, 4},
        {"packh", PACKH, R, 0b0110011, 0b0000100111, Bit, 4},
        {"packw", PACKW, R, 0b0111011, 0b0000100100, Bit, 4},
        {"rev8", REV8, R, 0b0010011, 0b0110100101, Bit, 4, {.rs2 = 0b11000}}, // This one is similar to bclri, but it instead makes bit 25 1 on rv64 and otherwise stays the same
        {"rev.b", REVB, R, 0b0010011, 0b0110100101, Bit, 4, {.rs2 = 0b00111}},
        {"rol", ROL, R, 0b0110011, 0b0110000001, Bit, 4},
        {"rolw", ROLW, R, 0b0111011, 0b0110000001, Bit, 4},
        {"ror", ROR, R, 0b0110011, 0b0110000101, Bit, 4},
        {"rori", RORI, R, 0b0010011, 0b0110000101, Bit, 4, {.use_imm_for_rs2 = true}}, // Same idea as bclri
        {"roriw", RORIW, R, 0b0011011, 0b0110000101, Bit, 4, {.use_imm_for_rs2 = true}},
        {"rorw", RORW, R, 0b0111011, 0b0110000101, Bit, 4},
        {"sext.b", SEXTB, R, 0b0010011, 0b0110000001, Bit, 4, {.rs2 = 0b00100}},
        {"sext.h", SEXTH, R, 0b0010011, 0b0110000001, Bit, 4, {.rs2 = 0b00101}},
        {"sh1add", SH1ADD, R, 0b0110011, 0b0010000010, Bit, 4},
        {"sh2add.uw", SH1ADDUW, R, 0b0111011, 0b0010000010, Bit, 4},
        {"sh2add", SH2ADD, R, 0b0110011, 0b0010000100, Bit, 4},
        {"sh2add.uw", SH2ADDUW, R, 0b0111011, 0b0010000100, Bit, 4},
        {"sh3add", SH3ADD, R, 0b0110011, 0b0010000110, Bit, 4},
        {"sh3add.uw", SH3ADDUW, R, 0b0111011, 0b0010000110, Bit, 4},
        {"slli.uw", SLLIUW, R, 0b0011011, 0b000010001, Bit, 4, {.use_imm_for_rs2 = true}},
        {"unzip", UNZIP, R, 0b0010011, 0b0000100101, Bit, 4, {.rs2 = 0b11111}},
        {"xnor", XNOR, R, 0b0110011, 0b0100000100, Bit, 4},
        {"xperm.b", XPERMB, R, 0b0110011, 0b0010100100, Bit, 4},
        {"xperm.n", XPERMN, R, 0b0110011, 0b0010100010, Bit, 4},
        {"zext.h", ZEXTH, R, 0b0110011, 0b0000100100, Bit, 4, {.rs2 = 0b00000}}, // Similar to rev8, but we make bit 4 (in the opcode) 1 instead for rv64
        {"zip", ZIP, R, 0b0010011, 0b0000100001, Bit, 4, {.rs2 = 0b11110}},
        ...
        {"vle8.v", VLE8V, VL, 0b0000111, 0b000001000, V, 4, {.rs2 = 0b00000}},
        {"vle16.v", VLE16V, VL, 0b0000111, 0b000001101, V, 4, {.rs2 = 0b00000}},
        {"vle32.v", VLE32V, VL, 0b0000111, 0b000001110, V, 4, {.rs2 = 0b00000}},
        {"vle64.v", VLE64V, VL, 0b0000111, 0b000001111, V, 4, {.rs2 = 0b00000}},
        {"vse8.v", VSE8V, VS, 0b0100111, 0b000001000, V, 4, {.rs2 = 0b00000}},
        {"vse16.v", VSE16V, VS, 0b0100111, 0b000001101, V, 4, {.rs2 = 0b00000}},
        {"vse32.v", VSE32V, VS, 0b0100111, 0b000001110, V, 4, {.rs2 = 0b00000}},
        {"vse64.v", VSE64V, VS, 0b0100111, 0b000001111, V, 4, {.rs2 = 0b00000}},
        {"vlm.v", VLMV, VL, 0b0000111, 0b0000001000, V, 4, {.rs2 = 0b01011}},
        {"vsm.v", VSMV, VS, 0b0100111, 0b0000001000, V, 4, {.rs2 = 0b01011}},
        ...
        {"vzext.vf2", VZEXTVF2, IVV, 0b1010111, 0b0100101000, V, 4, {.rs1 = 0b00110}},
        {"vsext.vf2", VSEXTVF2, IVV, 0b1010111, 0b0100101000, V, 4, {.rs1 = 0b00111}},
        {"vzext.vf4", VZEXTVF4, IVV, 0b1010111, 0b0100101000, V, 4, {.rs1 = 0b00100}},
        {"vsext.vf4", VSEXTVF4, IVV, 0b1010111, 0b0100101000, V, 4, {.rs1 = 0b00101}},
        {"vzext.vf8", VZEXTVF8, IVV, 0b1010111, 0b0100101000, V, 4, {.rs1 = 0b00010}},
        {"vsext.vf8", VSEXTVF8, IVV, 0b1010111, 0b0100101000, V, 4, {.rs1 = 0b00011}},
        ...
        {"vmv.v.v", VMVVV, IVV, 0b1010111, 0b0101111000, V, 4, {.rs2 = 0b00000}},
        {"vmv.v.x", VMVVX, IVX, 0b1010111, 0b0101111100, V, 4, {.rs2 = 0b00000}},
        {"vmv.v.i", VMVVI, IVI, 0b1010111, 0b0101111011, V, 4, {.rs2 = 0b00000}},
        ...
        {"vfsqrt.v", VFSQRTV, FVV, 0b1010111, 0b0100111001, V, 4, {.rs1 = 0b00000}},
        {"vfrsqrt7.v", VFRSQRT7V, FVV, 0b1010111, 0b0100111001, V, 4, {.rs1 = 0b00100}},
        {"vfrec7.v", VFREC7V, FVV, 0b1010111, 0b0100111001, V, 4, {.rs1 = 0b00101}},
        ...
        {"vfclass.v", VFCLASSV, FVV, 0b1010111, 0b0100111001, V, 4, {.rs1 = 0b10000}},
        {"vfmerge.vfm", VFMERGEVFM, FVF, 0b1010111, 0b0101111101, V, 4},
        {"vfmv.v.f", VFMVVF, FVF, 0b1010111, 0b0101111101, V, 4, {.rs2 = 0b00000}},
        {"vfcvt.xu.f.v", VFCVTXUFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b00000}},
        {"vfcvt.x.f.v", VFCVTXFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b00001}},
        {"vfcvt.rtz.xu.f.v", VFCVTRTZXUFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b00110}},
        {"vfcvt.rtz.x.f.v", VFCVTRTZXFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b00111}},
        {"vfcvt.f.xu.v", VFCVTFXUV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b00010}},
        {"vfcvt.f.x.v", VFCVTFXV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b00011}},
        {"vfwcvt.xu.f.v", VFWCVTXUFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01000}},
        {"vfwcvt.x.f.v", VFWCVTXFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01001}},
        {"vfwcvt.rtz.xu.f.v", VFWCVTRTZXUFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01110}},
        {"vfwcvt.rtz.x.f.v", VFWCVTRTZXFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01111}},
        {"vfwcvt.f.xu.v", VFWCVTFXUV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01010}},
        {"vfwcvt.f.x.v", VFWCVTFXV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01011}},
        {"vfwcvt.f.f.v", VFWCVTFFV, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b01100}},
        {"vfncvt.xu.f.w", VFNCVTXUFW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10000}},
        {"vfncvt.x.f.w", VFNCVTXFW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10001}},
        {"vfncvt.rtz.xu.f.w", VFNCVTRTZXUFW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10110}},
        {"vfncvt.rtz.x.f.w", VFNCVTRTZXFW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10111}},
        {"vfncvt.f.xu.w", VFNCVTFXUW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10010}},
        {"vfncvt.f.x.w", VFNCVTFXW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10011}},
        {"vfncvt.f.f.w", VFNCVTFFW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10100}},
        {"vfncvt.rod.f.f.w", VFNCVTRODFFW, FVV, 0b1010111, 0b0100101001, V, 4, {.rs1 = 0b10101}},
        ...
        {"vcpop.m", VCPOPM, MVV, 0b1010111, 0b0100001010, V, 4, {.rs1 = 0b10000}},
        {"vfirst.m", VFIRSTM, MVV, 0b1010111, 0b0100001010, V, 4, {.rs1 = 0b10001}},
        {"vmsbf.m", VMSBFM, MVV, 0b1010111, 0b0101001010, V, 4, {.rs1 = 0b00001}},
        {"vmsif.m", VMSIFM, MVV, 0b1010111, 0b0101001010, V, 4, {.rs1 = 0b00011}},
        {"vmsof.m", VMSOFM, MVV, 0b1010111, 0b0101001010, V, 4, {.rs1 = 0b00010}},
        {"viota.m", VIOTAM, MVV, 0b1010111, 0b0101001010, V, 4, {.rs1 = 0b10000}},
        {"vid.v", VIDV, MVV, 0b1010111, 0b0101001010, V, 4, {.rs1 = 0b10001}},
        {"vmv.x.s", VMVXS, MVV, 0b1010111, 0b0101001010, V, 4, {.rs1 = 0b00000}},
        {"vmv.s.x", VMVSX, MVX, 0b1010111, 0b0100001110, V, 4, {.rs1 = 0b00000}},
        {"vfmv.f.s", VFMVFS, FVV, 0b1010111, 0b0100001001, V, 4, {.rs1 = 0b00000}},
        {"vfmv.s.f", VFMVSF, FVF, 0b1010111, 0b0100001101, V, 4, {.rs1 = 0b00000}},
        ...
        {"vmv1r.v", VMV1RV, IVV, 0b1010111, 0b1001111011, V, 4, {.rs1 = 0b00000}}, // Actually IVI, but we just need a custom rs1 value
        {"vmv2r.v", VMV2RV, IVV, 0b1010111, 0b1001111011, V, 4, {.rs1 = 0b00001}},
        {"vmv4r.v", VMV4RV, IVV, 0b1010111, 0b1001111011, V, 4, {.rs1 = 0b00011}},
        {"vmv8r.v", VMV8RV, IVV, 0b1010111, 0b1001111011, V, 4, {.rs1 = 0b00111}}}};
