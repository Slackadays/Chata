...
const std::array<rvinstruction, 273> instructions = {
        {{"lui", U, LUI, 0b0110111, 0b000, RV32I},
         ...
         {"fsq", S, FSQ, 0b1000111, 0b100, RV32Q},
         {"fmadd.q", R4, FMADDQ, 0b1000011, 0b000, RV32Q, {nullopt, true}},
        {"fmsub.q", R4, FMSUBQ, 0b1000111, 0b000, RV32Q, {nullopt, true}},
        {"fnmsub.q", R4, FNMSUBQ, 0b1001011, 0b000, RV32Q, {nullopt, true}},
        {"fnmadd.q", R4, FNMADDQ, 0b1001111, 0b000, RV32Q, {nullopt, true}},
