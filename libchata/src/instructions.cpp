...
const std::array<rvinstruction, 171> instructions = {
        {{"lui", U, LUI, 0b0110111, 0b000, RV32I},
         ...
         {"slli", R, SLLI, 0b0010011, 0b0000000001, RV32I},
         {"srli", R, SRLI, 0b0010011, 0b0000000101, RV32I},
         {"srai", R, SRAI, 0b0010011, 0b0100000101, RV32I},
         ...
         {"slliw", R, SLLIW, 0b0011011, 0b0000000001, RV64I},
         {"srliw", R, SRLIW, 0b0011011, 0b0000000101, RV64I},
         {"sraiw", R, SRAIW, 0b0011011, 0b0100000101, RV64I},
         ...
         {"fmadd.d", R4, FMADDD, 0b1000011, 0b01, RV32D, {nullopt, true}},
         ...
         {"fdiv.d", R, FDIVD, 0b1010011, 0b0001110000, RV32D, {nullopt, true}},
         ...
         {"fmsub.d", R4, FMSUBD, 0b1000011, 0b01, RV32D, {nullopt, true}},
         {"fmul.d", R, FMULD, 0b1010011, 0b0001001000, RV32D, {nullopt,true}},
         {"fnmadd.d", R4, FNMADDD, 0b1000011, 0b01, RV32D},
         {"fnmsub.d", R4, FNMSUBD, 0b1000011, 0b01, RV32D, {nullopt, true}},
