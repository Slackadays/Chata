...
const std::array<rvinstruction, 170> instructions = {
        {{"lui", U, LUI, 0b0110111, 0b000, RV32I},
         ...
         {"fmadd.s", R, FMADDS, 0b1000011, 0b00, RV32F},
         {"fmsub.s", R, FMSUBS, 0b1000011, 0b00, RV32F},
         {"fnmsub.s", R, FNMSUBS, 0b1000011, 0b00, RV32F},
         {"fnmadd.s", R, FNMADDS, 0b1000011, 0b00, RV32F},
         ...
         {"fsqrt.s", R, FSQRTS, 0b1010011, 0b0101100, RV32F},
         ...
         {"fcvt.w.s", R, FCVTWS, 0b1010011, 0b110000000000, RV32F},
         {"fcvt.wu.s", R, FCVTWUS, 0b1010011, 0b110000000001, RV32F},
         {"fmv.x.w", R, FMVXW, 0b1010011, 0b111000000000, RV32F},
         ...
         {"fclass.s", R, FCLASSS, 0b1010011, 0b111000000000, RV32F},
         {"fcvt.s.w", R, FCVTSW, 0b1010011, 0b110100000000, RV32F},
         {"fcvt.s.wu", R, FCVTSWU, 0b1010011, 0b110100000001, RV32F},
         {"fmv.w.x", R, FMVWX, 0b1010011, 0b111100000000, RV32F},
         {"flw", I, FLW, 0b0000111, 0b010, RV32F},
         {"fsw", S, FSW, 0b0100111, 0b010, RV32F},
         {"fcvt.l.s", R, FCVTLS, 0b1010011, 0b110000000010, RV64F},
         {"fcvt.lu.s", R, FCVTLUS, 0b1010011, 0b110000000011, RV64F},
         {"fcvt.s.l", R, FCVTSL, 0b1010011, 0b110100000010, RV64F},
         {"fcvt.s.lu", R, FCVTSLU, 0b1010011, 0b110100000011, RV64F},
         {"fadd.d", R, FADDD, 0b1000011, 0b0000001, RV32D},
         {"fmadd.d", R, FMADDD, 0b1000011, 0b01, RV32D},
         {"fclass.d", R, FCLASSD, 0b1010011, 0b111000100000, RV32D},
         {"fcvt.d.h", R, FCVTDH, 0b1010011, 0b010000100010, RV32D},
         {"fcvt.d.s", R, FCVTDS, 0b1010011, 0b010000100000, RV32D},
         {"fcvt.d.w", R, FCVTDW, 0b1010011, 0b110100100000, RV32D},
         {"fcvt.d.wu", R, FCVTDWU, 0b1010011, 0b110100100001, RV32D},
         {"fcvt.h.d", R, FCVTHD, 0b1010011, 0b010001000001, RV32D},
         {"fcvt.s.d", R, FCVTSD, 0b1010011, 0b010000000001, RV32D},
         {"fcvt.w.d", R, FCVTWD, 0b1010011, 0b110000100000, RV32D},
         {"fcvt.wu.d", R, FCVTWUD, 0b1010011, 0b110000100001, RV32D},
         ...
         {"fmsub.d", R, FMSUBD, 0b1000011, 0b01, RV32D},
         {"fmul.d", R, FMULD, 0b1010011, 0b00010001, RV32D},
         {"fnmadd.d", R, FNMADDD, 0b1000011, 0b01, RV32D},
         {"fnmsub.d", R, FNMSUBD, 0b1000011, 0b01, RV32D},
         ...
         {"fsqrt.d", R, FSQRTD, 0b1010011, 0b010110100000, RV32D},
         {"fsub.d", R, FSUBD, 0b1010011, 0b0000101, RV32D},
         {"fcvt.l.d", R, FCVTLD, 0b1010011, 0b110000100010, RV64D},
         {"fcvt.lu.d", R, FCVTLUD, 0b1010011, 0b110000100011, RV64D},
         {"fmv.x.d", R, FMVDX, 0b1010011, 0b111000100000, RV64D},
         {"fcvt.d.l", R, FCVTDL, 0b1010011, 0b110100100010, RV64D},
         {"fcvt.d.lu", R, FCVTDLU, 0b1010011, 0b110100100011, RV64D},
         {"fmv.d.x", R, FMVDX, 0b1010011, 0b111100100000, RV64D},
