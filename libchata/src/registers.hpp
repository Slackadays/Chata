...
constexpr std::array<rvregister, 96> registers = {
        {{"x0", "zero", RegisterType::Integer, RegisterID::x0, 0},
         ...
         {"f0", "ft0", RegisterType::FloatingPoint, RegisterID::f0, 0},
         {"f1", "ft1", RegisterType::FloatingPoint, RegisterID::f1, 1},
         {"f2", "ft2", RegisterType::FloatingPoint, RegisterID::f2, 2},
         {"f3", "ft3", RegisterType::FloatingPoint, RegisterID::f3, 3},
         {"f4", "ft4", RegisterType::FloatingPoint, RegisterID::f4, 4},
         {"f5", "ft5", RegisterType::FloatingPoint, RegisterID::f5, 5},
         {"f6", "ft6", RegisterType::FloatingPoint, RegisterID::f6, 6},
         {"f7", "ft7", RegisterType::FloatingPoint, RegisterID::f7, 7},
         {"f8", "fs0", RegisterType::FloatingPoint, RegisterID::f8, 8},
         {"f9", "fs1", RegisterType::FloatingPoint, RegisterID::f9, 9},
         {"f10", "fa0", RegisterType::FloatingPoint, RegisterID::f10, 10},
         {"f11", "fa1", RegisterType::FloatingPoint, RegisterID::f11, 11},
         {"f12", "fa2", RegisterType::FloatingPoint, RegisterID::f12, 12},
         {"f13", "fa3", RegisterType::FloatingPoint, RegisterID::f13, 13},
         {"f14", "fa4", RegisterType::FloatingPoint, RegisterID::f14, 14},
         {"f15", "fa5", RegisterType::FloatingPoint, RegisterID::f15, 15},
         {"f16", "fa6", RegisterType::FloatingPoint, RegisterID::f16, 16},
         {"f17", "fa7", RegisterType::FloatingPoint, RegisterID::f17, 17},
         {"f18", "fs2", RegisterType::FloatingPoint, RegisterID::f18, 18},
         {"f19", "fs3", RegisterType::FloatingPoint, RegisterID::f19, 19},
         {"f20", "fs4", RegisterType::FloatingPoint, RegisterID::f20, 20},
         {"f21", "fs5", RegisterType::FloatingPoint, RegisterID::f21, 21},
         {"f22", "fs6", RegisterType::FloatingPoint, RegisterID::f22, 22},
         {"f23", "fs7", RegisterType::FloatingPoint, RegisterID::f23, 23},
         {"f24", "fs8", RegisterType::FloatingPoint, RegisterID::f24, 24},
         {"f25", "fs9", RegisterType::FloatingPoint, RegisterID::f25, 25},
         {"f26", "fs10", RegisterType::FloatingPoint, RegisterID::f26, 26},
         {"f27", "fs11", RegisterType::FloatingPoint, RegisterID::f27, 27},
         {"f28", "ft8", RegisterType::FloatingPoint, RegisterID::f28, 28},
         {"f29", "ft9", RegisterType::FloatingPoint, RegisterID::f29, 29},
         {"f30", "ft10", RegisterType::FloatingPoint, RegisterID::f30, 30},
         {"f31", "ft11", RegisterType::FloatingPoint, RegisterID::f31, 31},
