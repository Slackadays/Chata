...
const uint16_t fast_csr_search(const chatastring& csr) {
                ...
                if (csr[3] == 'e') {
                    ...
                    if (csr[4] == 'l') {
                        ...
                        if (csr[5] == 'e') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 94;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 99;
                                }
                            }
                        }
                    }
                ...
                if (csr[3] == 'v') {
                    ...
                    if (csr[4] == 'c') {
                        ...
                        if (csr[5] == 'f') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 105;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 106;
                                }
                            }
                        }
                    }
                        ...
                        if (csr[5] == 'e') {
                            ...
                            if (csr[6] == 'e') {
                                ...
                                if (csr[7] == 'n') {
                                    if (csr.size() < 9) return csr_search_failed;
                                    if (csr[8] == '0') {
                                        if (csr.size() < 10) return 111;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 115;
                                        }
                                    }
                                    if (csr[8] == '1') {
                                        if (csr.size() < 10) return 112;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 116;
                                        }
                                    }
                                    if (csr[8] == '2') {
                                        if (csr.size() < 10) return 113;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 117;
                                        }
                                    }
                                    if (csr[8] == '3') {
                                        if (csr.size() < 10) return 114;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 118;
                                        }
                                    }
                                }
                            }
                                    ...
                                    if (csr[8] == 'e') {
                                        ...
                                        if (csr[9] == 'r') {
                                            ...
                                            if (csr[10] == '1') {
                                                ...
                                                if (csr[11] == '0') {
                                                    if (csr.size() < 13) return 21;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 53;
                                                    }
                                                }
                                                if (csr[11] == '1') {
                                                    if (csr.size() < 13) return 22;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 54;
                                                    }
                                                }
                                                if (csr[11] == '2') {
                                                    if (csr.size() < 13) return 23;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 55;
                                                    }
                                                }
                                                if (csr[11] == '3') {
                                                    if (csr.size() < 13) return 24;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 56;
                                                    }
                                                }
                                                if (csr[11] == '4') {
                                                    if (csr.size() < 13) return 25;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 57;
                                                    }
                                                }
                                                if (csr[11] == '5') {
                                                    if (csr.size() < 13) return 26;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 58;
                                                    }
                                                }
                                                if (csr[11] == '6') {
                                            ...
                                            if (csr[10] == '4') {
                                                if (csr.size() < 12) return 15;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 47;
                                                }
                                            }
                                            if (csr[10] == '5') {
                                                if (csr.size() < 12) return 16;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 48;
                                                }
                                            }
                                            if (csr[10] == '6') {
                                                if (csr.size() < 12) return 17;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 49;
                                                }
                                            }
                                            if (csr[10] == '7') {
                                                if (csr.size() < 12) return 18;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 50;
                                                }
                                            }
                                            if (csr[10] == '8') {
                                                if (csr.size() < 12) return 19;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 51;
                                                }
                                            }
                                            if (csr[10] == '9') {
                            ...
                            if (csr[6] == 'e') {
                                ...
                                if (csr[7] == 'l') {
                                    ...
                                    if (csr[8] == 't') {
                                        if (csr.size() < 10) return csr_search_failed;
                                        if (csr[9] == 'a') {
                                            if (csr.size() < 11) return 109;
                                            if (csr[10] == 'h') {
                                                if (csr.size() < 12) return 110;
                                            }
                                        }
                                    }
                                }
                        ...
                        if (csr[5] == 't') {
                            ...
                            if (csr[6] == 'c') {
                                ...
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return csr_search_failed;
                                    if (csr[8] == '0') {
                                        if (csr.size() < 10) return 373;
                                    }
                                    if (csr[8] == '1') {
                                        if (csr.size() < 10) return 374;
                                    }
                                }
                            }
                        }
    ...
    if (csr[0] == 's') {
                        ...
                        if (csr[5] == 'e') {
                            ...
                            if (csr[6] == 'e') {
                                ...
                                if (csr[7] == 'n') {
                                    if (csr.size() < 9) return csr_search_failed;
                                    if (csr[8] == '0') {
                                        if (csr.size() < 10) return 89;
                                    }
                                    if (csr[8] == '1') {
                                        if (csr.size() < 10) return 90;
                                    }
                                    if (csr[8] == '2') {
                                        if (csr.size() < 10) return 91;
                                    }
                                    if (csr[8] == '3') {
        ...
        if (csr[1] == 't') {
            ...
            if (csr[2] == 'v') {
                ...
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'c') {
                        if (csr.size() < 6) return 77;
                    }
                }
                if (csr[3] == 'a') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'l') {
                        if (csr.size() < 6) return 84;
                    }
                }
            }
        }
        if (csr[1] == 'i') {
            if (csr.size() < 3) return csr_search_failed;
            if (csr[2] == 'e') {
                if (csr.size() < 4) return 76;
            }
            if (csr[2] == 'p') {
                if (csr.size() < 4) return 85;
            }
        }
    }
    if (csr[0] == 'p') {
                ...
                if (csr[3] == 'c') {
                    ...
                    if (csr[4] == 'f') {
                        ...
                        if (csr[5] == 'g') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == '0') {
                                if (csr.size() < 8) return 153;
                            }
                            if (csr[6] == '1') {
                                if (csr.size() < 8) return 154;
                                if (csr[7] == '0') {
                                    if (csr.size() < 9) return 163;
                                }
                                if (csr[7] == '1') {
                                    if (csr.size() < 9) return 164;
                                }
                                if (csr[7] == '2') {
                                    if (csr.size() < 9) return 165;
                                }
                                if (csr[7] == '3') {
                                    if (csr.size() < 9) return 166;
                                }
                                if (csr[7] == '4') {
                                    if (csr.size() < 9) return 167;
                                }
                                if (csr[7] == '5') {
                                    if (csr.size() < 9) return 168;
                                }
                            }
                            if (csr[6] == '2') {
                            ...
                            if (csr[6] == '3') {
                                if (csr.size() < 8) return 156;
                            }
                            if (csr[6] == '4') {
                                if (csr.size() < 8) return 157;
                            }
                            if (csr[6] == '5') {
                                if (csr.size() < 8) return 158;
                            }
                            if (csr[6] == '6') {
                        ...
                        if (csr[5] == 'd') {
                            ...
                            if (csr[6] == 'r') {
                                ...
                                if (csr[7] == '1') {
                                    ...
                                    if (csr[8] == '0') {
                                        if (csr.size() < 10) return 179;
                                    }
                                    if (csr[8] == '1') {
                                        if (csr.size() < 10) return 180;
                                    }
                                    if (csr[8] == '2') {
                                        if (csr.size() < 10) return 181;
                                    }
                                    if (csr[8] == '3') {
                                        if (csr.size() < 10) return 182;
                                    }
                                    if (csr[8] == '4') {
                                        if (csr.size() < 10) return 183;
                                    }
                                    if (csr[8] == '5') {
                                        if (csr.size() < 10) return 184;
                                    }
                                    if (csr[8] == '6') {
    ...
    if (csr[0] == 't') {
            ...
            if (csr[2] == 'a') {
                ...
                if (csr[3] == 't') {
                    ...
                    if (csr[4] == 'a') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == '1') {
                            if (csr.size() < 7) return 367;
                        }
                        if (csr[5] == '2') {
                            if (csr.size() < 7) return 368;
                        }
                        if (csr[5] == '3') {
                            if (csr.size() < 7) return 369;
                        }
                    }
                }
            }
        ...
        if (csr[1] == 'i') {
            ...
            if (csr[2] == 'm') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return 12;
                    if (csr[4] == 'h') {
                        if (csr.size() < 6) return 44;
                    }
                }
            }
        }
    ...
    if (csr[0] == 'm') {
            ...
            if (csr[2] == 'y') {
                ...
                if (csr[3] == 'c') {
                    ...
                    if (csr[4] == 'l') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == 'e') {
                            if (csr.size() < 7) return 245;
                            if (csr[6] == 'h') {
                                if (csr.size() < 8) return 276;
                            }
                        }
                    }
                }
                ...
                if (csr[3] == 'v') {
                    ...
                    if (csr[4] == 'c') {
                        ...
                        if (csr[5] == 'f') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 149;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 150;
                                }
                            }
                        }
                    }
                                        ...
                                        if (csr[9] == 'e') {
                                            ...
                                            if (csr[10] == 'r') {
                                                ...
                                                if (csr[11] == '1') {
                                                    if (csr.size() < 13) return csr_search_failed;
                                                    if (csr[12] == '0') {
                                                        if (csr.size() < 14) return 254;
                                                        if (csr[13] == 'h') {
                                                            if (csr.size() < 15) return 285;
                                                        }
                                                    }
                                                    if (csr[12] == '1') {
                                                        if (csr.size() < 14) return 255;
                                                        if (csr[13] == 'h') {
                                                            if (csr.size() < 15) return 286;
                                                        }
                                                    }
                                                    if (csr[12] == '2') {
                                                        if (csr.size() < 14) return 256;
                                                        if (csr[13] == 'h') {
                                                            if (csr.size() < 15) return 287;
                                                        }
                                                    }
                                                    if (csr[12] == '3') {
                                                        if (csr.size() < 14) return 257;
                                                        if (csr[13] == 'h') {
                                                            if (csr.size() < 15) return 288;
                                                        }
                                                    }
                                                    if (csr[12] == '4') {
                                                        if (csr.size() < 14) return 258;
                                                        if (csr[13] == 'h') {
                                                            if (csr.size() < 15) return 289;
                                                        }
                                                    }
                                                    if (csr[12] == '5') {
                                                        if (csr.size() < 14) return 259;
                                                        if (csr[13] == 'h') {
                                                            if (csr.size() < 15) return 290;
                                                        }
                                                    }
                                                    if (csr[12] == '6') {
                                                ...
                                                if (csr[11] == '4') {
                                                    if (csr.size() < 13) return 248;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 279;
                                                    }
                                                }
                                                if (csr[11] == '5') {
                                                    if (csr.size() < 13) return 249;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 280;
                                                    }
                                                }
                                                if (csr[11] == '6') {
                                                    if (csr.size() < 13) return 250;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 281;
                                                    }
                                                }
                                                if (csr[11] == '7') {
                                                    if (csr.size() < 13) return 251;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 282;
                                                    }
                                                }
                                                if (csr[11] == '8') {
                                                    if (csr.size() < 13) return 252;
                                                    if (csr[12] == 'h') {
                                                        if (csr.size() < 14) return 283;
                                                    }
                                                }
                                                if (csr[11] == '9') {
                                ...
                                if (csr[7] == 'n') {
                                    ...
                                    if (csr[8] == 't') {
                                        ...
                                        if (csr[9] == '1') {
                                            if (csr.size() < 11) return csr_search_failed;
                                            if (csr[10] == '0') {
                                                if (csr.size() < 12) return 315;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 344;
                                                }
                                            }
                                            if (csr[10] == '1') {
                                                if (csr.size() < 12) return 316;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 345;
                                                }
                                            }
                                            if (csr[10] == '2') {
                                                if (csr.size() < 12) return 317;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 346;
                                                }
                                            }
                                            if (csr[10] == '3') {
                                                if (csr.size() < 12) return 318;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 347;
                                                }
                                            }
                                            if (csr[10] == '4') {
                                                if (csr.size() < 12) return 319;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 348;
                                                }
                                            }
                                            if (csr[10] == '5') {
                                                if (csr.size() < 12) return 320;
                                                if (csr[11] == 'h') {
                                                    if (csr.size() < 13) return 349;
                                                }
                                            }
                                            if (csr[10] == '6') {
                                        ...
                                        if (csr[9] == '4') {
                                            if (csr.size() < 11) return 309;
                                            if (csr[10] == 'h') {
                                                if (csr.size() < 12) return 338;
                                            }
                                        }
                                        if (csr[9] == '5') {
                                            if (csr.size() < 11) return 310;
                                            if (csr[10] == 'h') {
                                                if (csr.size() < 12) return 339;
                                            }
                                        }
                                        if (csr[9] == '6') {
                                            if (csr.size() < 11) return 311;
                                            if (csr[10] == 'h') {
                                                if (csr.size() < 12) return 340;
                                            }
                                        }
                                        if (csr[9] == '7') {
                                            if (csr.size() < 11) return 312;
                                            if (csr[10] == 'h') {
                                                if (csr.size() < 12) return 341;
                                            }
                                        }
                                        if (csr[9] == '8') {
                                            if (csr.size() < 11) return 313;
                                            if (csr[10] == 'h') {
                ...
                if (csr[3] == 'c') {
                    ...
                    if (csr[4] == 'c') {
                        ...
                        if (csr[5] == 'f') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 151;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 152;
                                }
                            }
                        }
                    }
                ...
                if (csr[3] == 'a') {
                    ...
                    if (csr[4] == 't') {
                            ...
                            if (csr[6] == 'e') {
                                ...
                                if (csr[7] == 'n') {
                                    ...
                                    if (csr[8] == '0') {
                                        ...
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 237;
                                        }
                                    }
                                    if (csr[8] == '1') {
                                        if (csr.size() < 10) return 234;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 238;
                                        }
                                    }
                                    if (csr[8] == '2') {
                                        if (csr.size() < 10) return 235;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 239;
                                        }
                                    }
                                    if (csr[8] == '3') {
                                        if (csr.size() < 10) return 236;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 240;
                                        }
                                    }
                                }
                            }
                        ...
                        if (csr[5] == 'u') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 's') {
                                if (csr.size() < 8) return 133;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 140;
                                }
                            }
                        }
                    }
        ...
        if (csr[1] == 't') {
            ...
            if (csr[2] == 'v') {
                ...
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'c') {
                        if (csr.size() < 6) return 138;
                    }
                }
                if (csr[3] == 'a') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'l') {
                        if (csr.size() < 6) return 145;
                        if (csr[5] == '2') {
                            if (csr.size() < 7) return 148;
                        }
                    }
                }
            }
        ...
        if (csr[1] == 'i') {
            ...
            if (csr[2] == 's') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'a') {
                    if (csr.size() < 5) return 134;
                }
            }
            if (csr[2] == 'p') {
                if (csr.size() < 4) return 146;
            }
            if (csr[2] == 'm') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'p') {
                    ...
                    if (csr[4] == 't') {
                        ...
                        if (csr[5] == 'r') {
                            ...
                            if (csr[6] == 'e') {
                                if (csr.size() < 8) return csr_search_failed;
                                if (csr[7] == 't') {
                                    if (csr.size() < 9) return 246;
                                    if (csr[8] == 'h') {
                                        if (csr.size() < 10) return 277;
                                    }
                                }
                            }
                        }
    ...
    if (csr[0] == 'v') {
        ...
        if (csr[1] == 'c') {
            ...
            if (csr[2] == 's') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'r') {
                    if (csr.size() < 5) return 6;
                }
            }
        }
        if (csr[1] == 'l') {
            if (csr.size() < 3) return 7;
            if (csr[2] == 'e') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'n') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'b') {
                        if (csr.size() < 6) return 9;
                    }
                }
            }
        }
            ...
            if (csr[2] == 't') {
                ...
                if (csr[3] == 'v') {
                    ...
                    if (csr[4] == 'e') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == 'c') {
                            if (csr.size() < 7) return 121;
                        }
                    }
                    if (csr[4] == 'a') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == 'l') {
                            if (csr.size() < 7) return 125;
                        }
                    }
                }
            }
                ...
                if (csr[3] == 't') {
                    ...
                    if (csr[4] == 'r') {
                        ...
                        if (csr[5] == 'e') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 't') {
                                if (csr.size() < 8) return 13;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 45;
                                }
                            }
                        }
                    }
