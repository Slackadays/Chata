                                        ...
                                        if (inst[9] == 'n') {
                                            ...
                                            if (inst[10] == '.') {
                                                ...
                                                if (inst[11] == 'v') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'i') {
                                                        if (inst.size() < 14) return 1098;
                                                    }
                                                    if (inst[12] == 'x') {
                                                        if (inst.size() < 14) return 1097;
                                                    }
                                                }
                                            }
                                        }
                    ...
                    if (inst[4] == 'x') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1018;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1019;
                                }
                            }
                        }
                    }
