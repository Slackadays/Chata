...
using enum RVInstructionSetRequirements;
using std::nullopt;

const std::array<rvinstruction, 1192> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, RV32E_RV32I, 4},
         {"auipc", AUIPC, U, OP_AUIPC, 0b000, RV32E_RV32I, 4},
         {"jal", JAL, J, OP_JAL, 0b000, RV32E_RV32I, 4},
         {"jalr", JALR, I, OP_JALR, 0b000, RV32E_RV32I, 4},
         {"beq", BEQ, Branch, OP_BRANCH, 0b000, RV32E_RV32I, 4},
         {"bne", BNE, Branch, OP_BRANCH, 0b001, RV32E_RV32I, 4},
         {"blt", BLT, Branch, OP_BRANCH, 0b001, RV32E_RV32I, 4},
         {"bge", BGE, Branch, OP_BRANCH, 0b100, RV32E_RV32I, 4},
         {"bltu", BLTU, Branch, OP_BRANCH, 0b101, RV32E_RV32I, 4},
         {"bgeu", BGEU, Branch, OP_BRANCH, 0b110, RV32E_RV32I, 4},
         {"lb", LB, I, OP_LOAD, 0b000, RV32E_RV32I, 4},
         {"lh", LH, I, OP_LOAD, 0b001, RV32E_RV32I, 4},
         {"lw", LW, I, OP_LOAD, 0b010, RV32E_RV32I, 4},
         {"lbu", LBU, I, OP_LOAD, 0b100, RV32E_RV32I, 4},
         {"lhu", LHU, I, OP_LOAD, 0b101, RV32E_RV32I, 4},
         {"sb", SB, S, OP_STORE, 0b000, RV32E_RV32I, 4},
         {"sh", SH, S, OP_STORE, 0b001, RV32E_RV32I, 4},
         {"sw", SW, S, OP_STORE, 0b010, RV32E_RV32I, 4},
         {"addi", ADDI, I, OP_IMM, 0b000, RV32E_RV32I, 4},
         {"slti", SLTI, I, OP_IMM, 0b010, RV32E_RV32I, 4},
         {"sltiu", SLTIU, I, OP_IMM, 0b011, RV32E_RV32I, 4},
         {"xori", XORI, I, OP_IMM, 0b100, RV32E_RV32I, 4},
         {"ori", ORI, I, OP_IMM, 0b110, RV32E_RV32I, 4},
         {"andi", ANDI, I, OP_IMM, 0b111, RV32E_RV32I, 4},
         {"slli", SLLI, R, OP_IMM, 0b0000000001, RV32E_RV32I, 4, {.use_imm_for_rs = true}},
         {"srli", SRLI, R, OP_IMM, 0b0000000101, RV32E_RV32I, 4, {.use_imm_for_rs = true}},
         {"srai", SRAI, R, OP_IMM, 0b0100000101, RV32E_RV32I, 4, {.use_imm_for_rs = true}},
         {"add", ADD, R, OP_OP, 0b0000000000, RV32E_RV32I, 4},
         {"sub", SUB, R, OP_OP, 0b0100000000, RV32E_RV32I, 4},
         {"sll", SLL, R, OP_OP, 0b0000000001, RV32E_RV32I, 4},
         {"slt", SLT, R, OP_OP, 0b0000000010, RV32E_RV32I, 4},
         {"sltu", SLTU, R, OP_OP, 0b0000000011, RV32E_RV32I, 4},
         {"xor", XOR, R, OP_OP, 0b0000000100, RV32E_RV32I, 4},
         {"srl", SRL, R, OP_OP, 0b0000000101, RV32E_RV32I, 4},
         {"sra", SRA, R, OP_OP, 0b0100000101, RV32E_RV32I, 4},
         {"or", OR, R, OP_OP, 0b0000000110, RV32E_RV32I, 4},
         {"and", AND, R, OP_OP, 0b0000000111, RV32E_RV32I, 4},
         {"fence", FENCE, I, OP_MISC_MEM, 0b000, RV32E_RV32I, 4, {.super_special_snowflake = true}},
         {"fence.tso", FENCETSO, I, OP_MISC_MEM, 0b000, RV32E_RV32I, 4, {.super_special_snowflake = true}},
         {"pause", PAUSE, I, OP_MISC_MEM, 0b000, RV32E_RV32I, 4, {.super_special_snowflake = true}},
         {"ecall", ECALL, I, OP_SYSTEM, 0b000, RV32E_RV32I, 4, {.super_special_snowflake = true}},
         {"ebreak", EBREAK, I, OP_SYSTEM, 0b000, RV32E_RV32I, 4, {.super_special_snowflake = true}},
