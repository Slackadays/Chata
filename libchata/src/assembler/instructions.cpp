...
const std::array<rvinstruction, 1192> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, I, 4},
         {"auipc", AUIPC, U, OP_AUIPC, 0b000, I, 4},
         {"jal", JAL, J, OP_JAL, 0b000, I, 4},
         {"jalr", JALR, I, OP_JALR, 0b000, I, 4},
         {"beq", BEQ, Branch, OP_BRANCH, 0b000, I, 4},
         {"bne", BNE, Branch, OP_BRANCH, 0b001, I, 4},
         {"blt", BLT, Branch, OP_BRANCH, 0b001, I, 4},
         {"bge", BGE, Branch, OP_BRANCH, 0b100, I, 4},
         {"bltu", BLTU, Branch, OP_BRANCH, 0b101, I, 4},
         {"bgeu", BGEU, Branch, OP_BRANCH, 0b110, I, 4},
         {"lb", LB, I, OP_LOAD, 0b000, I, 4},
         {"lh", LH, I, OP_LOAD, 0b001, I, 4},
         {"lw", LW, I, OP_LOAD, 0b010, I, 4},
         {"lbu", LBU, I, OP_LOAD, 0b100, I, 4},
         {"lhu", LHU, I, OP_LOAD, 0b101, I, 4},
         {"sb", SB, S, OP_STORE, 0b000, I, 4},
         {"sh", SH, S, OP_STORE, 0b001, I, 4},
         {"sw", SW, S, OP_STORE, 0b010, I, 4},
         {"addi", ADDI, I, OP_IMM, 0b000, I, 4},
         {"slti", SLTI, I, OP_IMM, 0b010, I, 4},
         {"sltiu", SLTIU, I, OP_IMM, 0b011, I, 4},
         {"xori", XORI, I, OP_IMM, 0b100, I, 4},
         {"ori", ORI, I, OP_IMM, 0b110, I, 4},
         {"andi", ANDI, I, OP_IMM, 0b111, I, 4},
         {"slli", SLLI, R, OP_IMM, 0b0000000001, I, 4, {.use_imm_for_rs = true}},
         {"srli", SRLI, R, OP_IMM, 0b0000000101, I, 4, {.use_imm_for_rs = true}},
         {"srai", SRAI, R, OP_IMM, 0b0100000101, I, 4, {.use_imm_for_rs = true}},
         {"add", ADD, R, OP_OP, 0b0000000000, I, 4},
         {"sub", SUB, R, OP_OP, 0b0100000000, I, 4},
         {"sll", SLL, R, OP_OP, 0b0000000001, I, 4},
         {"slt", SLT, R, OP_OP, 0b0000000010, I, 4},
         {"sltu", SLTU, R, OP_OP, 0b0000000011, I, 4},
         {"xor", XOR, R, OP_OP, 0b0000000100, I, 4},
         {"srl", SRL, R, OP_OP, 0b0000000101, I, 4},
         {"sra", SRA, R, OP_OP, 0b0100000101, I, 4},
         {"or", OR, R, OP_OP, 0b0000000110, I, 4},
         {"and", AND, R, OP_OP, 0b0000000111, I, 4},
         {"fence", FENCE, I, OP_MISC_MEM, 0b000, I, 4, {.super_special_snowflake = true}},
         {"fence.tso", FENCETSO, I, OP_MISC_MEM, 0b000, I, 4, {.super_special_snowflake = true}},
         {"pause", PAUSE, I, OP_MISC_MEM, 0b000, I, 4, {.super_special_snowflake = true}},
         {"ecall", ECALL, I, OP_SYSTEM, 0b000, I, 4, {.super_special_snowflake = true}},
         {"ebreak", EBREAK, I, OP_SYSTEM, 0b000, I, 4, {.super_special_snowflake = true}},
         ...
         {"slliw", SLLIW, R, OP_IMM_32, 0b0000000001, I_and_64b, 4, {.use_imm_for_rs = true}},
         {"srliw", SRLIW, R, OP_IMM_32, 0b0000000101, I_and_64b, 4, {.use_imm_for_rs = true}},
         {"sraiw", SRAIW, R, OP_IMM_32, 0b0100000101, I_and_64b, 4, {.use_imm_for_rs = true}},
         ...
         {"fmadd.h", FMADDH, R4, OP_MADD, 0b10000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fmsub.h", FMSUBH, R4, OP_MSUB, 0b10000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fnmsub.h", FNMSUBH, R4, OP_NMSUB, 0b10000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fnmadd.h", FNMADDH, R4, OP_NMADD, 0b10000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fadd.h", FADDH, R, OP_FP, 0b0000010000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fsub.h", FSUBH, R, OP_FP, 0b0000110000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fmul.h", FMULH, R, OP_FP, 0b0001010000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fdiv.h", FDIVH, R, OP_FP, 0b0001110000, Zfh_or_Zfhinx, 4, {.use_frm_for_funct3 = true}},
         {"fsqrt.h", FSQRTH, R, OP_FP, 0b0101110000, Zfh_or_Zfhinx, 4, {.custom_reg_val = 0b00000, .use_frm_for_funct3 = true}},
         {"fsgnj.h", FSGNJH, R, OP_FP, 0b0010010000, Zfh_or_Zfhinx, 4},
         {"fsgnjn.h", FSGNJNH, R, OP_FP, 0b0010010001, Zfh_or_Zfhinx, 4},
         {"fsgnjx.h", FSGNJXH, R, OP_FP, 0b0010010010, Zfh_or_Zfhinx, 4},
         {"fmin.h", FMINH, R, OP_FP, 0b0010110000, Zfh_or_Zfhinx, 4},
         {"fmax.h", FMAXH, R, OP_FP, 0b0010110001, Zfh_or_Zfhinx, 4},
         {"fcvt.s.h", FCVTSH, R, OP_FP, 0b0100000000, Zfhmin, 4, {.custom_reg_val = 0b00010, .use_frm_for_funct3 = true}},
         {"fcvt.h.s", FCVTHS, R, OP_FP, 0b0100010000, Zfhmin, 4, {.custom_reg_val = 0b00000, .use_frm_for_funct3 = true}},
         {"fcvt.d.h", FCVTDH, R, OP_FP, 0b0100001000, Zfhmin_and_D_or_Zdinx, 4, {.custom_reg_val = 0b00010, .use_frm_for_funct3 = true}},
         {"fcvt.h.d", FCVTHD, R, OP_FP, 0b0100010000, Zfhmin_and_D_or_Zdinx, 4, {.custom_reg_val = 0b00001, .use_frm_for_funct3 = true}},
         ...
         {"feq.h", FEQH, R, OP_FP, 0b1010010010, Zfh_or_Zfhinx, 4},
         {"flt.h", FLTH, R, OP_FP, 0b1010010001, Zfh_or_Zfhinx, 4},
         {"fle.h", FLEH, R, OP_FP, 0b1010010000, Zfh_or_Zfhinx, 4},
         {"fclass.h", FCLASSH, R, OP_FP, 0b1110010001, Zfh_or_Zfhinx, 4, {.custom_reg_val = 0b00000}},
         {"fcvt.w.h", FCVTWH, R, OP_FP, 0b1100010000, Zfh_or_Zfhinx, 4, {.custom_reg_val = 0b00000, .use_frm_for_funct3 = true}},
         {"fcvt.wu.h", FCVTWUH, R, OP_FP, 0b1100010000, Zfh_or_Zfhinx, 4, {.custom_reg_val = 0b00001, .use_frm_for_funct3 = true}},
         {"fmv.x.h", FMVXH, R, OP_FP, 0b1110010000, Zfhmin, 4, {.custom_reg_val = 0b00000}},
         {"fcvt.h.w", FCVTHW, R, OP_FP, 0b1101010000, Zfh_or_Zfhinx, 4, {.custom_reg_val = 0b00000, .use_frm_for_funct3 = true}},
         {"fcvt.h.wu", FCVTHWU, R, OP_FP, 0b1101010000, Zfh_or_Zfhinx, 4, {.custom_reg_val = 0b00001, .use_frm_for_funct3 = true}},
         {"fmv.h.x", FMVXH, R, OP_FP, 0b1111010000, Zfhmin, 4, {.custom_reg_val = 0b00000}},
         {"fcvt.l.h", FCVTLH, R, OP_FP, 0b1100010000, Zfh_or_Zfhinx_and_64b,, 4, {.custom_reg_val = 0b00010, .use_frm_for_funct3 = true}},
         {"fcvt.lu.h", FCVTLUH, R, OP_FP, 0b1100010000, Zfh_or_Zfhinx_and_64b,, 4, {.custom_reg_val = 0b00011, .use_frm_for_funct3 = true}},
         {"fcvt.h.l", FCVTHL, R, OP_FP, 0b1101010000, Zfh_or_Zfhinx_and_64b,, 4, {.custom_reg_val = 0b00010, .use_frm_for_funct3 = true}},
         {"fcvt.h.lu", FCVTHLU, R, OP_FP, 0b1101010000, Zfh_or_Zfhinx_and_64b,, 4, {.custom_reg_val = 0b00011, .use_frm_for_funct3 = true}},
         ...
         {"c.lwsp", CLWSP, CI, OP_C2, 0b010, C_Zca, 2},
         {"c.ldsp", CLDSP, CI, OP_C2, 0b011, C_Zca, 2},
         {"c.flwsp", CFLWSP, CI, OP_C2, 0b011, C_Zcf, 2},
         {"c.fldsp", CFLDSP, CI, OP_C2, 0b001, C_Zcd, 2},
         {"c.swsp", CSWSP, CSS, OP_C2, 0b110, C_Zca, 2},
         {"c.sdsp", CSDSP, CSS, OP_C2, 0b111, C_Zca, 2},
         {"c.fswsp", CFSWSP, CSS, OP_C2, 0b111, C_Zcf, 2},
         {"c.fsdsp", CFSDSP, CSS, OP_C2, 0b101, C_Zcd, 2},
         {"c.lw", CLW, CL, OP_C0, 0b010, C_Zca, 2},
         {"c.ld", CLD, CL, OP_C0, 0b011, C_Zca, 2},
         {"c.flw", CFLW, CL, OP_C0, 0b011, C_Zcf, 2},
         {"c.fld", CFLD, CL, OP_C0, 0b001, C_Zcd, 2},
         {"c.sw", CSW, CS, OP_C0, 0b110, C_Zca, 2},
         {"c.sd", CSD, CS, OP_C0, 0b111, C_Zca, 2},
         {"c.fsw", CFSW, CS, OP_C0, 0b111, C_Zcf, 2},
         {"c.fsd", CFSD, CS, OP_C0, 0b101, C_Zcd, 2},
         {"c.j", CJump, CJ, OP_C1, 0b101, C_Zca, 2},
         {"c.jal", CJAL, CJ, OP_C1, 0b001, C_Zca, 2},
         {"c.jr", CJR, CR, OP_C2, 0b1000, C_Zca, 2, {.custom_reg_val = 0b00000}},
         {"c.jalr", CJALR, CR, OP_C2, 0b1001, C_Zca, 2, {.custom_reg_val = 0b00000}},
         {"c.beqz", CBEQZ, CB, OP_C1, 0b110, C_Zca, 2},
         {"c.bnez", CBNEZ, CB, OP_C1, 0b111, C_Zca, 2},
         {"c.li", CLI, CI, OP_C1, 0b010, C_Zca, 2},
         {"c.lui", CLUI, CI, OP_C1, 0b011, C_Zca, 2},
         {"c.addi", CADDI, CI, OP_C1, 0b000, C_Zca, 2},
         {"c.addiw", CADDIW, CI, OP_C1, 0b001, C_Zca, 2},
         {"c.addi16sp", CADDI16SP, CI, OP_C1, 0b011, C_Zca, 2},
         {"c.slli", CSLLI, CI, OP_C2, 0b000, C_Zca, 2},
         {"c.srli", CSRLI, CB, OP_C1, 0b10000, C_Zca, 2},
         {"c.srai", CSRAI, CB, OP_C1, 0b10001, C_Zca, 2},
         {"c.andi", CANDI, CB, OP_C1, 0b10010, C_Zca, 2},
         {"c.mv", CMV, CR, OP_C2, 0b1000, C_Zca, 2},
         {"c.add", CADD, CR, OP_C2, 0b1001, C_Zca, 2},
         {"c.and", CAND, CA, OP_C1, 0b10001111, C_Zca, 2},
         {"c.or", COR, CA, OP_C1, 0b10001110, C_Zca, 2},
         {"c.xor", CXOR, CA, OP_C1, 0b10001101, C_Zca, 2},
         {"c.sub", CSUB, CA, OP_C1, 0b10001100, C_Zca, 2},
         {"c.addw", CADDW, CA, OP_C1, 0b10011101, C_Zca, 2},
         {"c.subw", CSUBW, CA, OP_C1, 0b10011100, C_Zca, 2},
         {"c.nop", CNOP, CI, OP_C1, 0b000, C_Zca, 2, {.super_special_snowflake = true}},
         {"c.ebreak", CEBREAK, CI, OP_C2, 0b1001, C_Zca, 2, {.super_special_snowflake = true}},
         ...
         {"c.lbu", CLBU, CLB, OP_C0, 0b100000, C_Zcb_Zca, 2},
         {"c.lhu", CLHU, CLHfmt, OP_C0, 0b1000010, C_Zcb_Zca, 2},
         {"c.lh", CLH, CLHfmt, OP_C0, OP_MADD, C_Zcb_Zca, 2},
         {"c.sb", CSB, CSBfmt, OP_C0, 0b100010, C_Zcb_Zca, 2},
         {"c.sh", CSH, CSHfmt, OP_C0, 0b1000110, C_Zcb_Zca, 2},
         {"c.zext.b", CZEXTB, CU, OP_C1, 0b10011111000, C_Zcb_Zca, 2},
         {"c.sext.b", CSEXTB, CU, OP_C1, 0b10011111001, C_Zcb_Zca, 2},
         {"c.zext.h", CZEXTH, CU, OP_C1, 0b10011111010, C_Zcb_Zca, 2},
         {"c.sext.h", CSEXTH, CU, OP_C1, 0b10011111011, C_Zcb_Zca, 2},
         {"c.zext.w", CZEXTW, CU, OP_C1, 0b10011111100, C_Zcb_Zca, 2},
         {"c.not", CNOT, CU, OP_C1, 0b10011111101, C_Zcb_Zca, 2},
         {"c.mul", CMUL, CA, OP_C1, 0b10011110, C_Zcb_Zca, 2},
         {"cm.push", CMPUSH, CMPP, OP_C2, 0b10111000, C_Zcmp_Zca, 2},
         {"cm.pop", CMPOP, CMPP, OP_C2, 0b10111010, C_Zcmp_Zca, 2},
         {"cm.popretz", CMPOPRETZ, CMPP, OP_C2, 0b10111100, C_Zcmp_Zca, 2},
         {"cm.popret", CMPOPRET, CMPP, OP_C2, 0b10111110, C_Zcmp_Zca, 2},
         {"cm.mvsa01", CMMVSA01, CMMV, OP_C2, 0b10101101, C_Zcmp_Zca, 2},
         {"cm.mva01s", CMMVA01S, CMMV, OP_C2, 0b10101111, C_Zcmp_Zca, 2},
         {"cm.jt", CMJT, CMJTfmt, OP_C2, 0b101000, C_Zcmt_Zca, 2},
         {"cm.jalt", CMJALT, CMJTfmt, OP_C2, 0b101000, C_Zcmt_Zca, 2},
         {"fli.s", FLIS, R, OP_FP, 0b1111000000, Zfa, 4, {.custom_reg_val = 0b00001}},
         {"fli.d", FLID, R, OP_FP, 0b1111001000, Zfa, 4, {.custom_reg_val = 0b00001}},
         {"fli.q", FLIQ, R, OP_FP, 0b1111011000, Zfa, 4, {.custom_reg_val = 0b00001}},
         {"fli.h", FLIH, R, OP_FP, 0b1111010000, Zfa, 4, {.custom_reg_val = 0b00001}},
         {"fminm.s", FMINMS, R, OP_FP, 0b0010100010, Zfa, 4},
         {"fmaxm.s", FMAXMS, R, OP_FP, 0b0010100011, Zfa, 4},
         {"fminm.d", FMINMD, R, OP_FP, 0b0010101010, Zfa, 4},
         {"fmaxm.d", FMAXMD, R, OP_FP, 0b0010101011, Zfa, 4},
         {"fminm.q", FMINMQ, R, OP_FP, 0b0010111010, Zfa, 4},
         {"fmaxm.q", FMAXMQ, R, OP_FP, 0b0010111011, Zfa, 4},
         {"fminm.h", FMINMH, R, OP_FP, 0b0010110010, Zfa, 4},
         {"fmaxm.h", FMAXMH, R, OP_FP, 0b0010110011, Zfa, 4},
         ...
         {"fround.d", FROUNDD, R, OP_FP, 0b0100001000, Zfa, 4, {.custom_reg_val = 0b00100, .use_frm_for_funct3 = true}},
         {"froundnx.d", FROUNDNXD, R, OP_FP, 0b0100001000, Zfa, 4, {.custom_reg_val = 0b00101, .use_frm_for_funct3 = true}},
         {"fround.h", FROUNDH, R, OP_FP, 0b0100010000, Zfa, 4, {.custom_reg_val = 0b00100, .use_frm_for_funct3 = true}},
         {"froundnx.h", FROUNDNXH, R, OP_FP, 0b0100010000, Zfa, 4, {.custom_reg_val = 0b00101, .use_frm_for_funct3 = true}},
         {"fround.q", FROUNDQ, R, OP_FP, 0b0100011000, Zfa, 4, {.custom_reg_val = 0b00100, .use_frm_for_funct3 = true}},
         {"froundnx.q", FROUNDQ, R, OP_FP, 0b0100011000, Zfa, 4, {.custom_reg_val = 0b00101, .use_frm_for_funct3 = true}},
         {"fcvtmod.w.d", FCVTMODWD, R, OP_FP, 0b1100001000, Zfa, 4, {.custom_reg_val = 0b01000, .use_frm_for_funct3 = true}}, // This one needs 0b001 for frm (RTZ), and that "rtz" is explicitly
                                                                                                                                     // included in the assembly, like fcvtmod.w.d rd, rs1, rtz
         {"fmvh.x.d", FMVHXD, R, OP_FP, 0b1110001000, Zfa, 4, {.custom_reg_val = 0b00001}},
         {"fmvp.d.x", FMVPDX, R, OP_FP, 0b1011001000, Zfa, 4},
         {"fmvh.x.q", FMVHXQ, R, OP_FP, 0b1110011000, Zfa, 4, {.custom_reg_val = 0b00001}},
         {"fmvp.q.x", FMVPQX, R, OP_FP, 0b1011011000, Zfa, 4},
         {"fleq.s", FLEQS, R, OP_FP, 0b1010000100, Zfa, 4},
         {"fltq.s", FLTQS, R, OP_FP, 0b1010000101, Zfa, 4},
         {"fleq.d", FLEQD, R, OP_FP, 0b1010001100, Zfa, 4},
         {"fltq.d", FLTQD, R, OP_FP, 0b1010001101, Zfa, 4},
         {"fleq.h", FLEQH, R, OP_FP, 0b1010010100, Zfa, 4},
         {"fltq.h", FLTQH, R, OP_FP, 0b1010010101, Zfa, 4},
         {"fleq.q", FLEQQ, R, OP_FP, 0b1010011100, Zfa, 4},
         {"fltq.q", FLTQQ, R, OP_FP, 0b1010011101, Zfa, 4},
         ...
         {"add.uw", ADDUW, R, OP_32, 0b0000100000, B_Zba, 4},
         {"andn", ANDN, R, OP_OP, 0b0100000111, B_Zbb_Zbkb, 4},
         {"bclr", BCLR, R, OP_OP, 0b0100100001, B_Zbs, 4},
         {"bclri", BCLRI, R, OP_IMM, 0b0100100001, B_Zbs, 4, {.use_imm_for_rs = true}}, // This one "requires" an extra bit in shamt for RV64, but in reality it's a special case where shamt is big
                                                                                     // enough to clear a 64 bit register, so we just add the extra bit to rs2 and let the extra available space
                                                                                     // handle it transparently
         {"bext", BEXT, R, OP_OP, 0b0100100101, B_Zbs, 4},
         {"bexti", BEXTI, R, OP_IMM, 0b0100100101, B_Zbs, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         {"binv", BINV, R, OP_OP, 0b0110100001, B_Zbs, 4},
         {"binvi", BINVI, R, OP_IMM, 0b0110100001, B_Zbs, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         {"bset", BSET, R, OP_OP, 0b0010100001, B_Zbs, 4},
         {"bseti", BSETI, R, OP_IMM, 0b0010100001, B_Zbs, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         {"clmul", CLMUL, R, OP_OP, 0b0000101001, B_Zbc_Zbkc, 4},
         {"clmulh", CLMULH, R, OP_OP, 0b0000101011, B_Zbc_Zbkc, 4},
         {"clmulr", CLMULR, R, OP_OP, 0b0000101010, B_Zbc, 4},
         {"clz", CLZ, R, OP_IMM, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00000}},
         {"clzw", CLZW, R, OP_IMM_32, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00000}},
         {"cpop", CPOP, R, OP_IMM, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00010}},
         {"cpopw", CPOPW, R, OP_IMM_32, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00010}},
         {"ctz", CTZ, R, OP_IMM, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00001}},
         {"ctzw", CTZW, R, OP_IMM_32, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00001}},
         {"max", MAX, R, OP_OP, 0b0000101110, B_Zbb, 4},
         {"maxu", MAXU, R, OP_OP, 0b0000101111, B_Zbb, 4},
         {"min", MIN, R, OP_OP, 0b0000101100, B_Zbb, 4},
         {"minu", MINU, R, OP_OP, 0b0000101101, B_Zbb, 4},
         {"orc.b", ORCB, R, OP_IMM, 0b0010100101, B_Zbb, 4, {.custom_reg_val = 0b00111}},
         {"orn", ORN, R, OP_OP, 0b0100000110, B_Zbb_Zbkb, 4},
         {"pack", PACK, R, OP_OP, 0b0000100100, B_Zbkb, 4},
         {"packh", PACKH, R, OP_OP, 0b0000100111, B_Zbkb, 4},
         {"packw", PACKW, R, OP_32, 0b0000100100, B_Zbkb, 4},
         {"rev8", REV8, R, OP_IMM, 0b0110100101, B_Zbb_Zbkb, 4, {.custom_reg_val = 0b11000}}, // This one is similar to bclri, but it instead makes bit 25 1 on rv64 and otherwise stays the same
         {"rev.b", REVB, R, OP_IMM, 0b0110100101, B_Zbkb, 4, {.custom_reg_val = 0b00111}},
         {"rol", ROL, R, OP_OP, 0b0110000001, B_Zbb_Zbkb, 4},
         {"rolw", ROLW, R, OP_32, 0b0110000001, B_Zbb_Zbkb, 4},
         {"ror", ROR, R, OP_OP, 0b0110000101, B_Zbb_Zbkb, 4},
         {"rori", RORI, R, OP_IMM, 0b0110000101, B_Zbb_Zbkb, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         {"roriw", RORIW, R, OP_IMM_32, 0b0110000101, B_Zbb_Zbkb, 4, {.use_imm_for_rs = true}},
         {"rorw", RORW, R, OP_32, 0b0110000101, B_Zbb_Zbkb, 4},
         {"sext.b", SEXTB, R, OP_IMM, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00100}},
         {"sext.h", SEXTH, R, OP_IMM, 0b0110000001, B_Zbb, 4, {.custom_reg_val = 0b00101}},
         {"sh1add", SH1ADD, R, OP_OP, 0b0010000010, B_Zba, 4},
         {"sh1add.uw", SH1ADDUW, R, OP_32, 0b0010000010, B_Zba, 4},
         {"sh2add", SH2ADD, R, OP_OP, 0b0010000100, B_Zba, 4},
         {"sh2add.uw", SH2ADDUW, R, OP_32, 0b0010000100, B_Zba, 4},
         {"sh3add", SH3ADD, R, OP_OP, 0b0010000110, B_Zba, 4},
         {"sh3add.uw", SH3ADDUW, R, OP_32, 0b0010000110, B_Zba, 4},
         {"slli.uw", SLLIUW, R, OP_IMM_32, 0b0000100001, B_Zba, 4, {.use_imm_for_rs = true}},
         {"unzip", UNZIP, R, OP_IMM, 0b0000100101, B_Zbkb, 4, {.custom_reg_val = 0b11111}},
         {"xnor", XNOR, R, OP_OP, 0b0100000100, B_Zbb_Zbkb, 4},
         {"xperm.b", XPERMB, R, OP_OP, 0b0010100100, B_Zbkx, 4},
         {"xperm.n", XPERMN, R, OP_OP, 0b0010100010, B_Zbkx, 4},
         {"zext.h", ZEXTH, R, OP_OP, 0b0000100100, B_Zbb, 4, {.custom_reg_val = 0b00000}}, // Similar to rev8, but we make bit 4 (in the opcode) 1 instead for rv64
         {"zip", ZIP, R, OP_IMM, 0b0000100001, B_Zbkb, 4, {.custom_reg_val = 0b11110}},
