...
const std::array<rvinstruction, 1112> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, RV32I, 4},
         ...
         {"vssseg2e8.v", VSSSEG2E8V, VSS, OP_STORE_FP, 0b001010100000000, V, 4},
         {"vlsseg2e16.v", VLSSEG2E16V, VLS, OP_LOAD_FP, 0b001010100000101, V, 4},
         {"vssseg2e16.v", VSSSEG2E16V, VSS, OP_STORE_FP, 0b001010100000101, V, 4},
         {"vlsseg2e32.v", VLSSEG2E32V, VLS, OP_LOAD_FP, 0b001010100000110, V, 4},
         {"vssseg2e32.v", VSSSEG2E32V, VSS, OP_STORE_FP, 0b001010100000110, V, 4},
         {"vlsseg2e64.v", VLSSEG2E64V, VLS, OP_LOAD_FP, 0b001010100000111, V, 4},
         {"vssseg2e64.v", VSSSEG2E64V, VSS, OP_STORE_FP, 0b001010100000111, V, 4},
         {"vlsseg3e8.v", VLSSEG3E8V, VLS, OP_LOAD_FP, 0b010010100000000, V, 4},
         {"vssseg3e8.v", VSSSEG3E8V, VSS, OP_STORE_FP, 0b010010100000000, V, 4},
         {"vlsseg3e16.v", VLSSEG3E16V, VLS, OP_LOAD_FP, 0b010010100000101, V, 4},
         {"vssseg3e16.v", VSSSEG3E16V, VSS, OP_STORE_FP, 0b010010100000101, V, 4},
         {"vlsseg3e32.v", VLSSEG3E32V, VLS, OP_LOAD_FP, 0b010010100000110, V, 4},
         {"vssseg3e32.v", VSSSEG3E32V, VSS, OP_STORE_FP, 0b010010100000110, V, 4},
         {"vlsseg3e64.v", VLSSEG3E64V, VLS, OP_LOAD_FP, 0b010010100000111, V, 4},
         {"vssseg3e64.v", VSSSEG3E64V, VSS, OP_STORE_FP, 0b010010100000111, V, 4},
         {"vlsseg4e8.v", VLSSEG4E8V, VLS, OP_LOAD_FP, 0b011010100000000, V, 4},
         {"vssseg4e8.v", VSSSEG4E8V, VSS, OP_STORE_FP, 0b011010100000000, V, 4},
         {"vlsseg4e16.v", VLSSEG4E16V, VLS, OP_LOAD_FP, 0b011010100000101, V, 4},
         {"vssseg4e16.v", VSSSEG4E16V, VSS, OP_STORE_FP, 0b011010100000101, V, 4},
         {"vlsseg4e32.v", VLSSEG4E32V, VLS, OP_LOAD_FP, 0b011010100000110, V, 4},
         {"vssseg4e32.v", VSSSEG4E32V, VSS, OP_STORE_FP, 0b011010100000110, V, 4},
         {"vlsseg4e64.v", VLSSEG4E64V, VLS, OP_LOAD_FP, 0b011010100000111, V, 4},
         {"vssseg4e64.v", VSSSEG4E64V, VSS, OP_STORE_FP, 0b011010100000111, V, 4},
         {"vlsseg5e8.v", VLSSEG5E8V, VLS, OP_LOAD_FP, 0b100010100000000, V, 4},
         {"vssseg5e8.v", VSSSEG5E8V, VSS, OP_STORE_FP, 0b100010100000000, V, 4},
         {"vlsseg5e.v", VLSSEG5E16V, VLS, OP_LOAD_FP, 0b100010100000101, V, 4},
         {"vssseg5e16.v", VSSSEG5E16V, VSS, OP_STORE_FP, 0b100010100000101, V, 4},
         {"vlsseg5e32.v", VLSSEG5E32V, VLS, OP_LOAD_FP, 0b100010100000110, V, 4},
         {"vssseg5e32.v", VSSSEG5E32V, VSS, OP_STORE_FP, 0b100010100000110, V, 4},
         {"vlsseg5e64.v", VLSSEG5E64V, VLS, OP_LOAD_FP, 0b100010100000111, V, 4},
         {"vssseg5e64.v", VSSSEG5E64V, VSS, OP_STORE_FP, 0b100010100000111, V, 4},
         {"vlsseg6e8.v", VLSSEG6E8V, VLS, OP_LOAD_FP, 0b101010100000000, V, 4},
         {"vssseg6e8.v", VSSSEG6E8V, VSS, OP_STORE_FP, 0b101010100000000, V, 4},
         {"vlsseg6e16.v", VLSSEG6E16V, VLS, OP_LOAD_FP, 0b101010100000101, V, 4},
         {"vssseg6e16.v", VSSSEG6E16V, VSS, OP_STORE_FP, 0b101010100000101, V, 4},
         {"vlsseg6e32.v", VLSSEG6E32V, VLS, OP_LOAD_FP, 0b101010100000110, V, 4},
         {"vssseg6e32.v", VSSSEG6E32V, VSS, OP_STORE_FP, 0b101010100000110, V, 4},
         {"vlsseg6e64.v", VLSSEG6E64V, VLS, OP_LOAD_FP, 0b101010100000111, V, 4},
         {"vssseg6e64.v", VSSSEG6E64V, VSS, OP_STORE_FP, 0b101010100000111, V, 4},
         {"vlsseg7e8.v", VLSSEG7E8V, VLS, OP_LOAD_FP, 0b110010100000000, V, 4},
         {"vssseg7e8.v", VSSSEG7E8V, VSS, OP_STORE_FP, 0b110010100000000, V, 4},
         {"vlsseg7e16.v", VLSSEG7E16V, VLS, OP_LOAD_FP, 0b110010100000101, V, 4},
         {"vssseg7e16.v", VSSSEG7E16V, VSS, OP_STORE_FP, 0b110010100000101, V, 4},
         {"vlsseg7e32.v", VLSSEG7E32V, VLS, OP_LOAD_FP, 0b110010100000110, V, 4},
         {"vssseg7e32.v", VSSSEG7E32V, VSS, OP_STORE_FP, 0b110010100000110, V, 4},
         {"vlsseg7e64.v", VLSSEG7E64V, VLS, OP_LOAD_FP, 0b110010100000111, V, 4},
         {"vssseg7e64.v", VSSSEG7E64V, VSS, OP_STORE_FP, 0b110010100000111, V, 4},
         {"vlsseg8e8.v", VLSSEG8E8V, VLS, OP_LOAD_FP, 0b111010100000000, V, 4},
         {"vssseg8e8.v", VSSSEG8E8V, VSS, OP_STORE_FP, 0b111010100000000, V, 4},
         {"vlsseg8e16.v", VLSSEG8E16V, VLS, OP_LOAD_FP, 0b111010100000101, V, 4},
         {"vssseg8e16.v", VSSSEG8E16V, VSS, OP_STORE_FP, 0b111010100000101, V, 4},
         {"vlsseg8e32.v", VLSSEG8E32V, VLS, OP_LOAD_FP, 0b111010100000110, V, 4},
         {"vssseg8e32.v", VSSSEG8E32V, VSS, OP_STORE_FP, 0b111010100000110, V, 4},
         {"vlsseg8e64.v", VLSSEG8E64V, VLS, OP_LOAD_FP, 0b111010100000111, V, 4},
         {"vssseg8e64.v", VSSSEG8E64V, VSS, OP_STORE_FP, 0b111010100000111, V, 4},
