...
const uint16_t fast_instr_search(const ultrastring& inst) {
    ...
    if (size == 3) {
        ...
        if (inst[0] == 'r') {
            ...
            if (inst[1] == 'o') {
                if (inst[2] == 'r') return 561;
                if (inst[2] == 'l') return 559;
            }
        }
        if (inst[0] == 'l') {
            if (inst[1] == 'u') {
    ...
    if (size == 4) {
        ...
        if (inst[0] == 'r') {
            ...
            if (inst[1] == 'o') {
                if (inst[2] == 'r') {
                    if (inst[3] == 'w') return 564;
                    if (inst[3] == 'i') return 562;
                }
                if (inst[2] == 'l') {
                    if (inst[3] == 'w') return 560;
                }
            }
        }
        if (inst[0] == 'l') {
    ...
    if (size == 5) {
        ...
        if (inst[0] == 's') {
            if (inst[1] == 'm') {
                if (inst[2] == '3') {
                    if (inst[3] == 'p') {
                        if (inst[4] == '1') return 1234;
                        if (inst[4] == '0') return 1233;
                    }
                }
                if (inst[2] == '4') {
                    if (inst[3] == 'e') {
                        if (inst[4] == 'd') return 1235;
                    }
                    if (inst[3] == 'k') {
                        if (inst[4] == 's') return 1236;
                    }
                }
            }
            if (inst[1] == 'r') {
        ...
        if (inst[0] == 's') {
            if (inst[1] == 'e') {
                if (inst[2] == 'x') {
                    if (inst[3] == 't') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'b') return 565;
                            if (inst[5] == 'h') return 566;
                        }
                    }
                }
            }
        ...
        if (inst[0] == 'x') {
            if (inst[1] == 'p') {
                if (inst[2] == 'e') {
                    if (inst[3] == 'r') {
                        if (inst[4] == 'm') {
                            if (inst[5] == '4') return 1238;
                            if (inst[5] == '8') return 1237;
                        }
                    }
                }
            }
            ...
            if (inst[1] == 'h') {
                if (inst[2] == '.') {
                    ...
                    if (inst[3] == 's') {
                        ...
                        if (inst[4] == 'w') {
                            if (inst[5] == 'd') return 1372;
                        }
                        if (inst[4] == 'r') {
                            if (inst[5] == 'd') return 1356;
                            if (inst[5] == 'w') return 1355;
                            if (inst[5] == 'b') return 1353;
                            if (inst[5] == 'h') return 1354;
                        }
                    }
                    if (inst[3] == 'r') {
                        if (inst[4] == 'e') {
                            if (inst[5] == 'v') return 1318;
                        }
                    }
                    if (inst[3] == 'l') {
                        if (inst[4] == 'd') {
                        ...
                        if (inst[4] == 'w') {
                            if (inst[5] == 'd') return 1369;
                        }
                        if (inst[4] == 'r') {
                            if (inst[5] == 'd') return 1352;
                            if (inst[5] == 'w') return 1350;
                            if (inst[5] == 'b') return 1346;
                            if (inst[5] == 'h') return 1348;
                        }
                    }
                    if (inst[3] == 't') {
                        if (inst[4] == 's') {
                            if (inst[5] == 't') return 1321;
                        }
                    }
                    if (inst[3] == 'f') {
                        if (inst[4] == 'f') {
                            if (inst[5] == '1') return 1317;
                            if (inst[5] == '0') return 1316;
                        }
                    }
                }
            }
        ...
        if (inst[0] == 'v') {
            if (inst[1] == 's') {
                if (inst[2] == 'e') {
                    if (inst[3] == 't') {
                        if (inst[4] == 'v') {
                            if (inst[5] == 'l') return 582;
                        }
                    }
                    if (inst[3] == '8') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') return 587;
                        }
                    }
                }
                if (inst[2] == '2') {
            ...
            if (inst[1] == 'o') {
                if (inst[2] == 'r') {
                    if (inst[3] == '.') {
                        if (inst[4] == 'v') {
                            if (inst[5] == 'i') return 942;
                            if (inst[5] == 'x') return 941;
                            if (inst[5] == 'v') return 940;
                        }
                    }
                }
            }
            ...
            if (inst[1] == 'e') {
                if (inst[2] == 's') {
                    if (inst[3] == '6') {
                        if (inst[4] == '4') {
                            if (inst[5] == 'd') {
                                if (inst[6] == 's') return 1211;
                            }
                            if (inst[5] == 'i') {
                                if (inst[6] == 'm') return 1215;
                            }
                            if (inst[5] == 'e') {
                                if (inst[6] == 's') return 1213;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 'p') {
                if (inst[2] == 'e') {
                    if (inst[3] == 'r') {
                        if (inst[4] == 'm') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'b') return 576;
                                if (inst[6] == 'n') return 577;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 'h') {
                if (inst[2] == '.') {
                    ...
                    if (inst[3] == 's') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1344;
                                if (inst[6] == 'b') return 1345;
                            }
                        }
                        if (inst[4] == 'u') {
                            if (inst[5] == 'r') {
                                if (inst[6] == 'd') return 1367;
                                if (inst[6] == 'w') return 1366;
                                if (inst[6] == 'b') return 1364;
                                if (inst[6] == 'h') return 1365;
                            }
                        }
                        if (inst[4] == 'w') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1342;
                                if (inst[6] == 'b') return 1343;
                            }
                        }
                        if (inst[4] == 'b') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1338;
                                if (inst[6] == 'b') return 1339;
                            }
                        }
                        if (inst[4] == 'r') {
                            if (inst[5] == 'r') {
                                if (inst[6] == 'i') return 1312;
                            }
                        }
                        if (inst[4] == 'h') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1340;
                                if (inst[6] == 'b') return 1341;
                            }
                        }
                        if (inst[4] == 'y') {
                            if (inst[5] == 'n') {
                                if (inst[6] == 'c') return 1307;
                            }
                        }
                    }
                    if (inst[3] == 'm') {
                        if (inst[4] == 'u') {
                            if (inst[5] == 'l') {
                                if (inst[6] == 'a') return 1381;
                                if (inst[6] == 's') return 1384;
                            }
                        }
                    }
                    if (inst[3] == 'r') {
                    ...
                    if (inst[3] == 'l') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1336;
                                if (inst[6] == 'b') return 1337;
                            }
                        }
                        if (inst[4] == 'u') {
                            if (inst[5] == 'r') {
                                if (inst[6] == 'd') return 1363;
                                if (inst[6] == 'w') return 1361;
                                if (inst[6] == 'b') return 1357;
                                if (inst[6] == 'h') return 1359;
                            }
                        }
                        if (inst[4] == 'w') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'd') return 1370;
                            }
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1332;
                                if (inst[6] == 'b') return 1333;
                            }
                        }
                        if (inst[4] == 'b') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1324;
                                if (inst[6] == 'b') return 1325;
                            }
                        }
                        if (inst[4] == 'r') {
                            if (inst[5] == 'w') {
                                if (inst[6] == 'u') return 1351;
                            }
                            if (inst[5] == 'b') {
                                if (inst[6] == 'u') return 1347;
                            }
                            if (inst[5] == 'h') {
                                if (inst[6] == 'u') return 1349;
                            }
                        }
                        if (inst[4] == 'h') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'a') return 1328;
                                if (inst[6] == 'b') return 1329;
                            }
                        }
                    }
                    if (inst[3] == 'f') {
                        if (inst[4] == 's') {
                            if (inst[5] == 'r') {
                                if (inst[6] == 'd') return 1377;
                                if (inst[6] == 'w') return 1378;
                            }
                        }
                        if (inst[4] == 'l') {
                            if (inst[5] == 'r') {
                                if (inst[6] == 'd') return 1373;
                                if (inst[6] == 'w') return 1374;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 'a') {
                if (inst[2] == 'd') {
                    if (inst[3] == 'd') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 895;
                                if (inst[6] == 'x') return 894;
                                if (inst[6] == 'v') return 893;
                            }
                        }
                    }
                }
                if (inst[2] == 'n') {
                    if (inst[3] == 'd') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 939;
                                if (inst[6] == 'x') return 938;
                                if (inst[6] == 'v') return 937;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 'd') {
                if (inst[2] == 'i') {
                    if (inst[3] == 'v') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 1000;
                                if (inst[6] == 'v') return 999;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 's') {
                if (inst[2] == 'u') {
                    if (inst[3] == 'b') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 897;
                                if (inst[6] == 'v') return 896;
                            }
                        }
                    }
                }
                ...
                if (inst[2] == 'r') {
                    if (inst[3] == 'a') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 954;
                                if (inst[6] == 'x') return 953;
                                if (inst[6] == 'v') return 952;
                            }
                        }
                    }
                    if (inst[3] == 'l') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 951;
                                if (inst[6] == 'x') return 950;
                                if (inst[6] == 'v') return 949;
                            }
                        }
                    }
                }
                if (inst[2] == 'l') {
                    if (inst[3] == 'l') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 948;
                                if (inst[6] == 'x') return 947;
                                if (inst[6] == 'v') return 946;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 'm') {
                if (inst[2] == 'a') {
                    if (inst[3] == 'x') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 988;
                                if (inst[6] == 'v') return 987;
                            }
                        }
                    }
                }
                if (inst[2] == 'u') {
                    if (inst[3] == 'l') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 990;
                                if (inst[6] == 'v') return 989;
                            }
                        }
                    }
                }
                if (inst[2] == 'i') {
                    if (inst[3] == 'n') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 984;
                                if (inst[6] == 'v') return 983;
                            }
                        }
                    }
                }
                ...
                if (inst[2] == 'v') {
                    if (inst[3] == '.') {
                        if (inst[4] == 's') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'x') return 1187;
                            }
                        }
                        if (inst[4] == 'x') {
                            if (inst[5] == '.') {
                                if (inst[6] == 's') return 1186;
                            }
                        }
                        if (inst[4] == 'v') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'i') return 1031;
                                if (inst[6] == 'x') return 1030;
                                if (inst[6] == 'v') return 1029;
                            }
                        }
                    }
                    if (inst[3] == '2') {
            ...
            if (inst[1] == 'r') {
                if (inst[2] == 'e') {
                    if (inst[3] == 'm') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 1004;
                                if (inst[6] == 'v') return 1003;
                            }
                        }
                    }
                    if (inst[3] == 'v') {
                ...
                if (inst[2] == 'o') {
                    if (inst[3] == 'r') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 1267;
                                if (inst[6] == 'x') return 1266;
                                if (inst[6] == 'v') return 1265;
                            }
                        }
                    }
                    if (inst[3] == 'l') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'x') return 1264;
                                if (inst[6] == 'v') return 1263;
                            }
                        }
                    }
                }
            ...
            if (inst[1] == 'x') {
                if (inst[2] == 'o') {
                    if (inst[3] == 'r') {
                        if (inst[4] == '.') {
                            if (inst[5] == 'v') {
                                if (inst[6] == 'i') return 945;
                                if (inst[6] == 'x') return 944;
                                if (inst[6] == 'v') return 943;
                            }
                        }
                    }
                }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == '3') {
                        if (inst[4] == '2') {
                            if (inst[5] == 'd') {
                                if (inst[6] == 's') {
                                    if (inst[7] == 'i') return 1207;
                                }
                            }
                            if (inst[5] == 'e') {
                                if (inst[6] == 's') {
                                    if (inst[7] == 'i') return 1209;
                                }
                            }
                        }
                    }
                    if (inst[3] == '6') {
                        if (inst[4] == '4') {
                            if (inst[5] == 'd') {
                                if (inst[6] == 's') {
                                    if (inst[7] == 'm') return 1212;
                                }
                            }
                            if (inst[5] == 'e') {
                                if (inst[6] == 's') {
                                    if (inst[7] == 'm') return 1214;
                                }
                            }
                            if (inst[5] == 'k') {
                                if (inst[6] == 's') {
                                    if (inst[7] == '2') return 1217;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == '.') {
                    ...
                    if (inst[3] == 'm') {
                        if (inst[4] == 'u') {
                            if (inst[5] == 'l') {
                                if (inst[6] == 'a') {
                                    if (inst[7] == 'w') return 1383;
                                    if (inst[7] == 'h') return 1382;
                                }
                                if (inst[6] == 's') {
                                    if (inst[7] == 'w') return 1386;
                                    if (inst[7] == 'h') return 1385;
                                }
                            }
                        }
                        if (inst[4] == 'v') {
                    ...
                    if (inst[3] == 'l') {
                        if (inst[4] == 'u') {
                            if (inst[5] == 'r') {
                                if (inst[6] == 'w') {
                                    if (inst[7] == 'u') return 1362;
                                }
                                if (inst[6] == 'b') {
                                    if (inst[7] == 'u') return 1358;
                                }
                                if (inst[6] == 'h') {
                                    if (inst[7] == 'u') return 1360;
                                }
                            }
                        }
                        if (inst[4] == 'w') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'i') {
                                    if (inst[7] == 'a') return 1334;
                                    if (inst[7] == 'b') return 1335;
                                }
                            }
                        }
                        if (inst[4] == 'b') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'i') {
                                    if (inst[7] == 'a') return 1326;
                                    if (inst[7] == 'b') return 1327;
                                }
                            }
                        }
                        if (inst[4] == 'h') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'i') {
                                    if (inst[7] == 'a') return 1330;
                                    if (inst[7] == 'b') return 1331;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[3] == 'f') {
                        if (inst[4] == 's') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'r') {
                                    if (inst[7] == 'd') return 1379;
                                    if (inst[7] == 'w') return 1380;
                                }
                            }
                        }
                        if (inst[4] == 'l') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'r') {
                                    if (inst[7] == 'd') return 1375;
                                    if (inst[7] == 'w') return 1376;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'a') {
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1045;
                                    if (inst[7] == 'v') return 1044;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1049;
                                    if (inst[7] == 'v') return 1048;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'n') {
                    if (inst[3] == 'd') {
                        if (inst[4] == 'n') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1251;
                                    if (inst[7] == 'v') return 1250;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'i') {
                    if (inst[3] == 'v') {
                        if (inst[4] == 'u') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 998;
                                    if (inst[7] == 'v') return 997;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'a') {
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'w') {
                                    if (inst[7] == 'x') return 913;
                                    if (inst[7] == 'v') return 912;
                                }
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 905;
                                    if (inst[7] == 'v') return 904;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'w') {
                                    if (inst[7] == 'x') return 915;
                                    if (inst[7] == 'v') return 914;
                                }
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 907;
                                    if (inst[7] == 'v') return 906;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'l') {
                        if (inst[4] == 'l') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 1278;
                                    if (inst[7] == 'x') return 1277;
                                    if (inst[7] == 'v') return 1276;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'm') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'l') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1006;
                                    if (inst[7] == 'v') return 1005;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'a') {
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 1037;
                                    if (inst[7] == 'x') return 1036;
                                    if (inst[7] == 'v') return 1035;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1041;
                                    if (inst[7] == 'v') return 1040;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[3] == 'r') {
                        if (inst[4] == 'a') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 1057;
                                    if (inst[7] == 'x') return 1056;
                                    if (inst[7] == 'v') return 1055;
                                }
                            }
                        }
                        if (inst[4] == 'l') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 1054;
                                    if (inst[7] == 'x') return 1053;
                                    if (inst[7] == 'v') return 1052;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'm') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'l') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1051;
                                    if (inst[7] == 'v') return 1050;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[3] == '4') {
                        ...
                        if (inst[4] == 'r') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 's') return 1275;
                                    if (inst[7] == 'v') return 1274;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'a') {
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1016;
                                    if (inst[7] == 'v') return 1015;
                                }
                            }
                        }
                        if (inst[4] == 'c') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 930;
                                    if (inst[7] == 'x') return 929;
                                    if (inst[7] == 'v') return 928;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[3] == 'c') {
                        if (inst[4] == 'c') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1012;
                                    if (inst[7] == 'v') return 1011;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'x') {
                        if (inst[4] == 'u') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 986;
                                    if (inst[7] == 'v') return 985;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'u') {
                    if (inst[3] == 'l') {
                        if (inst[4] == 'h') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 992;
                                    if (inst[7] == 'v') return 991;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'i') {
                    if (inst[3] == 'n') {
                        if (inst[4] == 'u') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 982;
                                    if (inst[7] == 'v') return 981;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'e') {
                        if (inst[4] == 'q') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 963;
                                    if (inst[7] == 'x') return 962;
                                    if (inst[7] == 'v') return 961;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'b') {
                        if (inst[4] == 'c') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 936;
                                    if (inst[7] == 'v') return 935;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'l') {
                        if (inst[4] == 'e') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 976;
                                    if (inst[7] == 'x') return 975;
                                    if (inst[7] == 'v') return 974;
                                }
                            }
                        }
                        if (inst[4] == 't') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 970;
                                    if (inst[7] == 'v') return 969;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'n') {
                        if (inst[4] == 'e') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 966;
                                    if (inst[7] == 'x') return 965;
                                    if (inst[7] == 'v') return 964;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'g') {
                        if (inst[4] == 't') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 980;
                                    if (inst[7] == 'x') return 979;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'f') {
                    if (inst[3] == 'e') {
                        if (inst[4] == 'q') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1121;
                                    if (inst[7] == 'f') return 1122;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'l') {
                        ...
                        if (inst[4] == 't') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1125;
                                    if (inst[7] == 'f') return 1126;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'n') {
                        if (inst[4] == 'e') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1123;
                                    if (inst[7] == 'f') return 1124;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'e') {
                    if (inst[3] == 'm') {
                        if (inst[4] == 'u') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'x') return 1002;
                                    if (inst[7] == 'v') return 1001;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'i') return 899;
                                    if (inst[7] == 'x') return 898;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'r') {
                        if (inst[4] == 'a') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'w') {
                                    if (inst[7] == 'i') return 960;
                                    if (inst[7] == 'x') return 959;
                                    if (inst[7] == 'v') return 958;
                                }
                            }
                        }
                        if (inst[4] == 'l') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'w') {
                                    if (inst[7] == 'i') return 957;
                                    if (inst[7] == 'x') return 956;
                                    if (inst[7] == 'v') return 955;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'a') {
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1064;
                                    if (inst[7] == 'f') return 1065;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'd') {
                    if (inst[3] == 'i') {
                        if (inst[4] == 'v') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1079;
                                    if (inst[7] == 'f') return 1080;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 's') {
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1066;
                                    if (inst[7] == 'f') return 1067;
                                }
                            }
                        }
                    }
                ...
                if (inst[2] == 'm') {
                    if (inst[3] == 'a') {
                        if (inst[4] == 'x') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1113;
                                    if (inst[7] == 'f') return 1114;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'u') {
                        if (inst[4] == 'l') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1077;
                                    if (inst[7] == 'f') return 1078;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'i') {
                        if (inst[4] == 'n') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'v') return 1111;
                                    if (inst[7] == 'f') return 1112;
                                }
                            }
                        }
                    }
                    if (inst[3] == 'v') {
                        if (inst[4] == '.') {
                            if (inst[5] == 's') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'f') return 1189;
                                }
                            }
                            if (inst[5] == 'v') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'f') return 1133;
                                }
                            }
                            if (inst[5] == 'f') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 's') return 1188;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[3] == 's') {
                        if (inst[4] == 'y') {
                            if (inst[5] == 'n') {
                                if (inst[6] == 'c') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'i') return 1309;
                                        if (inst[8] == 's') return 1308;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'v') {
                        ...
                        if (inst[4] == 'o') {
                            if (inst[5] == 'r') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'i') return 1780;
                                        if (inst[8] == 'x') return 1779;
                                        if (inst[8] == 'v') return 1778;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1043;
                                        if (inst[8] == 'v') return 1042;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 's') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'm') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 's') return 1242;
                                        if (inst[8] == 'v') return 1241;
                                    }
                                }
                            }
                            if (inst[5] == 'f') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 's') return 1240;
                                        if (inst[8] == 'v') return 1239;
                                    }
                                }
                            }
                        }
                        if (inst[4] == 'e') {
                            if (inst[5] == 'm') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 's') return 1246;
                                        if (inst[8] == 'v') return 1245;
                                    }
                                }
                            }
                            if (inst[5] == 'f') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 's') return 1244;
                                        if (inst[8] == 'v') return 1243;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1047;
                                        if (inst[8] == 'v') return 1046;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'w') {
                                        if (inst[8] == 'x') return 909;
                                        if (inst[8] == 'v') return 908;
                                    }
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 901;
                                        if (inst[8] == 'v') return 900;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'w') {
                                        if (inst[8] == 'x') return 911;
                                        if (inst[8] == 'v') return 910;
                                    }
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 903;
                                        if (inst[8] == 'v') return 902;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'a') {
                        if (inst[4] == 'c') {
                            if (inst[5] == 'c') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1022;
                                        if (inst[8] == 'v') return 1021;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'u') {
                        if (inst[4] == 'l') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1008;
                                        if (inst[8] == 'v') return 1007;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'd') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'i') return 1034;
                                        if (inst[8] == 'x') return 1033;
                                        if (inst[8] == 'v') return 1032;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'x') {
                        if (inst[4] == 't') {
                            if (inst[5] == '.') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'f') {
                                        if (inst[8] == '2') return 917;
                                        if (inst[8] == '4') return 919;
                                        if (inst[8] == '8') return 921;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'u') {
                        if (inst[4] == 'b') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1039;
                                        if (inst[8] == 'v') return 1038;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'l') {
                        if (inst[4] == 'h') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 994;
                                        if (inst[8] == 'v') return 993;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'l') {
                        if (inst[4] == 'e') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'i') return 973;
                                        if (inst[8] == 'x') return 972;
                                        if (inst[8] == 'v') return 971;
                                    }
                                }
                            }
                        }
                        if (inst[4] == 't') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 968;
                                        if (inst[8] == 'v') return 967;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'g') {
                        if (inst[4] == 't') {
                            if (inst[5] == 'u') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'i') return 978;
                                        if (inst[8] == 'x') return 977;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 's') {
                        if (inst[4] == 'a') {
                            if (inst[5] == 'c') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1014;
                                        if (inst[8] == 'v') return 1013;
                                    }
                                }
                            }
                        }
                        if (inst[4] == 'u') {
                            if (inst[5] == 'b') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1018;
                                        if (inst[8] == 'v') return 1017;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'l') {
                        if (inst[4] == 'i') {
                            if (inst[5] == 'p') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'w') {
                                        if (inst[8] == 'i') return 1063;
                                        if (inst[8] == 'x') return 1062;
                                        if (inst[8] == 'v') return 1061;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'm') {
                        if (inst[4] == 'u') {
                            if (inst[5] == 'l') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'x') return 1255;
                                        if (inst[8] == 'v') return 1254;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'a') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'd') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'w') {
                                        if (inst[8] == 'v') return 1073;
                                        if (inst[8] == 'f') return 1074;
                                    }
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1069;
                                        if (inst[8] == 'f') return 1070;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 's') {
                        if (inst[4] == 'u') {
                            if (inst[5] == 'b') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'w') {
                                        if (inst[8] == 'v') return 1075;
                                        if (inst[8] == 'f') return 1076;
                                    }
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1071;
                                        if (inst[8] == 'f') return 1072;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'm') {
                        if (inst[4] == 'u') {
                            if (inst[5] == 'l') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1082;
                                        if (inst[8] == 'f') return 1083;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'g') {
                        if (inst[4] == 'n') {
                            if (inst[5] == 'j') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1115;
                                        if (inst[8] == 'f') return 1116;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 'a') {
                        if (inst[4] == 'd') {
                            if (inst[5] == 'd') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1092;
                                        if (inst[8] == 'f') return 1093;
                                    }
                                }
                            }
                        }
                        if (inst[4] == 'c') {
                            if (inst[5] == 'c') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1084;
                                        if (inst[8] == 'f') return 1085;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[3] == 's') {
                        if (inst[4] == 'a') {
                            if (inst[5] == 'c') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1088;
                                        if (inst[8] == 'f') return 1089;
                                    }
                                }
                            }
                        }
                        if (inst[4] == 'u') {
                            if (inst[5] == 'b') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == 'v') return 1096;
                                        if (inst[8] == 'f') return 1097;
                                    }
                                }
                            }
                        }
                        ...
                        if (inst[4] == '5') {
                            if (inst[5] == '6') {
                                if (inst[6] == 's') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == 'm') {
                                            if (inst[9] == '1') return 1222;
                                            if (inst[9] == '0') return 1221;
                                        }
                                    }
                                    if (inst[7] == 'i') {
                                        if (inst[8] == 'g') {
                                            if (inst[9] == '1') return 1220;
                                            if (inst[9] == '0') return 1219;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == '1') {
                            if (inst[5] == '2') {
                                if (inst[6] == 's') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == 'm') {
                                            if (inst[9] == '1') return 1232;
                                            if (inst[9] == '0') return 1231;
                                        }
                                    }
                                    if (inst[7] == 'i') {
                                        if (inst[8] == 'g') {
                                            if (inst[9] == '1') return 1230;
                                            if (inst[9] == '0') return 1229;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'a') {
                            if (inst[5] == 'd') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'i') return 1744;
                                            if (inst[9] == 'x') return 1743;
                                            if (inst[9] == 'v') return 1742;
                                        }
                                    }
                                }
                            }
                            if (inst[5] == 'n') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'i') return 1777;
                                            if (inst[9] == 'x') return 1776;
                                            if (inst[9] == 'v') return 1775;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'd') {
                            if (inst[5] == 'i') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1838;
                                            if (inst[9] == 'v') return 1837;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 's') {
                            if (inst[5] == 'u') {
                                if (inst[6] == 'b') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1746;
                                            if (inst[9] == 'v') return 1745;
                                        }
                                    }
                                }
                                if (inst[6] == 'x') {
                            ...
                            if (inst[5] == 'r') {
                                if (inst[6] == 'a') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'i') return 1792;
                                            if (inst[9] == 'x') return 1791;
                                            if (inst[9] == 'v') return 1790;
                                        }
                                    }
                                }
                                if (inst[6] == 'l') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'i') return 1789;
                                            if (inst[9] == 'x') return 1788;
                                            if (inst[9] == 'v') return 1787;
                                        }
                                    }
                                }
                            }
                            if (inst[5] == 'l') {
                                if (inst[6] == 'l') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'i') return 1786;
                                            if (inst[9] == 'x') return 1785;
                                            if (inst[9] == 'v') return 1784;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'm') {
                            if (inst[5] == 'a') {
                                if (inst[6] == 'x') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1826;
                                            if (inst[9] == 'v') return 1825;
                                        }
                                    }
                                }
                            }
                            if (inst[5] == 'u') {
                                if (inst[6] == 'l') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1828;
                                            if (inst[9] == 'v') return 1827;
                                        }
                                    }
                                }
                            }
                            if (inst[5] == 'i') {
                                if (inst[6] == 'n') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1822;
                                            if (inst[9] == 'v') return 1821;
                                        }
                                    }
                                }
                            }
                            ...
                            if (inst[5] == 'v') {
                                if (inst[6] == '.') {
                                    if (inst[7] == 's') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'x') return 2021;
                                        }
                                    }
                                    if (inst[7] == 'v') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'i') return 1869;
                                            if (inst[9] == 'x') return 1868;
                                            if (inst[9] == 'v') return 1867;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'r') {
                            if (inst[5] == 'e') {
                                if (inst[6] == 'm') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1842;
                                            if (inst[9] == 'v') return 1841;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'x') {
                            if (inst[5] == 'o') {
                                if (inst[6] == 'r') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'i') return 1783;
                                            if (inst[9] == 'x') return 1782;
                                            if (inst[9] == 'v') return 1781;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'c') {
                            if (inst[5] == 'c') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1020;
                                            if (inst[9] == 'v') return 1019;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'l') {
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1010;
                                            if (inst[9] == 'v') return 1009;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'h') {
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 996;
                                            if (inst[9] == 'v') return 995;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'i') {
                            if (inst[5] == 'p') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'w') {
                                            if (inst[9] == 'i') return 1060;
                                            if (inst[9] == 'x') return 1059;
                                            if (inst[9] == 'v') return 1058;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'u') {
                            if (inst[5] == 'l') {
                                if (inst[6] == 'h') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'x') return 1257;
                                            if (inst[9] == 'v') return 1256;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'a') {
                            if (inst[5] == 'c') {
                                if (inst[6] == 'c') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1100;
                                            if (inst[9] == 'f') return 1101;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 's') {
                            if (inst[5] == 'a') {
                                if (inst[6] == 'c') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1104;
                                            if (inst[9] == 'f') return 1105;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'n') {
                            if (inst[5] == 'j') {
                                if (inst[6] == 'n') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1117;
                                            if (inst[9] == 'f') return 1118;
                                        }
                                    }
                                }
                                if (inst[6] == 'x') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1119;
                                            if (inst[9] == 'f') return 1120;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 'a') {
                            if (inst[5] == 'd') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1094;
                                            if (inst[9] == 'f') return 1095;
                                        }
                                    }
                                }
                            }
                            if (inst[5] == 'c') {
                                if (inst[6] == 'c') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1086;
                                            if (inst[9] == 'f') return 1087;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[4] == 's') {
                            if (inst[5] == 'a') {
                                if (inst[6] == 'c') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1090;
                                            if (inst[9] == 'f') return 1091;
                                        }
                                    }
                                }
                            }
                            if (inst[5] == 'u') {
                                if (inst[6] == 'b') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 'v') {
                                            if (inst[9] == 'v') return 1098;
                                            if (inst[9] == 'f') return 1099;
                                        }
                                    }
                                }
                            }
                            ...
                            if (inst[5] == '2') {
                                if (inst[6] == 's') {
                                    ...
                                    if (inst[7] == 'i') {
                                        if (inst[8] == 'g') {
                                            if (inst[9] == '1') {
                                                if (inst[10] == 'l') return 1226;
                                                if (inst[10] == 'h') return 1225;
                                            }
                                            if (inst[9] == '0') {
                                                if (inst[10] == 'l') return 1224;
                                                if (inst[10] == 'h') return 1223;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'a') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1882;
                                                if (inst[10] == 'x') return 1881;
                                                if (inst[10] == 'v') return 1880;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1884;
                                                if (inst[10] == 'v') return 1883;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'i') {
                                if (inst[6] == 'v') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1836;
                                                if (inst[10] == 'v') return 1835;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'a') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'w') {
                                                if (inst[10] == 'x') return 1762;
                                                if (inst[10] == 'v') return 1761;
                                            }
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1754;
                                                if (inst[10] == 'v') return 1753;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'w') {
                                                if (inst[10] == 'x') return 1764;
                                                if (inst[10] == 'v') return 1763;
                                            }
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1756;
                                                if (inst[10] == 'v') return 1755;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'm') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'l') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1844;
                                                if (inst[10] == 'v') return 1843;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'a') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1875;
                                                if (inst[10] == 'x') return 1874;
                                                if (inst[10] == 'v') return 1873;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1879;
                                                if (inst[10] == 'v') return 1878;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'r') {
                                    if (inst[7] == 'a') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1899;
                                                if (inst[10] == 'x') return 1898;
                                                if (inst[10] == 'v') return 1897;
                                            }
                                        }
                                    }
                                    if (inst[7] == 'l') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1896;
                                                if (inst[10] == 'x') return 1895;
                                                if (inst[10] == 'v') return 1894;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'm') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'l') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1886;
                                                if (inst[10] == 'v') return 1885;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'a') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1854;
                                                if (inst[10] == 'v') return 1853;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'q') {
                                    if (inst[7] == 'a') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1392;
                                                if (inst[10] == 'v') return 1391;
                                            }
                                        }
                                    }
                                }
                                ...
                                if (inst[6] == 'c') {
                                    if (inst[7] == 'c') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1850;
                                                if (inst[10] == 'v') return 1849;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'x') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1824;
                                                if (inst[10] == 'v') return 1823;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'u') {
                                if (inst[6] == 'l') {
                                    if (inst[7] == 'h') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1830;
                                                if (inst[10] == 'v') return 1829;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'i') {
                                if (inst[6] == 'n') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1820;
                                                if (inst[10] == 'v') return 1819;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'e') {
                                    if (inst[7] == 'q') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1801;
                                                if (inst[10] == 'x') return 1800;
                                                if (inst[10] == 'v') return 1799;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'l') {
                                    if (inst[7] == 'e') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1814;
                                                if (inst[10] == 'x') return 1813;
                                                if (inst[10] == 'v') return 1812;
                                            }
                                        }
                                    }
                                    if (inst[7] == 't') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1808;
                                                if (inst[10] == 'v') return 1807;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'n') {
                                    if (inst[7] == 'e') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1804;
                                                if (inst[10] == 'x') return 1803;
                                                if (inst[10] == 'v') return 1802;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'g') {
                                    if (inst[7] == 't') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1818;
                                                if (inst[10] == 'x') return 1817;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'f') {
                                if (inst[6] == 'e') {
                                    if (inst[7] == 'q') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1961;
                                                if (inst[10] == 'f') return 1962;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'l') {
                                    ...
                                    if (inst[7] == 't') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1965;
                                                if (inst[10] == 'f') return 1966;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'n') {
                                    if (inst[7] == 'e') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1963;
                                                if (inst[10] == 'f') return 1964;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'e') {
                                if (inst[6] == 'm') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'x') return 1840;
                                                if (inst[10] == 'v') return 1839;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1748;
                                                if (inst[10] == 'x') return 1747;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'r') {
                                    if (inst[7] == 'a') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1798;
                                                if (inst[10] == 'x') return 1797;
                                                if (inst[10] == 'v') return 1796;
                                            }
                                        }
                                    }
                                    if (inst[7] == 'l') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1795;
                                                if (inst[10] == 'x') return 1794;
                                                if (inst[10] == 'v') return 1793;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'a') {
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1906;
                                                if (inst[10] == 'f') return 1907;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'd') {
                                if (inst[6] == 'i') {
                                    if (inst[7] == 'v') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1921;
                                                if (inst[10] == 'f') return 1922;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1908;
                                                if (inst[10] == 'f') return 1909;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'm') {
                                if (inst[6] == 'a') {
                                    if (inst[7] == 'x') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1953;
                                                if (inst[10] == 'f') return 1954;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'l') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1919;
                                                if (inst[10] == 'f') return 1920;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'i') {
                                    if (inst[7] == 'n') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1951;
                                                if (inst[10] == 'f') return 1952;
                                            }
                                        }
                                    }
                                }
                                if (inst[6] == 'v') {
                                    if (inst[7] == '.') {
                                        if (inst[8] == 's') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'f') return 2024;
                                            }
                                        }
                                        if (inst[8] == 'v') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'f') return 1975;
                                            }
                                        }
                                        if (inst[8] == 'f') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 's') return 2023;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'e') {
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'p') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1191;
                                                if (inst[10] == 'x') return 1190;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'h') {
                                if (inst[6] == 'e') {
                                    if (inst[7] == 'r') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'i') return 1201;
                                                if (inst[10] == 'x') return 1200;
                                                if (inst[10] == 'v') return 1198;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 'a') {
                                if (inst[6] == 'c') {
                                    if (inst[7] == 'c') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1102;
                                                if (inst[10] == 'f') return 1103;
                                            }
                                        }
                                    }
                                }
                            ...
                            if (inst[5] == 's') {
                                if (inst[6] == 'a') {
                                    if (inst[7] == 'c') {
                                        if (inst[8] == '.') {
                                            if (inst[9] == 'v') {
                                                if (inst[10] == 'v') return 1106;
                                                if (inst[10] == 'f') return 1107;
                                            }
                                        }
                                    }
                                }
                                ...
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'w') {
                                                    if (inst[11] == 'x') return 1758;
                                                    if (inst[11] == 'v') return 1757;
                                                }
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1750;
                                                    if (inst[11] == 'v') return 1749;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'w') {
                                                    if (inst[11] == 'x') return 1760;
                                                    if (inst[11] == 'v') return 1759;
                                                }
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1752;
                                                    if (inst[11] == 'v') return 1751;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'a') {
                                    if (inst[7] == 'c') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1860;
                                                    if (inst[11] == 'v') return 1859;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'l') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1846;
                                                    if (inst[11] == 'v') return 1845;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'd') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'i') return 1872;
                                                    if (inst[11] == 'x') return 1871;
                                                    if (inst[11] == 'v') return 1870;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'u') {
                                    if (inst[7] == 'b') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1877;
                                                    if (inst[11] == 'v') return 1876;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'q') {
                                    if (inst[7] == 'a') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1394;
                                                    if (inst[11] == 'v') return 1393;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'l') {
                                    if (inst[7] == 'h') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1832;
                                                    if (inst[11] == 'v') return 1831;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'l') {
                                    if (inst[7] == 'e') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'i') return 1811;
                                                    if (inst[11] == 'x') return 1810;
                                                    if (inst[11] == 'v') return 1809;
                                                }
                                            }
                                        }
                                    }
                                    if (inst[7] == 't') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1806;
                                                    if (inst[11] == 'v') return 1805;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'g') {
                                    if (inst[7] == 't') {
                                        if (inst[8] == 'u') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'i') return 1816;
                                                    if (inst[11] == 'x') return 1815;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'o') {
                                    if (inst[7] == 'r') {
                                        if (inst[8] == 'd') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1971;
                                                    if (inst[11] == 'f') return 1972;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 's') {
                                    if (inst[7] == 'a') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1852;
                                                    if (inst[11] == 'v') return 1851;
                                                }
                                            }
                                        }
                                    }
                                    if (inst[7] == 'u') {
                                        if (inst[8] == 'b') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'x') return 1856;
                                                    if (inst[11] == 'v') return 1855;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'l') {
                                    if (inst[7] == 'i') {
                                        if (inst[8] == 'p') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'i') return 1905;
                                                    if (inst[11] == 'x') return 1904;
                                                    if (inst[11] == 'v') return 1903;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'a') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == 'd') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'w') {
                                                    if (inst[11] == 'v') return 1915;
                                                    if (inst[11] == 'f') return 1916;
                                                }
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1911;
                                                    if (inst[11] == 'f') return 1912;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 's') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == 'b') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'w') {
                                                    if (inst[11] == 'v') return 1917;
                                                    if (inst[11] == 'f') return 1918;
                                                }
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1913;
                                                    if (inst[11] == 'f') return 1914;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'm') {
                                    if (inst[7] == 'u') {
                                        if (inst[8] == 'l') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1924;
                                                    if (inst[11] == 'f') return 1925;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'g') {
                                    if (inst[7] == 'n') {
                                        if (inst[8] == 'j') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1955;
                                                    if (inst[11] == 'f') return 1956;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 'a') {
                                    if (inst[7] == 'd') {
                                        if (inst[8] == 'd') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1934;
                                                    if (inst[11] == 'f') return 1935;
                                                }
                                            }
                                        }
                                    }
                                    if (inst[7] == 'c') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1926;
                                                    if (inst[11] == 'f') return 1927;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (inst[6] == 's') {
                                    if (inst[7] == 'a') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1930;
                                                    if (inst[11] == 'f') return 1931;
                                                }
                                            }
                                        }
                                    }
                                    if (inst[7] == 'u') {
                                        if (inst[8] == 'b') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'v') {
                                                    if (inst[11] == 'v') return 1938;
                                                    if (inst[11] == 'f') return 1939;
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    if (inst[7] == 'h') {
                                        if (inst[8] == 'e') {
                                            if (inst[9] == '.') {
                                                if (inst[10] == 'i') {
                                                    if (inst[11] == 's') {
                                                        if (inst[12] == 'w') return 1296;
                                                    }
                                                    if (inst[11] == 'p') {
                                                        if (inst[12] == 'a') return 1290;
                                                    }
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'a') return 1293;
                                                    }
                                                }
                                                if (inst[10] == 'c') {
                                                    if (inst[11] == 's') {
                                                        if (inst[12] == 'w') return 1294;
                                                    }
                                                    if (inst[11] == 'p') {
                                                        if (inst[12] == 'a') return 1288;
                                                    }
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'a') return 1291;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'a') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'x') return 1890;
                                                        if (inst[12] == 'v') return 1889;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'c') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == 'u') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'x') return 1858;
                                                        if (inst[12] == 'v') return 1857;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'l') {
                                        if (inst[8] == 's') {
                                            if (inst[9] == 'u') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'x') return 1848;
                                                        if (inst[12] == 'v') return 1847;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'h') {
                                        if (inst[8] == 's') {
                                            if (inst[9] == 'u') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'x') return 1834;
                                                        if (inst[12] == 'v') return 1833;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'i') {
                                        if (inst[8] == 'p') {
                                            if (inst[9] == 'u') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'i') return 1902;
                                                        if (inst[12] == 'x') return 1901;
                                                        if (inst[12] == 'v') return 1900;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'a') {
                                        if (inst[8] == 'c') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1942;
                                                        if (inst[12] == 'f') return 1943;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 's') {
                                        if (inst[8] == 'a') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1946;
                                                        if (inst[12] == 'f') return 1947;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'n') {
                                        if (inst[8] == 'j') {
                                            if (inst[9] == 'n') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1957;
                                                        if (inst[12] == 'f') return 1958;
                                                    }
                                                }
                                            }
                                            if (inst[9] == 'x') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1959;
                                                        if (inst[12] == 'f') return 1960;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'a') {
                                        if (inst[8] == 'd') {
                                            if (inst[9] == 'd') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1936;
                                                        if (inst[12] == 'f') return 1937;
                                                    }
                                                }
                                            }
                                        }
                                        if (inst[8] == 'c') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1928;
                                                        if (inst[12] == 'f') return 1929;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 's') {
                                        if (inst[8] == 'a') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1932;
                                                        if (inst[12] == 'f') return 1933;
                                                    }
                                                }
                                            }
                                        }
                                        if (inst[8] == 'u') {
                                            if (inst[9] == 'b') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'v') return 1940;
                                                        if (inst[12] == 'f') return 1941;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[7] == 'o') {
                                        if (inst[8] == 'w') {
                                            if (inst[9] == 'n') {
                                                if (inst[10] == '.') {
                                                    if (inst[11] == 'v') {
                                                        if (inst[12] == 'i') return 1193;
                                                        if (inst[12] == 'x') return 1192;
                                                    }
                                                }
                                            }
                                        }
                                        ...
                                        if (inst[8] == 'e') {
                                            if (inst[9] == '.') {
                                                ...
                                                if (inst[10] == 'c') {
                                                    if (inst[11] == 'a') {
                                                        if (inst[12] == 'l') {
                                                            if (inst[13] == 'l') return 1285;
                                                        }
                                                    }
                                                    if (inst[11] == 'i') {
                                                        if (inst[12] == 's') {
                                                            if (inst[13] == 'w') return 1295;
                                                        }
                                                        if (inst[12] == 'p') {
                                                            if (inst[13] == 'a') return 1289;
                                                        }
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'a') return 1292;
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (inst[8] == 'c') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == 'u') {
                                                    if (inst[11] == '.') {
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'x') return 1888;
                                                            if (inst[13] == 'v') return 1887;
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (inst[8] == 'e') {
                                            if (inst[9] == 'u') {
                                                if (inst[10] == 'p') {
                                                    if (inst[11] == '.') {
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'i') return 2026;
                                                            if (inst[13] == 'x') return 2025;
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (inst[8] == 'h') {
                                            if (inst[9] == 'e') {
                                                if (inst[10] == 'r') {
                                                    if (inst[11] == '.') {
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'i') return 2033;
                                                            if (inst[13] == 'x') return 2032;
                                                            if (inst[13] == 'v') return 2031;
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (inst[8] == 'a') {
                                            if (inst[9] == 'c') {
                                                if (inst[10] == 'c') {
                                                    if (inst[11] == '.') {
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'v') return 1944;
                                                            if (inst[13] == 'f') return 1945;
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (inst[8] == 's') {
                                            if (inst[9] == 'a') {
                                                if (inst[10] == 'c') {
                                                    if (inst[11] == '.') {
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'v') return 1948;
                                                            if (inst[13] == 'f') return 1949;
                                                        }
                                                    }
                                                }
                                            }
                                        ...
                                        if (inst[8] == 'f') {
                                            if (inst[9] == '1') {
                                                if (inst[10] == '6') {
                                                    if (inst[11] == '.') {
                                                        if (inst[12] == 'v') {
                                                            if (inst[13] == 'v') return 1283;
                                                            if (inst[13] == 'f') return 1284;
                                                        }
                                                    }
                                                }
                                            }
                                                ...
                                                if (inst[10] == 'o') {
                                                    if (inst[11] == 'w') {
                                                        if (inst[12] == 'n') {
                                                            if (inst[13] == '.') {
                                                                if (inst[14] == 'v') {
                                                                    if (inst[15] == 'i') return 2028;
                                                                    if (inst[15] == 'x') return 2027;
                                                                }
                                                            }
                                                        }
                                                    }
