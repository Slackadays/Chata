...
ultravector<uint8_t> assemble_code(const std::string_view& data, const ultravector<RVInstructionSet> supported_sets) {
    ...
    int res = std::system("riscv64-linux-gnu-as -march=rv64gvfdcqb_zknd_zbkb_zknh_zksh_zksed_zvkned_zvkb_zbkx_zvbb_zvbc_zvknhb_zvkg_zvksh_zvksed_zbc_zba_zicond_zacas_zcb_zcmp_zfbfmin_zvfbfmin temp.s -o temp.o");
