...
const uint16_t fast_instr_search(const ultrastring& inst) {
                    ...
                    if (inst[4] == '2') {
                        ...
                        if (inst[5] == 'd') {
                            ...
                            if (inst[6] == 's') {
                                ...
                                if (inst[7] == 'i') {
                                    if (inst.size() < 9) return 1200;
                                }
                                if (inst[7] == 'm') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'i') {
                                        if (inst.size() < 10) return 1201;
                                    }
                                }
                            }
                        }
                        if (inst[5] == 'e') {
                            ...
                            if (inst[6] == 's') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'i') {
                                    if (inst.size() < 9) return 1202;
                                }
                                if (inst[7] == 'm') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'i') {
                                        if (inst.size() < 10) return 1203;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[4] == '4') {
                        ...
                        if (inst[5] == 'k') {
                            ...
                            if (inst[6] == 's') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == '2') {
                                    if (inst.size() < 9) return 1210;
                                }
                                if (inst[7] == '1') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'i') {
                                        if (inst.size() < 10) return 1209;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[4] == 'd') {
                        ...
                        if (inst[5] == 'd') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'b') {
                                    if (inst.size() < 9) return 351;
                                    if (inst[8] == '.') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 371;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 411;
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if (inst[7] == 'h') {
                                    if (inst.size() < 9) return 352;
                                    if (inst[8] == '.') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 372;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 412;
                                                    }
                                                }
                                            }
                                        }
                    ...
                    if (inst[4] == 'n') {
                        ...
                        if (inst[5] == 'd') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'b') {
                                    if (inst.size() < 9) return 353;
                                    if (inst[8] == '.') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 373;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 413;
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if (inst[7] == 'h') {
                                    ...
                                    if (inst[8] == '.') {
                                        ...
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 374;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 414;
                                                    }
                                                }
                                            }
                                        }
                        ...
                        if (inst[5] == 'a') {
                            ...
                            if (inst[6] == 'p') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'b') {
                                        if (inst.size() < 10) return 349;
                                        if (inst[9] == '.') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'a') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'q') {
                                                    if (inst.size() < 13) return 369;
                                                    if (inst[12] == 'r') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'l') {
                                                            if (inst.size() < 15) return 409;
                                                        }
                                                    }
                                                }
                                            }
                                    ...
                                    if (inst[8] == 'h') {
                                        if (inst.size() < 10) return 350;
                                        if (inst[9] == '.') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'a') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'q') {
                                                    if (inst.size() < 13) return 370;
                                                    if (inst[12] == 'r') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'l') {
                                                            if (inst.size() < 15) return 410;
                                                        }
                                                    }
                                                }
                                            }
                        ...
                        if (inst[5] == 'x') {
                            ...
                            if (inst[6] == 'u') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'b') {
                                        if (inst.size() < 10) return 361;
                                        if (inst[9] == '.') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'a') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'q') {
                                                    if (inst.size() < 13) return 381;
                                                    if (inst[12] == 'r') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'l') {
                                                            if (inst.size() < 15) return 421;
                                                        }
                                                    }
                                                }
                                            }
                                            if (inst[10] == 'r') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'l') {
                                                    if (inst.size() < 13) return 401;
                                                }
                                            }
                                        }
                                    }
                                    if (inst[8] == 'h') {
                                        if (inst.size() < 10) return 362;
                                        if (inst[9] == '.') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'a') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'q') {
                                                    if (inst.size() < 13) return 382;
                                                    if (inst[12] == 'r') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'l') {
                                                            if (inst.size() < 15) return 422;
                                                        }
                                                    }
                                                }
                                            }
                    ...
                    if (inst[4] == 'i') {
                        ...
                        if (inst[5] == 'n') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'b') {
                                    if (inst.size() < 9) return 363;
                                    if (inst[8] == '.') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 383;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 423;
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    if (inst[8] == 'b') {
                                        ...
                                        if (inst[9] == '.') {
                                            ...
                                            if (inst[10] == 'a') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'q') {
                                                    if (inst.size() < 13) return 385;
                                                    if (inst[12] == 'r') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'l') {
                                                            if (inst.size() < 15) return 425;
                                                        }
                                                    }
                                                }
                                            }
                                    ...
                                    if (inst[8] == 'h') {
                                        ...
                                        if (inst[9] == '.') {
                                            ...
                                            if (inst[10] == 'a') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'q') {
                                                    if (inst.size() < 13) return 386;
                                                    if (inst[12] == 'r') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'l') {
                                                            if (inst.size() < 15) return 426;
                                                        }
                                                    }
                                                }
                                            }
                ...
                if (inst[3] == 'o') {
                    ...
                    if (inst[4] == 'r') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'b') {
                                if (inst.size() < 8) return 355;
                                if (inst[7] == '.') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'a') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'q') {
                                            if (inst.size() < 11) return 375;
                                            if (inst[10] == 'r') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'l') {
                                                    if (inst.size() < 13) return 415;
                                                }
                                            }
                                        }
                                    }
                                    if (inst[8] == 'r') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'l') {
                                            if (inst.size() < 11) return 395;
                                        }
                                    }
                                }
                            }
                            if (inst[6] == 'h') {
                                if (inst.size() < 8) return 356;
                                if (inst[7] == '.') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'a') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'q') {
                                            if (inst.size() < 11) return 376;
                                            if (inst[10] == 'r') {
                                                if (inst.size() < 12) return instr_search_failed;
                                                if (inst[11] == 'l') {
                                                    if (inst.size() < 13) return 416;
                                                }
                                            }
                                        }
                                    }
                    ...
                    if (inst[4] == 'a') {
                        ...
                        if (inst[5] == 's') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'h') {
                                    if (inst.size() < 9) return 368;
                                    if (inst[8] == '.') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 388;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 428;
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if (inst[7] == 'b') {
                                    ...
                                    if (inst[8] == '.') {
                                        ...
                                        if (inst[9] == 'a') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'q') {
                                                if (inst.size() < 12) return 377;
                                                if (inst[11] == 'r') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'l') {
                                                        if (inst.size() < 14) return 417;
                                                    }
                                                }
                                            }
                                        }
            ...
            if (inst[2] == 'x') {
                ...
                if (inst[3] == 't') {
                    ...
                    if (inst[4] == '.') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'b') {
                            if (inst.size() < 7) return 558;
                        }
                        if (inst[5] == 'h') {
                            if (inst.size() < 7) return 559;
                        }
                    }
                }
            }
        ...
        if (inst[1] == 'm') {
            ...
            if (inst[2] == '3') {
                ...
                if (inst[3] == 'p') {
                    if (inst.size() < 5) return instr_search_failed;
                    if (inst[4] == '1') {
                        if (inst.size() < 6) return 1227;
                    }
                    if (inst[4] == '0') {
                        if (inst.size() < 6) return 1226;
                    }
                }
            }
            if (inst[2] == '4') {
                ...
                if (inst[3] == 'e') {
                    if (inst.size() < 5) return instr_search_failed;
                    if (inst[4] == 'd') {
                        if (inst.size() < 6) return 1228;
                    }
                }
                if (inst[3] == 'k') {
                    if (inst.size() < 5) return instr_search_failed;
                    if (inst[4] == 's') {
                        if (inst.size() < 6) return 1229;
                    }
                }
            }
        }
                            ...
                            if (inst[6] == 's') {
                                ...
                                if (inst[7] == 'u') {
                                    ...
                                    if (inst[8] == 'm') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == '1') {
                                            if (inst.size() < 11) return 1215;
                                        }
                                        if (inst[9] == '0') {
                                            if (inst.size() < 11) return 1214;
                                        }
                                    }
                                }
                                if (inst[7] == 'i') {
                                    ...
                                    if (inst[8] == 'g') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == '1') {
                                            if (inst.size() < 11) return 1213;
                                        }
                                        if (inst[9] == '0') {
                                            if (inst.size() < 11) return 1212;
                                        }
                                    }
                                }
                            }
                            ...
                            if (inst[6] == 's') {
                                ...
                                if (inst[7] == 'u') {
                                    ...
                                    if (inst[8] == 'm') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == '1') {
                                            if (inst.size() < 11) return 1225;
                                            if (inst[10] == 'r') {
                                                if (inst.size() < 12) return 1221;
                                            }
                                        }
                                        if (inst[9] == '0') {
                                            if (inst.size() < 11) return 1224;
                                            if (inst[10] == 'r') {
                                                if (inst.size() < 12) return 1220;
                                            }
                                        }
                                    }
                                }
                                if (inst[7] == 'i') {
                                    ...
                                    if (inst[8] == 'g') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == '1') {
                                            if (inst.size() < 11) return 1223;
                                            if (inst[10] == 'l') {
                                                if (inst.size() < 12) return 1219;
                                            }
                                            if (inst[10] == 'h') {
                                                if (inst.size() < 12) return 1218;
                                            }
                                        }
                                        if (inst[9] == '0') {
                                            if (inst.size() < 11) return 1222;
                                            if (inst[10] == 'l') {
                                                if (inst.size() < 12) return 1217;
                                            }
                                            if (inst[10] == 'h') {
                                                if (inst.size() < 12) return 1216;
                                            }
                                        }
                                    }
                                }
            ...
            if (inst[2] == '3') {
                ...
                if (inst[3] == 'a') {
                    ...
                    if (inst[4] == 'd') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'd') {
                            if (inst.size() < 7) return 564;
                            if (inst[6] == '.') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'u') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'w') {
                                        if (inst.size() < 10) return 565;
                                    }
                                }
                            }
                        }
            ...
            if (inst[2] == '2') {
                ...
                if (inst[3] == 'a') {
                    ...
                    if (inst[4] == 'd') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'd') {
                            if (inst.size() < 7) return 562;
                            if (inst[6] == '.') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'u') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'w') {
                                        if (inst.size() < 10) return 563;
                                    }
                                }
                            }
                        }
            ...
            if (inst[2] == '1') {
                ...
                if (inst[3] == 'a') {
                    ...
                    if (inst[4] == 'd') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'd') {
                            if (inst.size() < 7) return 560;
                            if (inst[6] == '.') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'u') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'w') {
                                        if (inst.size() < 10) return 561;
                                    }
                                }
                            }
                        }
    ...
    if (inst[0] == 'm') {
        ...
        if (inst[1] == 'a') {
            if (inst.size() < 3) return instr_search_failed;
            if (inst[2] == 'x') {
                if (inst.size() < 4) return 541;
                if (inst[3] == 'u') {
                    if (inst.size() < 5) return 542;
                }
            }
        }
        if (inst[1] == 'u') {
                ...
                if (inst[3] == '.') {
                    ...
                    if (inst[4] == 'r') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == '6') {
                                if (inst.size() < 8) return 488;
                            }
                            if (inst[6] == '4') {
                                if (inst.size() < 8) return 486;
                            }
                            if (inst[6] == '1') {
                                if (inst.size() < 8) return 483;
                                if (inst[7] == '3') {
                                    if (inst.size() < 9) return 495;
                                }
                                if (inst[7] == '2') {
                                    if (inst.size() < 9) return 494;
                                }
                                if (inst[7] == '6') {
                                    if (inst.size() < 9) return 498;
                                }
                                if (inst[7] == '4') {
                                    if (inst.size() < 9) return 496;
                                }
                                if (inst[7] == '1') {
                                    if (inst.size() < 9) return 493;
                                }
                                if (inst[7] == '8') {
                                    if (inst.size() < 9) return 500;
                                }
                                if (inst[7] == '0') {
                                    if (inst.size() < 9) return 492;
                                }
                                if (inst[7] == '5') {
                                    if (inst.size() < 9) return 497;
                                }
                                if (inst[7] == '7') {
                            ...
                            if (inst[6] == '0') {
                                if (inst.size() < 8) return 482;
                            }
                            if (inst[6] == '5') {
                                if (inst.size() < 8) return 487;
                            }
                            if (inst[6] == '7') {
    ...
    if (inst[0] == 'b') {
        ...
        if (inst[1] == 'i') {
            ...
            if (inst[2] == 'n') {
                if (inst.size() < 4) return instr_search_failed;
                if (inst[3] == 'v') {
                    if (inst.size() < 5) return 528;
                    if (inst[4] == 'i') {
                        if (inst.size() < 6) return 529;
                    }
                }
            }
        }
        if (inst[1] == 'e') {
            ...
            if (inst[2] == 'x') {
                if (inst.size() < 4) return instr_search_failed;
                if (inst[3] == 't') {
                    if (inst.size() < 5) return 526;
                    if (inst[4] == 'i') {
                        if (inst.size() < 6) return 527;
                    }
                }
            }
        }
        ...
        if (inst[1] == 'c') {
            ...
            if (inst[2] == 'l') {
                if (inst.size() < 4) return instr_search_failed;
                if (inst[3] == 'r') {
                    if (inst.size() < 5) return 524;
                    if (inst[4] == 'i') {
                        if (inst.size() < 6) return 525;
                    }
                }
            }
        }
        ...
        if (inst[1] == 'e') {
            ...
            if (inst[2] == 'v') {
                ...
                if (inst[3] == '.') {
                    if (inst.size() < 5) return instr_search_failed;
                    if (inst[4] == 'b') {
                        if (inst.size() < 6) return 551;
                    }
                }
                if (inst[3] == '8') {
                    if (inst.size() < 5) return 550;
                }
            }
        }
        if (inst[1] == 'o') {
            if (inst.size() < 3) return instr_search_failed;
            if (inst[2] == 'r') {
                if (inst.size() < 4) return 554;
                if (inst[3] == 'w') {
                    if (inst.size() < 5) return 557;
                }
                if (inst[3] == 'i') {
                    if (inst.size() < 5) return 555;
                    if (inst[4] == 'w') {
            ...
            if (inst[2] == 'l') {
                if (inst.size() < 4) return 552;
                if (inst[3] == 'w') {
                    if (inst.size() < 5) return 553;
                }
            }
        }
    }
    ...
    if (inst[0] == 'c') {
        ...
        if (inst[1] == '.') {
            ...
            if (inst[2] == 'l') {
                ...
                if (inst[3] == 'b') {
                    if (inst.size() < 5) return instr_search_failed;
                    if (inst[4] == 'u') {
                        if (inst.size() < 6) return 429;
                    }
                }
                if (inst[3] == 'h') {
                    if (inst.size() < 5) return 431;
                    if (inst[4] == 'u') {
                        if (inst.size() < 6) return 430;
                    }
                }
            }
            if (inst[2] == 'n') {
            ...
            if (inst[2] == 'm') {
                ...
                if (inst[3] == 'u') {
                    ...
                    if (inst[4] == 'l') {
                        ...
                        if (inst[5] == 'r') {
                            if (inst.size() < 7) return 534;
                        }
                        if (inst[5] == 'h') {
                            if (inst.size() < 7) return 533;
                        }
                    }
                }
            }
            if (inst[2] == 'z') {
                if (inst.size() < 4) return 535;
                if (inst[3] == 'w') {
                    if (inst.size() < 5) return 536;
                }
            }
        }
        if (inst[1] == 'p') {
        ...
        if (inst[1] == 't') {
            if (inst.size() < 3) return instr_search_failed;
            if (inst[2] == 'z') {
                if (inst.size() < 4) return 539;
                if (inst[3] == 'w') {
                    if (inst.size() < 5) return 540;
                }
            }
        }
        if (inst[1] == 'z') {
                ...
                if (inst[3] == 'r') {
                    ...
                    if (inst[4] == 'm') {
                        ...
                        if (inst[5] == '.') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'b') {
                                if (inst.size() < 8) return 569;
                            }
                            if (inst[6] == 'n') {
                                if (inst.size() < 8) return 570;
                            }
                        }
                        if (inst[5] == '4') {
                            if (inst.size() < 7) return 1231;
                        }
                        if (inst[5] == '8') {
                            if (inst.size() < 7) return 1230;
                        }
                    }
                }
            }
        ...
        if (inst[1] == 'a') {
            ...
            if (inst[2] == 'c') {
                ...
                if (inst[3] == 'k') {
                    ...
                    if (inst[4] == 'w') {
                        if (inst.size() < 6) return 549;
                    }
                    if (inst[4] == 'h') {
                        if (inst.size() < 6) return 548;
                    }
                }
            }
        }
                        ...
                        if (inst[5] == 'u') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 1036;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1035;
                                    }
                                }
                            }
                        }
                ...
                if (inst[3] == 'd') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'i') {
                                if (inst.size() < 8) return 888;
                            }
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 887;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 886;
                            }
                        }
                    }
                }
                        ...
                        if (inst[5] == 'm') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 's') {
                                        if (inst.size() < 10) return 1235;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1234;
                                    }
                                }
                            }
                        }
                        if (inst[5] == 'f') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 's') {
                                        if (inst.size() < 10) return 1233;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1232;
                                    }
                                }
                            }
                        }
                        ...
                        if (inst[5] == 'f') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 's') {
                                        if (inst.size() < 10) return 1237;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1236;
                                    }
                                }
                            }
                        }
                ...
                if (inst[3] == 'd') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'i') {
                                if (inst.size() < 8) return 932;
                            }
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 931;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 930;
                            }
                        }
                    }
                    if (inst[4] == 'n') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'x') {
                                    if (inst.size() < 9) return 1244;
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1243;
                                }
                            }
                        }
                    }
                ...
                if (inst[3] == 'v') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 993;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 992;
                            }
                        }
                    }
                    if (inst[4] == 'u') {
                        ...
                        if (inst[5] == 'u') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 894;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 893;
                                    }
                                }
                            }
                        }
                        ...
                        if (inst[5] == 'u') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 896;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 895;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[4] == 'l') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                ...
                                if (inst[7] == 'x') {
                                    if (inst.size() < 9) return 1270;
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1269;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[4] == 'd') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'i') {
                                    if (inst.size() < 9) return 1030;
                                }
                                if (inst[7] == 'x') {
                                    if (inst.size() < 9) return 1029;
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1028;
                                }
                            }
                        }
                        if (inst[5] == 'u') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'i') {
                                        if (inst.size() < 10) return 1027;
                                    }
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 1026;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1025;
                                    }
                                }
                            }
                        }
                ...
                if (inst[3] == 'b') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 890;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 889;
                            }
                        }
                    }
                }
                    ...
                    if (inst[4] == 'r') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 's') {
                                    if (inst.size() < 9) return 1268;
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1267;
                                }
                            }
                        }
                    }
                                        ...
                                        if (inst[9] == 'n') {
                                            ...
                                            if (inst[10] == '.') {
                                                ...
                                                if (inst[11] == 'v') {
                                                    if (inst.size() < 13) return instr_search_failed;
                                                    if (inst[12] == 'i') {
                                                        if (inst.size() < 14) return 1186;
                                                    }
                                                    if (inst[12] == 'x') {
                                                        if (inst.size() < 14) return 1185;
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if (inst[7] == 'p') {
                                    ...
                                    if (inst[8] == '.') {
                                        ...
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'i') {
                                                if (inst.size() < 12) return 1184;
                                            }
                                            if (inst[10] == 'x') {
                                                if (inst.size() < 12) return 1183;
                                            }
                                        }
                                    }
                                }
                ...
                if (inst[3] == 'l') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'i') {
                                if (inst.size() < 8) return 941;
                            }
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 940;
                            }
                            if (inst[6] == 'v') {
                ...
                if (inst[3] == 'x') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 981;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 980;
                            }
                        }
                    }
                    if (inst[4] == 'u') {
                ...
                if (inst[3] == 'n') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 977;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 976;
                            }
                        }
                    }
                    if (inst[4] == 'u') {
                        ...
                        if (inst[5] == 'u') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'i') {
                                        if (inst.size() < 10) return 966;
                                    }
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 965;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 964;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[4] == 't') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'i') {
                                    if (inst.size() < 9) return 973;
                                }
                                if (inst[7] == 'x') {
                                    if (inst.size() < 9) return 972;
                                }
                            }
                        }
                        if (inst[5] == 'u') {
                ...
                if (inst[3] == '.') {
                    ...
                    if (inst[4] == 'v') {
                        ...
                        if (inst[5] == '.') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'i') {
                                if (inst.size() < 8) return 1024;
                            }
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 1023;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 1022;
                            }
                        }
                    }
                }
                    ...
                    if (inst[4] == 't') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1118;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1119;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[4] == 'e') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1116;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1117;
                                }
                            }
                        }
                    }
            ...
            if (inst[2] == 'r') {
                ...
                if (inst[3] == '.') {
                    ...
                    if (inst[4] == 'v') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'i') {
                            if (inst.size() < 7) return 935;
                        }
                        if (inst[5] == 'x') {
                            if (inst.size() < 7) return 934;
                        }
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return 933;
                        }
                    }
                }
            }
                ...
                if (inst[3] == 'm') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 997;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 996;
                            }
                        }
                    }
                    if (inst[4] == 'u') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'x') {
                                    if (inst.size() < 9) return 995;
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 994;
                                }
                            }
                        }
                    }
                ...
                if (inst[3] == 'r') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'i') {
                                if (inst.size() < 8) return 1260;
                            }
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 1259;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 1258;
                            }
                        }
                    }
                }
                if (inst[3] == 'l') {
                    ...
                    if (inst[4] == '.') {
                        ...
                        if (inst[5] == 'v') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'x') {
                                if (inst.size() < 8) return 1257;
                            }
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return 1256;
                            }
                        }
                    }
                }
                                ...
                                if (inst[7] == 'r') {
                                    ...
                                    if (inst[8] == '.') {
                                        ...
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'i') {
                                                if (inst.size() < 12) return 1194;
                                            }
                                            if (inst[10] == 'x') {
                                                if (inst.size() < 12) return 1193;
                                            }
                                            if (inst[10] == 'v') {
                    ...
                    if (inst[4] == 'a') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'w') {
                                ...
                                if (inst[7] == 'x') {
                                    if (inst.size() < 9) return 952;
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 951;
                                }
                            }
                        }
                    }
                        ...
                        if (inst[5] == 'p') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'w') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'i') {
                                        if (inst.size() < 10) return 1056;
                                    }
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 1055;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1054;
                                    }
                                }
                            }
                            if (inst[6] == 'u') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'w') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'i') {
                                            if (inst.size() < 11) return 1053;
                                        }
                                        if (inst[9] == 'x') {
                                            if (inst.size() < 11) return 1052;
                                        }
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return 1051;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[5] == 'l') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'x') {
                                        if (inst.size() < 10) return 1248;
                                    }
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1247;
                                    }
                                }
                            }
                            if (inst[6] == 'h') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'x') {
                                            if (inst.size() < 11) return 1250;
                                        }
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return 1249;
                                        }
                                    }
                                }
                            }
                    ...
                    if (inst[4] == 'v') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1072;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1073;
                                }
                            }
                        }
                    }
                        ...
                        if (inst[5] == 'd') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'w') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1066;
                                    }
                                    if (inst[8] == 'f') {
                                        if (inst.size() < 10) return 1067;
                                    }
                                }
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                        ...
                        if (inst[5] == 'b') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1064;
                                    }
                                    if (inst[8] == 'f') {
                                        if (inst.size() < 10) return 1065;
                                    }
                                }
                            }
                        }
                                            ...
                                            if (inst[10] == '6') {
                                                ...
                                                if (inst[11] == '.') {
                                                    ...
                                                    if (inst[12] == 'v') {
                                                        if (inst.size() < 14) return instr_search_failed;
                                                        if (inst[13] == 'v') {
                                                            if (inst.size() < 15) return 1276;
                                                        }
                                                        if (inst[13] == 'f') {
                                                            if (inst.size() < 15) return 1277;
                                                        }
                                                    }
                                                }
                                            }
                                ...
                                if (inst[7] == 'c') {
                                    ...
                                    if (inst[8] == '.') {
                                        ...
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'v') {
                                                if (inst.size() < 12) return 1095;
                                            }
                                            if (inst[10] == 'f') {
                                                if (inst.size() < 12) return 1096;
                                            }
                                        }
                                    }
                                }
                                ...
                                if (inst[7] == 'c') {
                                    ...
                                    if (inst[8] == '.') {
                                        ...
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return instr_search_failed;
                                            if (inst[10] == 'v') {
                                                if (inst.size() < 12) return 1099;
                                            }
                                            if (inst[10] == 'f') {
                                                if (inst.size() < 12) return 1100;
                                            }
                                        }
                                    }
                                }
                    ...
                    if (inst[4] == 'b') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1059;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1060;
                                }
                            }
                        }
                    }
                        ...
                        if (inst[5] == 'j') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1108;
                                    }
                                    if (inst[8] == 'f') {
                                        if (inst.size() < 10) return 1109;
                                    }
                                }
                            }
                            if (inst[6] == 'n') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return 1110;
                                        }
                                        if (inst[9] == 'f') {
                                            if (inst.size() < 11) return 1111;
                                        }
                                    }
                                }
                            }
                            if (inst[6] == 'x') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return 1112;
                                        }
                                        if (inst[9] == 'f') {
                                            if (inst.size() < 11) return 1113;
                                        }
                                    }
                                }
                            }
                        ...
                        if (inst[5] == 'c') {
                            ...
                            if (inst[6] == '.') {
                                ...
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return instr_search_failed;
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return 1077;
                                    }
                                    if (inst[8] == 'f') {
                                        if (inst.size() < 10) return 1078;
                                    }
                                }
                            }
                        }
                    ...
                    if (inst[4] == 'x') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1106;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1107;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[4] == 'l') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1070;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1071;
                                }
                            }
                        }
                    }
                    ...
                    if (inst[4] == 'n') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 'v') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'v') {
                                    if (inst.size() < 9) return 1104;
                                }
                                if (inst[7] == 'f') {
                                    if (inst.size() < 9) return 1105;
                                }
                            }
                        }
                    }
                            ...
                            if (inst[6] == 'c') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return 1079;
                                        }
                                        if (inst[9] == 'f') {
                                            if (inst.size() < 11) return 1080;
                                        }
                                    }
                                }
                            }
                            ...
                            if (inst[6] == 'c') {
                                ...
                                if (inst[7] == '.') {
                                    ...
                                    if (inst[8] == 'v') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'v') {
                                            if (inst.size() < 11) return 1083;
                                        }
                                        if (inst[9] == 'f') {
                                            if (inst.size() < 11) return 1084;
                                        }
                                    }
                                }
                            }
                ...
                if (inst[3] == 'x') {
                    ...
                    if (inst[4] == 'm') {
                        ...
                        if (inst[5] == '.') {
                            if (inst.size() < 7) return instr_search_failed;
                            if (inst[6] == 'd') {
                                if (inst.size() < 8) return 456;
                            }
                            if (inst[6] == 's') {
                                if (inst.size() < 8) return 454;
                            }
                            if (inst[6] == 'q') {
                                if (inst.size() < 8) return 458;
                            }
                            if (inst[6] == 'h') {
                ...
                if (inst[3] == 'n') {
                    ...
                    if (inst[4] == 'm') {
                        ...
                        if (inst[5] == '.') {
                            ...
                            if (inst[6] == 's') {
                                if (inst.size() < 8) return 453;
                            }
                            if (inst[6] == 'q') {
                                if (inst.size() < 8) return 457;
                            }
                            if (inst[6] == 'h') {
                                if (inst.size() < 8) return 459;
                            }
                        }
                    }
                }
                    ...
                    if (inst[4] == 'n') {
                        ...
                        if (inst[5] == 'd') {
                            ...
                            if (inst[6] == '.') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'd') {
                                    if (inst.size() < 9) return 463;
                                }
                                if (inst[7] == 's') {
                                    if (inst.size() < 9) return 461;
                                }
                                if (inst[7] == 'q') {
                                    if (inst.size() < 9) return 467;
                                }
                                if (inst[7] == 'h') {
                                    if (inst.size() < 9) return 465;
                                }
                            }
                            if (inst[6] == 'n') {
                                if (inst.size() < 8) return instr_search_failed;
                                if (inst[7] == 'x') {
                                    ...
                                    if (inst[8] == '.') {
                                        if (inst.size() < 10) return instr_search_failed;
                                        if (inst[9] == 'd') {
                                            if (inst.size() < 11) return 464;
                                        }
                                        if (inst[9] == 's') {
                                            if (inst.size() < 11) return 462;
                                        }
                                        if (inst[9] == 'q') {
                                            if (inst.size() < 11) return 468;
                                        }
                                        if (inst[9] == 'h') {
                                            if (inst.size() < 11) return 466;
                                        }
                                    }
                                }
                            }
            ...
            if (inst[2] == 'e') {
                ...
                if (inst[3] == 'q') {
                    ...
                    if (inst[4] == '.') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'd') {
                            if (inst.size() < 7) return 476;
                        }
                        if (inst[5] == 's') {
                            if (inst.size() < 7) return 474;
                        }
                        if (inst[5] == 'q') {
            ...
            if (inst[2] == 't') {
                ...
                if (inst[3] == 'q') {
                    ...
                    if (inst[4] == '.') {
                        if (inst.size() < 6) return instr_search_failed;
                        if (inst[5] == 'd') {
                            if (inst.size() < 7) return 477;
                        }
                        if (inst[5] == 's') {
                            if (inst.size() < 7) return 475;
                        }
                        if (inst[5] == 'q') {
