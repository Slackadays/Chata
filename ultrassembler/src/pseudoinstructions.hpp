...
void th_vfneg_v_instr(assembly_context& c);
void vfabs_v_instr(assembly_context& c);
void th_vfabs_v_instr(assembly_context& c);
void vmclr_m_instr(assembly_context& c);
void th_vmclr_m_instr(assembly_context& c);
void vmfge_vv_instr(assembly_context& c);
void th_vmfge_vv_instr(assembly_context& c);
...
void th_vmset_m_instr(assembly_context& c);
void vmsge_vi_instr(assembly_context& c);
void th_vmsge_vi_instr(assembly_context& c);
void vmsgeu_vi_instr(assembly_context& c);
void th_vmsgeu_vi_instr(assembly_context& c);
void vmsge_vv_instr(assembly_context& c);
void th_vmsge_vv_instr(assembly_context& c);
void vmsgeu_vv_instr(assembly_context& c);
void th_vmsgeu_vv_instr(assembly_context& c);
void vmsgt_vv_instr(assembly_context& c);
void th_vmsgt_vv_instr(assembly_context& c);
void vmsgtu_vv_instr(assembly_context& c);
void th_vmsgtu_vv_instr(assembly_context& c);
void vmslt_vi_instr(assembly_context& c);
void th_vmslt_vi_instr(assembly_context& c);
void vmsltu_vi_instr(assembly_context& c);
void th_vmsltu_vi_instr(assembly_context& c);
void vneg_v_instr(assembly_context& c);
void th_vneg_v_instr(assembly_context& c);
void vnot_v_instr(assembly_context& c);
void th_vnot_v_instr(assembly_context& c);
void vncvt_x_x_w_instr(assembly_context& c);
void th_vncvt_x_x_v_instr(assembly_context& c);
void vwcvt_x_x_v_instr(assembly_context& c);
void th_vwcvt_x_x_v_instr(assembly_context& c);
void vwcvtu_x_x_v_instr(assembly_context& c);
void th_vwcvtu_x_x_v_instr(assembly_context& c);
...
void th_vmv_x_s_instr(assembly_context& c);
