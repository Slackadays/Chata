...
constexpr std::array<std::string_view, 56> valid_integer_registers = {"x0",   "x5",  "x6",  "x7",  "x8",  "x9",  "x10", "x11", "x12", "x13", "x14", "x15", "x16", "x17",
                                                                      "x18",  "x19", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28", "x29", "x30", "x31",
                                                                      "zero", "t0",  "t1",  "t2",  "s0",  "s1",  "a0",  "a1",  "a2",  "a3",  "a4",  "a5",  "a6",  "a7",
