...
const std::array<rvinstruction, 1285> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, RVI, 4, {.imm_constraint = Signed_32b}},
         ...
         {"jalr", JALR, I, OP_JALR, 0b000, RVI, 4, {.imm_constraint = Signed_12b}},
         {"beq", BEQ, Branch, OP_BRANCH, 0b000, RVI, 4, {.imm_constraint = Signed_13b}},
         {"bne", BNE, Branch, OP_BRANCH, 0b001, RVI, 4, {.imm_constraint = Signed_13b}},
         {"blt", BLT, Branch, OP_BRANCH, 0b001, RVI, 4, {.imm_constraint = Signed_13b}},
         {"bge", BGE, Branch, OP_BRANCH, 0b100, RVI, 4, {.imm_constraint = Signed_13b}},
         {"bltu", BLTU, Branch, OP_BRANCH, 0b101, RVI, 4, {.imm_constraint = Signed_13b}},
         {"bgeu", BGEU, Branch, OP_BRANCH, 0b110, RVI, 4, {.imm_constraint = Signed_13b}},
         {"lb", LB, I, OP_LOAD, 0b000, RVI, 4, {.imm_constraint = Signed_12b}},
         {"lh", LH, I, OP_LOAD, 0b001, RVI, 4, {.imm_constraint = Signed_12b}},
         {"lw", LW, I, OP_LOAD, 0b010, RVI, 4, {.imm_constraint = Signed_12b}},
         {"lbu", LBU, I, OP_LOAD, 0b100, RVI, 4, {.imm_constraint = Signed_12b}},
         {"lhu", LHU, I, OP_LOAD, 0b101, RVI, 4, {.imm_constraint = Signed_12b}},
         {"sb", SB, S, OP_STORE, 0b000, RVI, 4, {.imm_constraint = Signed_12b}},
         {"sh", SH, S, OP_STORE, 0b001, RVI, 4, {.imm_constraint = Signed_12b}},
         {"sw", SW, S, OP_STORE, 0b010, RVI, 4, {.imm_constraint = Signed_12b}},
         {"addi", ADDI, I, OP_IMM, 0b000, RVI, 4, {.imm_constraint = Signed_12b}},
         {"slti", SLTI, I, OP_IMM, 0b010, RVI, 4, {.imm_constraint = Signed_12b}},
         {"sltiu", SLTIU, I, OP_IMM, 0b011, RVI, 4, {.imm_constraint = Signed_12b}},
         {"xori", XORI, I, OP_IMM, 0b100, RVI, 4, {.imm_constraint = Signed_12b}},
         {"ori", ORI, I, OP_IMM, 0b110, RVI, 4, {.imm_constraint = Signed_12b}},
         {"andi", ANDI, I, OP_IMM, 0b111, RVI, 4, {.imm_constraint = Signed_12b}},
         {"slli", SLLI, R, OP_IMM, 0b0000000001, RVI, 4, {.use_imm_for_rs = true, .imm_constraint = Unsigned_5b}},
         {"srli", SRLI, R, OP_IMM, 0b0000000101, RVI, 4, {.use_imm_for_rs = true, .imm_constraint = Unsigned_5b}},
         {"srai", SRAI, R, OP_IMM, 0b0100000101, RVI, 4, {.use_imm_for_rs = true, .imm_constraint = Unsigned_5b}},
         ...
         {"fence.tso", FENCETSO, I, OP_MISC_MEM, 0b000, RVI, 4, {.super_special_snowflake = true}},
         {"pause", PAUSE, I, OP_MISC_MEM, 0b000, RVI, 4, {.super_special_snowflake = true}},
         {"ecall", ECALL, I, OP_SYSTEM, 0b000, RVI, 4, {.super_special_snowflake = true}},
         {"ebreak", EBREAK, I, OP_SYSTEM, 0b000, RVI, 4, {.super_special_snowflake = true}},
         {"lwu", LWU, I, OP_LOAD, 0b110, I_and_64b, 4, {.imm_constraint = Signed_12b}},
         {"ld", LD, I, OP_LOAD, 0b011, I_and_64b, 4, {.imm_constraint = Signed_12b}},
         {"sd", SD, S, OP_STORE, 0b011, I_and_64b, 4, {.imm_constraint = Signed_12b}},
         {"addiw", ADDIW, I, OP_IMM_32, 0b0000000000, I_and_64b, 4, {.imm_constraint = Signed_12b}},
         {"slliw", SLLIW, R, OP_IMM_32, 0b0000000001, I_and_64b, 4, {.use_imm_for_rs = true, .imm_constraint = Unsigned_5b}},
         {"srliw", SRLIW, R, OP_IMM_32, 0b0000000101, I_and_64b, 4, {.use_imm_for_rs = true, .imm_constraint = Unsigned_5b}},
         {"sraiw", SRAIW, R, OP_IMM_32, 0b0100000101, I_and_64b, 4, {.use_imm_for_rs = true, .imm_constraint = Unsigned_5b}},
         ...
         {"cbo.clean", CBOCLEAN, I, OP_MISC_MEM, 0b010, Zicbom, 4, {.super_special_snowflake = true}},
         {"cbo.flush", CBOFLUSH, I, OP_MISC_MEM, 0b010, Zicbom, 4, {.super_special_snowflake = true}},
         {"cbo.inval", CBOINVAL, I, OP_MISC_MEM, 0b010, Zicbom, 4, {.super_special_snowflake = true}},
         {"cbo.zero", CBOZERO, I, OP_MISC_MEM, 0b010, Zicboz, 4, {.super_special_snowflake = true}},
         {"prefetch.i", PREFETCHI, I, OP_IMM, 0b110, Zicbop, 4, {.super_special_snowflake = true}},
         {"prefetch.r", PREFETCHR, I, OP_IMM, 0b110, Zicbop, 4, {.super_special_snowflake = true}},
         {"prefetch.w", PREFETCHW, I, OP_IMM, 0b110, Zicbop, 4, {.super_special_snowflake = true}},
         ...
         {"flw", FLW, I, OP_LOAD_FP, 0b010, F, 4, {.imm_constraint = Signed_12b}},
         {"fsw", FSW, S, OP_STORE_FP, 0b010, F, 4, {.imm_constraint = Signed_12b}},
         ...
         {"fld", FLD, I, OP_LOAD_FP, 0b011, D_or_Zdinx, 4, {.imm_constraint = Signed_12b}},
         ...
         {"fsd", FSD, S, OP_STORE_FP, 0b011, D_or_Zdinx, 4, {.imm_constraint = Signed_12b}},
         ...
         {"flq", FLQ, I, OP_LOAD_FP, 0b100, Q, 4, {.imm_constraint = Signed_12b}},
         {"fsq", FSQ, S, OP_STORE_FP, 0b100, Q, 4, {.imm_constraint = Signed_12b}},
         ...
         {"flh", FLH, I, OP_LOAD_FP, 0b001, Zfhmin, 4, {.imm_constraint = Signed_12b}},
         {"fsh", FSH, S, OP_STORE_FP, 0b001, Zfhmin, 4, {.imm_constraint = Signed_12b}},
         ...
         {"c.lwsp", CLWSP, CI, OP_C2, 0b010, Zca, 2, {.imm_constraint = Unsigned_8b}},
         {"c.ldsp", CLDSP, CI, OP_C2, 0b011, Zca, 2, {.imm_constraint = Unsigned_9b}},
         {"c.flwsp", CFLWSP, CI, OP_C2, 0b011, Zcf, 2, {.imm_constraint = Unsigned_8b}},
         {"c.fldsp", CFLDSP, CI, OP_C2, 0b001, Zcd, 2, {.imm_constraint = Unsigned_9b}},
         {"c.swsp", CSWSP, CSS, OP_C2, 0b110, Zca, 2, {.imm_constraint = Unsigned_8b}},
         {"c.sdsp", CSDSP, CSS, OP_C2, 0b111, Zca, 2, {.imm_constraint = Unsigned_9b}},
         {"c.fswsp", CFSWSP, CSS, OP_C2, 0b111, Zcf, 2, {.imm_constraint = Unsigned_8b}},
         {"c.fsdsp", CFSDSP, CSS, OP_C2, 0b101, Zcd, 2, {.imm_constraint = Unsigned_9b}},
         {"c.lw", CLW, CL, OP_C0, 0b010, Zca, 2, {.imm_constraint = Unsigned_7b}},
         {"c.ld", CLD, CL, OP_C0, 0b011, Zca, 2, {.imm_constraint = Unsigned_8b}},
         {"c.flw", CFLW, CL, OP_C0, 0b011, Zcf, 2, {.imm_constraint = Unsigned_7b}},
         {"c.fld", CFLD, CL, OP_C0, 0b001, Zcd, 2, {.imm_constraint = Unsigned_8b}},
         {"c.sw", CSW, CS, OP_C0, 0b110, Zca, 2, {.imm_constraint = Unsigned_7b}},
         {"c.sd", CSD, CS, OP_C0, 0b111, Zca, 2, {.imm_constraint = Unsigned_8b}},
         {"c.fsw", CFSW, CS, OP_C0, 0b111, Zcf, 2, {.imm_constraint = Unsigned_7b}},
         {"c.fsd", CFSD, CS, OP_C0, 0b101, Zcd, 2, {.imm_constraint = Unsigned_8b}},
         {"c.j", CJump, CJ, OP_C1, 0b101, Zca, 2, {.imm_constraint = Signed_12b}},
         {"c.jal", CJAL, CJ, OP_C1, 0b001, Zca, 2, {.imm_constraint = Signed_12b}},
         {"c.jr", CJR, CR, OP_C2, 0b1000, Zca, 2, {.custom_reg_val = 0b00000}},
         {"c.jalr", CJALR, CR, OP_C2, 0b1001, Zca, 2, {.custom_reg_val = 0b00000}},
         {"c.beqz", CBEQZ, CB, OP_C1, 0b110, Zca, 2, {.imm_constraint = Signed_9b}},
         {"c.bnez", CBNEZ, CB, OP_C1, 0b111, Zca, 2, {.imm_constraint = Signed_9b}},
         {"c.li", CLI, CI, OP_C1, 0b010, Zca, 2, {.imm_constraint = Signed_6b}},
         {"c.lui", CLUI, CI, OP_C1, 0b011, Zca, 2, {.imm_constraint = Signed_6b}},
         {"c.addi", CADDI, CI, OP_C1, 0b000, Zca, 2, {.imm_constraint = Signed_6b}},
         {"c.addiw", CADDIW, CI, OP_C1, 0b001, Zca, 2, {.imm_constraint = Signed_6b}},
         {"c.addi16sp", CADDI16SP, CI, OP_C1, 0b011, Zca, 2, {.imm_constraint = Signed_6b}},
         {"c.slli", CSLLI, CI, OP_C2, 0b000, Zca, 2, {.imm_constraint = Unsigned_6b}},
         {"c.srli", CSRLI, CB, OP_C1, 0b10000, Zca, 2, {.imm_constraint = Unsigned_6b}},
         {"c.srai", CSRAI, CB, OP_C1, 0b10001, Zca, 2, {.imm_constraint = Unsigned_6b}},
         {"c.andi", CANDI, CB, OP_C1, 0b10010, Zca, 2, {.imm_constraint = Unsigned_6b}},
         ...
         {"c.nop", CNOP, CI, OP_C1, 0b000, Zca, 2, {.super_special_snowflake = true}},
         {"c.ebreak", CEBREAK, CI, OP_C2, 0b1001, Zca, 2, {.super_special_snowflake = true}},
         ...
         {"binvi", BINVI, R, OP_IMM, 0b0110100001, Zbs, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         {"bset", BSET, R, OP_OP, 0b0010100001, Zbs, 4},
         {"bseti", BSETI, R, OP_IMM, 0b0010100001, Zbs, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         ...
         {"rori", RORI, R, OP_IMM, 0b0110000101, Zbb_or_Zbkb, 4, {.use_imm_for_rs = true}}, // Same idea as bclri
         {"roriw", RORIW, R, OP_IMM_32, 0b0110000101, Zbb_or_Zbkb, 4, {.use_imm_for_rs = true}},
         ...
         {"slli.uw", SLLIUW, R, OP_IMM_32, 0b0000100001, Zba, 4, {.use_imm_for_rs = true}},
         ...
         {"vadd.vi", VADDVI, IVI, OP_V, 0b0000001011, V, 4, {.imm_constraint = Signed_5b}},
         ...
         {"vrsub.vi", VRSUBVI, IVI, OP_V, 0b0000111011, V, 4, {.imm_constraint = Signed_5b}},
         ...
         {"vadc.vim", VADCVIM, IVI, OP_V, 0b0100000011, V, 4, {.imm_constraint = Signed_5b}},
         {"vmadc.vvm", VMADCVVM, IVV, OP_V, 0b0100010000, V, 4},
         {"vmadc.vxm", VMADCVXM, IVX, OP_V, 0b0100010100, V, 4},
         {"vmadc.vim", VMADCVIM, IVI, OP_V, 0b0100010011, V, 4, {.imm_constraint = Signed_5b}},
         {"vmadc.vv", VMADCVV, IVV, OP_V, 0b0100011000, V, 4},
         {"vmadc.vx", VMADCVX, IVX, OP_V, 0b0100011100, V, 4},
         {"vmadc.vi", VMADCVI, IVI, OP_V, 0b0100011011, V, 4, {.imm_constraint = Signed_5b}},
         ...
         {"vmsleu.vi", VMSLEUVI, IVI, OP_V, 0b0111001011, V, 4, {.imm_constraint = Signed_5b}},
         {"vmsle.vv", VMSLEVV, IVV, OP_V, 0b0111011000, V, 4},
         {"vmsle.vx", VMSLEVX, IVX, OP_V, 0b0111011100, V, 4},
         {"vmsle.vi", VMSLEVI, IVI, OP_V, 0b0111011011, V, 4, {.imm_constraint = Signed_5b}},
         {"vmsgtu.vx", VMSGTUVX, IVX, OP_V, 0b0111101100, V, 4},
         {"vmsgtu.vi", VMSGTUVI, IVI, OP_V, 0b0111101011, V, 4, {.imm_constraint = Signed_5b}},
         {"vmsgt.vx", VMSGTVX, IVX, OP_V, 0b0111111100, V, 4},
         {"vmsgt.vi", VMSGTVI, IVI, OP_V, 0b0111111011, V, 4, {.imm_constraint = Signed_5b}},
         ...
         {"vmerge.vim", VMERGEVIM, IVI, OP_V, 0b0101110011, V, 4, {.imm_constraint = Signed_5b}},
         ...
         {"vmv.v.i", VMVVI, IVI, OP_V, 0b0101111011, V, 4, {.custom_reg_val = 0b00000, .imm_constraint = Signed_5b}},
         {"vsaddu.vv", VSADDUVV, IVV, OP_V, 0b1000001000, V, 4},
         {"vsaddu.vx", VSADDUVX, IVX, OP_V, 0b1000001100, V, 4},
         {"vsaddu.vi", VSADDUVI, IVI, OP_V, 0b1000001011, V, 4, {.imm_constraint = Signed_5b}},
         {"vsadd.vv", VSADDVV, IVV, OP_V, 0b1000011000, V, 4},
         {"vsadd.vx", VSADDVX, IVX, OP_V, 0b1000011100, V, 4},
         {"vsadd.vi", VSADDVI, IVI, OP_V, 0b1000011011, V, 4, {.imm_constraint = Signed_5b}},
         ...
         {"vssrl.vi", VSSRLVI, IVI, OP_V, 0b1010101011, V, 4, {.imm_constraint = Unsigned_5b}},
         {"vssra.vv", VSSRAVV, IVV, OP_V, 0b1010111000, V, 4},
         {"vssra.vx", VSSRAVX, IVX, OP_V, 0b1010111100, V, 4},
         {"vssra.vi", VSSRAVI, IVI, OP_V, 0b1010111011, V, 4, {.imm_constraint = Unsigned_5b}},
         {"vnclipu.wv", VNCLIPUWV, IVV, OP_V, 0b1011101000, V, 4},
         {"vnclipu.wx", VNCLIPUWX, IVX, OP_V, 0b1011101100, V, 4},
         {"vnclipu.wi", VNCLIPUWI, IVI, OP_V, 0b1011101011, V, 4, {.imm_constraint = Unsigned_5b}},
         {"vnclip.wv", VNCLIPWV, IVV, OP_V, 0b1011111000, V, 4},
         {"vnclip.wx", VNCLIPWX, IVX, OP_V, 0b1011111100, V, 4},
         {"vnclip.wi", VNCLIPWI, IVI, OP_V, 0b1011111011, V, 4, {.imm_constraint = Unsigned_5b}},
         ...
         {"vslideup.vi", VSLIDEUPVI, IVI, OP_V, 0b0011101011, V, 4, {.imm_constraint = Unsigned_5b}},
         {"vslidedown.vx", VSLIDEDOWNVX, IVX, OP_V, 0b0011111100, V, 4},
         {"vslidedown.vi", VSLIDEDOWNVI, IVI, OP_V, 0b0011111011, V, 4, {.imm_constraint = Unsigned_5b}},
         ...
         {"vrgather.vi", VRGATHERVI, IVI, OP_V, 0b0011001011, V, 4, {.imm_constraint = Unsigned_5b}},
         ...
         {"aes64ks1i", AES64KS1I, R, OP_IMM, 0b0011000001, Zknd_or_Zkne, 4, {.custom_reg_val = 0b10000, .use_imm_for_rs = true}},
         ...
         {"vaeskf1.vi", VAESKF1VI, MVV, OP_VE, 0b1000101010, Zvkned, 4, {.use_imm_for_rs = true}},
         {"vaeskf2.vi", VAESKF2VI, MVV, OP_VE, 0b1010101010, Zvkned, 4, {.use_imm_for_rs = true}},
         ...
         {"vror.vi", VRORVI, IVI, OP_V, 0b0101001011, Zvkb, 4, {.imm_constraint = Unsigned_6b}}, // Requires 6th bit of uimm to be in first bit of funct
         ...
         {"vsm3c.vi", VSM3CVI, MVV, OP_VE, 0b1010111010, Zvksh, 4, {.use_imm_for_rs = true}},
         {"vsm3me.vv", VSM3MEVV, MVV, OP_VE, 0b1000001010, Zvksh, 4},
         {"vsm4k.vi", VSM4KVI, MVV, OP_VE, 0b1000011010, Zvksed, 4, {.use_imm_for_rs = true}},
