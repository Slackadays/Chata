...
const std::array<rvinstruction, 2035> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, RVI, 4},
         ...
         {"th.vfsqrt.v", THVFSQRTV, FVV, OP_V, 0b1000111001, XTheadVector, 4, {.custom_reg_val = 0b00000}},
         ...
         {"th.vfcvt.xu.f.v", THVFCVTXUFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b00000}},
         {"th.vfcvt.x.f.v", THVFCVTXFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b00001}},
         {"th.vfcvt.f.xu.v", THVFCVTFXUV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b00010}},
         {"th.vfcvt.f.x.v", THVFCVTFXV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b00011}},
         {"th.vfwcvt.xu.f.v", THVFWCVTXUFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b01000}},
         {"th.vfwcvt.x.f.v", THVFWCVTXFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b01001}},
         {"th.vfwcvt.f.xu.v", THVFWCVTFXUV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b01010}},
         {"th.vfwcvt.f.x.v", THVFWCVTFXV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b01011}},
         {"th.vfwcvt.f.f.v", THVFWCVTFFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b01100}},
         {"th.vfncvt.xu.f.v", THVFNCVTXUFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b10000}},
         {"th.vfncvt.x.f.v", THVFNCVTXFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b10001}},
         {"th.vfncvt.f.xu.v", THVFNCVTFXUV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b10010}},
         {"th.vfncvt.f.x.v", THVFNCVTFXV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b10011}},
         {"th.vfncvt.f.f.v", THVFNCVTFFV, FVV, OP_V, 0b1000101001, XTheadVector, 4, {.custom_reg_val = 0b10100}},
         ...
         {"th.vmpopc.m", THVMPOPCM, MVV, OP_V, 0b0101001010, XTheadVector, 4, {.custom_reg_val = 0b00000}},
         {"th.vmfirst.m", THVMFIRSTM, MVV, OP_V, 0b0101011010, XTheadVector, 4, {.custom_reg_val = 0b00000}},
         ...
         {"th.viota.m", THVIOTAM, MVV, OP_V, 0b0101101010, XTheadVector, 4, {.custom_reg_val = 0b10000}},
         ...
         {"th.vfmv.f.s", THVFMVFS, FVV, OP_V, 0b0011001001, XTheadVector, 4, {.custom_reg_val = 0b00000}},
