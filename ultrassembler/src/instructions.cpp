...
const std::array<rvinstruction, 1398> instructions = {{
        ...
        {"th.lrb", THLRB, I, OP_CUSTOM_0, 0b000000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lrbu", THLRBU, I, OP_CUSTOM_0, 0b100000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lrh", THLRH, I, OP_CUSTOM_0, 0b001000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lrhu", THLRHU, I, OP_CUSTOM_0, 0b101000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lrw", THLRW, I, OP_CUSTOM_0, 0b010000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lrwu", THLRWU, I, OP_CUSTOM_0, 0b110000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lrd", THLRD, I, OP_CUSTOM_0, 0b011000000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.srb", THSRB, I, OP_CUSTOM_0, 0b000000000000101, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.srh", THSRH, I, OP_CUSTOM_0, 0b001000000000101, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.srw", THSRW, I, OP_CUSTOM_0, 0b010000000000101, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.srd", THSRD, I, OP_CUSTOM_0, 0b011000000000101, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lurb", THLURB, I, OP_CUSTOM_0, 0b000100000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        {"th.lurbu", THLURBU, I, OP_CUSTOM_0, 0b100100000000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
        ...
        {"th.vmaqaus.vx", THVMAQAUSVX, MVX, OP_CUSTOM_0, 0b1001111110, XTheadVdot, 4} {"th.vsetvli", THVSETVLI, I, OP_V, 0b111, XTheadVector, 4, {.super_special_snowflake = true}},
        ...
        {"th.vlseg7hff.v", THVLSEG7HFFV, VL, OPLOAD_FP, 0b110100110000101, XTheadVector, 4},
        ...
        {"th.vmadc.vv", THVMADCVV, IVV, OP_V, 0b0100011000, XTheadVector, 4},
        {"th.vmadc.vx", THVMADCVX, IVX, OP_V, 0b0100011100, XTheadVector, 4},
        {"th.vmadc.vi", THVMADCVI, IVI, OP_V, 0b0100011011, XTheadVector, 4},
        ...
        {"th.vnsrl.wv", THVNSRLWV, IVV, OP_V, 0b1011001000, XTheadVector, 4},
        {"th.vnsrl.wx", THVNSRLWX, IVX, OP_V, 0b1011001100, XTheadVector, 4},
        {"th.vnsrl.wi", THVNSRLWI, IVI, OP_V, 0b1011001011, XTheadVector, 4},
        {"th.vnsra.wv", THVNSRAWV, IVV, OP_V, 0b1011011000, XTheadVector, 4},
        {"th.vnsra.wx", THVNSRAWX, IVX, OP_V, 0b1011011100, XTheadVector, 4},
        {"th.vnsra.wi", THVNSRAWI, IVI, OP_V, 0b1011011011, XTheadVector, 4},
        ...
        {"th.vnclipu.wv", THVNCLIPUWV, IVV, OP_V, 0b1011101000, XTheadVector, 4},
        {"th.vnclipu.wx", THVNCLIPUWX, IVX, OP_V, 0b1011101100, XTheadVector, 4},
        {"th.vnclipu.wi", THVNCLIPUWI, IVI, OP_V, 0b1011101011, XTheadVector, 4},
        {"th.vnclip.wv", THVNCLIPWV, IVV, OP_V, 0b1011111000, XTheadVector, 4},
        {"th.vnclip.wx", THVNCLIPWX, IVX, OP_V, 0b1011111100, XTheadVector, 4},
        {"th.vnclip.wi", THVNCLIPWI, IVI, OP_V, 0b1011111011, XTheadVector, 4},
        ...
        {"th.vfncvt.xu.f.w", THVFNCVTXUFW, FVV, OP_V, 0b0100101001, XTheadVector, 4, {.custom_reg_val = 0b10000}},
        {"th.vfncvt.x.f.w", THVFNCVTXFW, FVV, OP_V, 0b0100101001, XTheadVector, 4, {.custom_reg_val = 0b10001}},
        {"th.vfncvt.f.xu.w", THVFNCVTFXUW, FVV, OP_V, 0b0100101001, XTheadVector, 4, {.custom_reg_val = 0b10010}},
        {"th.vfncvt.f.x.w", THVFNCVTFXW, FVV, OP_V, 0b0100101001, XTheadVector, 4, {.custom_reg_val = 0b10011}},
        {"th.vfncvt.f.f.w", THVFNCVTFFW, FVV, OP_V, 0b0100101001, XTheadVector, 4, {.custom_reg_val = 0b10100}},
        ...
        {"th.vfredusum.vs", THVFREDUSUMVS, FVV, OP_V, 0b0000011001, XTheadVector, 4},
        ...
        {"th.vfwredusum.vs", THVFWREDUSUMVS, FVV, OP_V, 0b1100011001, XTheadVector, 4},
        {"th.vmand.mm", THVMANDMM, MVV, OP_V, 0b0110011010, XTheadVector, 4},
        {"th.vmnand.mm", THVMNANDMM, MVV, OP_V, 0b0111011010, XTheadVector, 4},
        {"th.vmandn.mm", THVMANDNMM, MVV, OP_V, 0b0110001010, XTheadVector, 4},
        ...
        {"th.vmorn.mm", THVMORNMM, MVV, OP_V, 0b0111001010, XTheadVector, 4},
