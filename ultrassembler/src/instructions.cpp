...
const std::array<rvinstruction, 2035> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, RVI, 4},
         ...
         {"th.lurd", THLURD, R, OP_CUSTOM_0, 0b0111000100, XTheadMemIdx, 4, {.use_funct_for_imm = true}},
         ...
         {"th.ldd", THLDD, R, OP_CUSTOM_0, 0b1111100100, XTheadMemPair, 4, {.swap_rs1_rs2 = true}},
         {"th.lwd", THLWD, R, OP_CUSTOM_0, 0b1110000100, XTheadMemPair, 4, {.swap_rs1_rs2 = true}},
         {"th.lwud", THLWUD, R, OP_CUSTOM_0, 0b1111000100, XTheadMemPair, 4, {.swap_rs1_rs2 = true}},
         {"th.sdd", THSDD, R, OP_CUSTOM_0, 0b1111100101, XTheadMemPair, 4, {.swap_rs1_rs2 = true}},
         {"th.swd", THSWD, R, OP_CUSTOM_0, 0b1110000101, XTheadMemPair, 4, {.swap_rs1_rs2 = true}},
