...
const std::array<rvinstruction, 1285> instructions = {
        {{"lui", LUI, U, OP_LUI, 0b000, RVI, 4},
         ...
         {"slli", SLLI, R, OP_IMM, 0b0000000001, RVI, 4, {.use_imm_for_rs = true}},
         {"srli", SRLI, R, OP_IMM, 0b0000000101, RVI, 4, {.use_imm_for_rs = true}},
         {"srai", SRAI, R, OP_IMM, 0b0100000101, RVI, 4, {.use_imm_for_rs = true}},
