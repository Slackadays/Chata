...
const uint16_t fast_csr_search(const ultrastring& csr) {
                ...
                if (csr[3] == 'v') {
                    ...
                    if (csr[4] == 'c') {
                        ...
                        if (csr[5] == 'f') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 106;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 107;
                                }
                            }
                        }
                    }
                        ...
                        if (csr[5] == 'e') {
                            ...
                            if (csr[6] == 'e') {
                                ...
                                if (csr[7] == 'n') {
                                    ...
                                    if (csr[8] == '3') {
                                        if (csr.size() < 10) return 115;
                                        if (csr[9] == 'h') {
                                            if (csr.size() < 11) return 119;
                                        }
                                    }
                                }
                            }
                            ...
                            if (csr[6] == 'e') {
                                ...
                                if (csr[7] == 'l') {
                                    ...
                                    if (csr[8] == 't') {
                                        if (csr.size() < 10) return csr_search_failed;
                                        if (csr[9] == 'a') {
                                            if (csr.size() < 11) return 110;
                                            if (csr[10] == 'h') {
                                                if (csr.size() < 12) return 111;
                                            }
                                        }
                                    }
                                }
        ...
        if (csr[1] == 'g') {
            ...
            if (csr[2] == 'e') {
                ...
                if (csr[3] == 'i') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'e') {
                        if (csr.size() < 6) return 99;
                    }
                    if (csr[4] == 'p') {
                        if (csr.size() < 6) return 105;
                    }
                }
            }
            if (csr[2] == 'a') {
    ...
    if (csr[0] == 's') {
        ...
        if (csr[1] == 't') {
            ...
            if (csr[2] == 'v') {
                ...
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'c') {
                        if (csr.size() < 6) return 78;
                    }
                }
                if (csr[3] == 'a') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'l') {
                        if (csr.size() < 6) return 85;
                    }
                }
            }
        }
        if (csr[1] == 'i') {
            if (csr.size() < 3) return csr_search_failed;
            if (csr[2] == 'e') {
                if (csr.size() < 4) return 77;
            }
            if (csr[2] == 'p') {
                if (csr.size() < 4) return 86;
            }
        }
    }
    if (csr[0] == 'p') {
    ...
    if (csr[0] == 't') {
        ...
        if (csr[1] == 'i') {
            ...
            if (csr[2] == 'm') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return 13;
                    if (csr[4] == 'h') {
                        if (csr.size() < 6) return 45;
                    }
                }
            }
        }
    ...
    if (csr[0] == 'm') {
            ...
            if (csr[2] == 'y') {
                ...
                if (csr[3] == 'c') {
                    ...
                    if (csr[4] == 'l') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == 'e') {
                            if (csr.size() < 7) return 246;
                            if (csr[6] == 'h') {
                                if (csr.size() < 8) return 277;
                            }
                        }
                    }
                }
                ...
                if (csr[3] == 'v') {
                    ...
                    if (csr[4] == 'c') {
                        ...
                        if (csr[5] == 'f') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 150;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 151;
                                }
                            }
                        }
                    }
                ...
                if (csr[3] == 'c') {
                    ...
                    if (csr[4] == 'c') {
                        ...
                        if (csr[5] == 'f') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 'g') {
                                if (csr.size() < 8) return 152;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 153;
                                }
                            }
                        }
                    }
        ...
        if (csr[1] == 't') {
            ...
            if (csr[2] == 'v') {
                ...
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'c') {
                        if (csr.size() < 6) return 139;
                    }
                }
                if (csr[3] == 'a') {
                    if (csr.size() < 5) return csr_search_failed;
                    if (csr[4] == 'l') {
                        if (csr.size() < 6) return 146;
                        if (csr[5] == '2') {
                            if (csr.size() < 7) return 149;
                        }
                    }
                }
            }
        ...
        if (csr[1] == 'i') {
            ...
            if (csr[2] == 's') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'a') {
                    if (csr.size() < 5) return 135;
                }
            }
            if (csr[2] == 'p') {
                if (csr.size() < 4) return 147;
            }
            if (csr[2] == 'm') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'p') {
                    ...
                    if (csr[4] == 't') {
                        ...
                        if (csr[5] == 'r') {
                            ...
                            if (csr[6] == 'e') {
                                if (csr.size() < 8) return csr_search_failed;
                                if (csr[7] == 't') {
                                    if (csr.size() < 9) return 247;
                                    if (csr[8] == 'h') {
                                        if (csr.size() < 10) return 278;
                                    }
                                }
                            }
                        }
    ...
    if (csr[0] == 'v') {
        ...
        if (csr[1] == 's') {
            ...
            if (csr[2] == 't') {
                ...
                if (csr[3] == 'v') {
                    ...
                    if (csr[4] == 'e') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == 'c') {
                            if (csr.size() < 7) return 122;
                        }
                    }
                    if (csr[4] == 'a') {
                        if (csr.size() < 6) return csr_search_failed;
                        if (csr[5] == 'l') {
                            if (csr.size() < 7) return 126;
                        }
                    }
                }
            }
            if (csr[2] == 'i') {
                if (csr.size() < 4) return csr_search_failed;
                if (csr[3] == 'e') {
                    if (csr.size() < 5) return 121;
                }
                if (csr[3] == 'p') {
                    if (csr.size() < 5) return 127;
                }
            }
        }
        if (csr[1] == 't') {
                ...
                if (csr[3] == 't') {
                    ...
                    if (csr[4] == 'r') {
                        ...
                        if (csr[5] == 'e') {
                            if (csr.size() < 7) return csr_search_failed;
                            if (csr[6] == 't') {
                                if (csr.size() < 8) return 14;
                                if (csr[7] == 'h') {
                                    if (csr.size() < 9) return 46;
                                }
                            }
                        }
                    }
